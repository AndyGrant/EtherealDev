...
static const int FutilityPruningHistoryLimit[] = { 18810, 3680 };

static const int CounterMovePruningDepth[] = { 3, 2 };
static const int CounterMoveHistoryLimit[] = { -37, -1317 };

static const int FollowUpMovePruningDepth[] = { 3, 2 };
static const int FollowUpMoveHistoryLimit[] = { -3800, -7138 };
...
static const int HistexLimit = 14527;
