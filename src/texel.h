...
#define NTERMS       (      8) // Total terms in the Tuner (659)

#define LEARNING     (   15.0) // Learning rate
...
#define EXECUTE_ON_TERMS(fname) do {                            \
    ...
    ENABLE_1(fname, KnightDistance, 8, NORMAL);                 \
    ...
    ENABLE_0(fname, BishopLongDiagonal, NORMAL);                \
