...
#define BASE_RATE  (   10.0) // Base Learning Rate
#define NTHREADS   (      4) // # of Threads to use
#define NTERMS     (      1) // # of Terms to tune
#define NPOSITIONS (2000000) // # of FENs in book
...
#define TunePawnConnected32            (0 * 32 )
...
#define TuneThreatToQueenByKnightMove  (1 * 1  )
