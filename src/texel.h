...
#define NT (                                                                                           \
    ...
    TuneThreatPawnAttackedByOne    + TuneThreatPawnAttackedByTwo    + TuneThreatMinorAttackedByPawn  + \
    TuneThreatMinorAttackedByMinor + TuneThreatMinorAttackedByMajor + TuneThreatMajorAttackedByMinor + \
    TuneThreatQueenAttackedByOne   + TuneThreatQueenAttackedByTwo                                      \
)
