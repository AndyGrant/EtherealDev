...
#define NPOSITIONS   (5000000) // Total FENS in the book

#define STATICWEIGHT (   0.00) // Weight of the Static Evaluation
#define SEARCHWEIGHT (   1.00) // Weight of the Depth 12 Search
