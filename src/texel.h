...
#define NTERMS       (     64) // Total terms in the Tuner (519)
...
#define NPOSITIONS   (5819931) // Total FENS in the book
...
#define EXECUTE_ON_TERMS(F) do {                                            \
    ...
    ENABLE_3(F, KingShelter, 2, 2, 8, NORMAL, "[2][2][RANK_NB]");           \
    ENABLE_3(F, KingStorm, 2, 2, 8, NORMAL, "[2][2][RANK_NB]");             \
