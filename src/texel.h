...
#define NTERMS      (     64) // Total terms in the tuner

#define LEARNING    (    2.0) // Learning rate
#define LRCUTSIZE   (    4.0) // Learning rate divisor
#define LRSTEPSIZE  (   1000) // Learning rate cut markers
...
#define EXECUTE_ON_TERMS(fname) do {                            \
    ...
    ENABLE_3(fname, KingShelter, 2, 4, 8);                      \
