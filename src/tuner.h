...
#define LRSTEPRATE   (     100) // Cut LR after this many epochs

#define NTERMS       (     643) // Total terms in the Tuner (659)
#define MAXEPOCHS    (   10000) // Max number of epochs allowed
#define BATCHSIZE    (32485879) // FENs per mini-batch
#define NPOSITIONS   (32485879) // Total FENS in the book
