...
const int PawnPSQT32[32] = {
    ...
    S( -13,  22), S(  23,  16), S(   2,  13), S(  -2,   1),
    S( -12,  13), S(   8,  13), S(   2,   2), S(   2,  -3),
    S( -13,  23), S(   0,  27), S(  21,  -2), S(  15, -13),
    S(  -3,  32), S(  12,  25), S(  19,   8), S(  18, -14),
    S(   0,  38), S(  16,  35), S(  18,   9), S(  33, -19),
    S( -43,  15), S( -35,  13), S(  -2, -14), S(   2, -30),
    S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
};
