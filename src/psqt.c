...
const int PawnPSQT32[32] = {
    ...
    S( -23,   1), S(  12,   2), S(  -6,   5), S(  -4,   0),
    S( -25,   0), S(  -3,  -1), S(  -7,  -6), S(   0, -11),
    S( -20,   7), S(  -7,   6), S(   4, -10), S(   2, -23),
    S(  -9,  15), S(   3,   9), S(   0,  -1), S(   3, -23),
    S(  -9,  29), S(  13,  28), S(  18,   6), S(  24, -20),
    S( -45,   7), S( -34,  11), S(  -3, -15), S(   1, -32),
    S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
};
