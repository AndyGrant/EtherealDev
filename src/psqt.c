...
void initializePSQT() {
    ...
    for (int s = 0; s < SQUARE_NB; s++) {
        ...
        PSQT[WHITE_PAWN  ][s] = +MakeScore(PieceValues[PAWN  ][MG] + 9, PieceValues[PAWN  ][EG]) +   PawnPSQT32[w32];
        ...
        PSQT[BLACK_PAWN  ][s] = -MakeScore(PieceValues[PAWN  ][MG] + 9, PieceValues[PAWN  ][EG]) -   PawnPSQT32[b32];
