...
const int KnightPSQT32[32] = {
    S( -37, -42), S(   2, -37), S(  -6, -14), S(  10,  -8),
    S(   6, -43), S(  16,  -9), S(  16, -25), S(  23,  -4),
    S(  11, -20), S(  30, -17), S(  18,   3), S(  31,  13),
    S(  10,   0), S(  18,   4), S(  29,  25), S(  33,  30),
    S(  23,   2), S(  27,  11), S(  35,  34), S(  35,  40),
    S( -37,   6), S(  11,   4), S(  22,  29), S(  34,  28),
    S( -18, -21), S( -26,  11), S(  56, -30), S(  25,  -3),
    S(-158, -28), S(-100, -22), S(-132,  -1), S( -46, -24),
};

const int BishopPSQT32[32] = {
    S(  30, -26), S(  20, -31), S(   1,  -7), S(  21, -14),
    S(  42, -34), S(  35, -26), S(  25, -18), S(  13,  -4),
    S(  27, -16), S(  34, -15), S(  22,   1), S(  16,   6),
    S(  19, -12), S(  12,  -5), S(  10,  13), S(  26,  14),
    S( -12,   8), S(  26,   0), S(  -1,  12), S(  20,  18),
    S(   0,   0), S( -11,   5), S(  17,   2), S(  22,   1),
    S( -72,   6), S( -13,  -3), S(  -5, -14), S( -38,  -3),
    S( -26,   1), S( -52,  -3), S(-111,   7), S(-110,  11),
};
