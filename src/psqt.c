...
const int QueenPSQT32[32] = {
    S(   0, -47), S( -11, -30), S(  -2, -21), S(   9, -40),
    S(   6, -47), S(  12, -37), S(  15, -54), S(   8, -14),
    S(   4, -22), S(  20, -17), S(   5,   6), S(   0,   1),
    S(   3,  -5), S(   9,   4), S(  -4,  15), S(  -2,  46),
    S(  -9,  10), S( -11,  33), S(  -6,  22), S( -18,  52),
    S( -10,   3), S(  -4,  18), S(   0,  21), S(  -8,  46),
    S(  -3,  12), S( -66,  55), S(  19,  11), S( -17,  66),
    S( -18, -22), S(   1, -12), S(   7,  -4), S( -16,   9),
};
