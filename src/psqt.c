...
const int QueenPSQT32[32] = {
    S(   0, -47), S(  -8, -30), S(  -1, -21), S(   7, -40),
    S(   4, -47), S(   9, -37), S(  12, -54), S(   6, -14),
    S(   3, -22), S(  16, -17), S(   4,   6), S(   0,   1),
    S(   2,  -5), S(   7,   4), S(  -3,  15), S(  -1,  46),
    S(  -7,  10), S(  -8,  33), S(  -4,  22), S( -14,  52),
    S(  -8,   3), S(  -3,  18), S(   0,  21), S(  -6,  46),
    S(  -2,  12), S( -52,  55), S(  15,  11), S( -13,  66),
    S( -14, -22), S(   0, -12), S(   5,  -4), S( -12,   9),
};
