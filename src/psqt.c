...
const int PawnPSQT32[32] = {
    ...
    S(  -2,  18), S(   5,  13), S(   3,  -1), S(  16, -21),
    S(   0,  32), S(   4,  36), S(  16,  24), S(  43,   0),
    S( -19, -41), S( -65,  -7), S(   3, -19), S(  37, -32),
    S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
};
...
const int KnightPSQT32[32] = {
    ...
    S(  28,  17), S(  29,  12), S(  41,  28), S(  31,  40),
...
const int RookPSQT32[32] = {
    ...
    S(   5,   9), S( -13,  15), S(   4,   7), S(  18,   6),
    S(  37,  20), S(  26,  23), S(   3,  28), S(  14,  25),
};

const int QueenPSQT32[32] = {
    S(   7, -54), S( -10, -38), S(  -1, -53), S(  13, -46),
    S(   8, -39), S(  22, -58), S(  24, -74), S(  15, -26),
    S(   7, -21), S(  23, -19), S(   5,   3), S(   4,   2),
    S(   8,  -1), S(  12,  15), S(  -2,  16), S( -18,  62),
    S(  -9,  21), S(  -7,  39), S( -16,  18), S( -34,  69),
...
const int KingPSQT32[32] = {
    S(  40, -80), S(  42, -50), S( -10, -12), S( -28, -20),
    S(  34, -33), S(   1, -24), S( -32,   3), S( -46,   6),
    S(  15, -36), S(  26, -33), S(  23,  -7), S(  -1,   8),
    S(   0, -38), S(  82, -41), S(  41,   0), S(  -5,  17),
    S(   1, -22), S(  89, -27), S(  39,  10), S(  -3,  18),
