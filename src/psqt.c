...
const int PawnPSQT32[32] = {
    ...
    S( -21,   3), S(  -2,   0), S(  -5,  -5), S(   2, -13),
    S( -17,  13), S(  -4,   5), S(  13,  -9), S(   9, -20),
    S(  -5,  17), S(   4,   7), S(   1,   0), S(   7, -20),
    S(   0,  28), S(  10,  26), S(  14,   3), S(  23, -20),
...
const int KnightPSQT32[32] = {
    ...
    S(   4, -48), S(   6, -11), S(   6, -22), S(  12,  -2),
    S(   4, -23), S(  23, -18), S(  16,   1), S(  27,  12),
    S(   4,   5), S(  26,   7), S(  33,  31), S(  48,  32),
...
const int BishopPSQT32[32] = {
    S(  25, -22), S(  19, -27), S(  -5,  -9), S(  17, -14),
    S(  33, -29), S(  28, -25), S(  22, -12), S(  10,  -2),
    S(  23, -10), S(  29, -11), S(  19,   0), S(  22,   6),
    S(   8,  -5), S(  18,   0), S(  17,  13), S(  33,  17),
    S( -14,  10), S(  35,   2), S(   3,  16), S(  29,  18),
