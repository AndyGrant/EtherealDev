...
const int PawnPSQT32[32] = {
    ...
    S( -20,   2), S(  13,   2), S(  -3,   6), S(  -3,   2),
    S( -23,   0), S(  -4,  -2), S(  -5,  -7), S(   0, -11),
    S( -19,   8), S(  -9,   6), S(   7, -14), S(   7, -25),
    S(  -7,  18), S(   0,  12), S(   0,  -3), S(   6, -27),
    S(   0,  40), S(  16,  38), S(  21,  14), S(  29, -12),
    S( -56,  28), S( -55,  29), S(   0,  -4), S(   7, -24),
    S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
};
