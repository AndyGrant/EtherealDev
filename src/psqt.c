...
const int PawnPSQT32[32] = {
    ...
    S( -14,   3), S(  17,  -4), S(   3,  -2), S(   4,  -7),
    S( -21,   4), S(   0,  -1), S(  -1,  -7), S(   8, -15),
    S( -14,  14), S(   0,   3), S(  15, -11), S(  12, -23),
    S(  -2,  17), S(   9,   5), S(   4,  -2), S(  10, -22),
    S(   1,  27), S(   8,  23), S(  13,   1), S(  23, -22),
    S( -45,   6), S( -36,   4), S(  -1, -19), S(   1, -30),
    S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
};
