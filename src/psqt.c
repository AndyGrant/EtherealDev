...
const int KnightPSQT32[32] = {
    S( -39, -48), S(   4, -38), S(  -9, -15), S(  10,  -7),
    S(   6, -49), S(  11, -10), S(  15, -24), S(  23,  -2),
    S(  11, -21), S(  30, -17), S(  19,   3), S(  32,  13),
    S(   8,   2), S(  27,   7), S(  31,  27), S(  38,  29),
    S(  25,   3), S(  32,  12), S(  39,  35), S(  39,  39),
    S( -30,   6), S(  23,   2), S(  37,  33), S(  45,  30),
    S( -34, -23), S( -34,   4), S(  39, -33), S(  13,  -3),
    S(-168, -35), S(-102, -30), S(-158,  -8), S( -41, -27),
};
const int BishopPSQT32[32] = {
    S(  27, -21), S(  21, -27), S(   2,  -6), S(  20, -13),
    S(  37, -29), S(  37, -27), S(  25, -16), S(  15,  -5),
    S(  27, -12), S(  35, -13), S(  24,   1), S(  18,   6),
    S(  13,  -6), S(  13,  -3), S(  12,  11), S(  27,  15),
    S( -14,   9), S(  29,   0), S(   0,  12), S(  22,  15),
    S(  -5,   2), S(  -4,   3), S(  20,   2), S(  16,   2),
    S( -71,   1), S(  -5,  -5), S( -12, -14), S( -42,  -1),
    S( -50,   0), S( -63,  -3), S(-126,   5), S(-112,  11),
};
