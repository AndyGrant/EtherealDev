...
const int PawnPSQT32[32] = {
    ...
    S( -23,   2), S(  12,   2), S(  -6,   4), S(  -6,   0),
    S( -25,  -1), S(  -2,  -3), S(  -7,  -8), S(  -1, -13),
    S( -20,   7), S(  -9,   7), S(   5, -13), S(   4, -25),
    S(  -8,  16), S(   2,  11), S(   3,  -2), S(   6, -25),
    S(   0,  31), S(  14,  30), S(  21,   7), S(  28, -19),
    S( -45,   8), S( -33,  11), S(  -3, -15), S(   1, -32),
    S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
};
