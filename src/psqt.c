...
const int PawnPSQT32[32] = {
    ...
    S( -12,  17), S(  23,  13), S(   1,  11), S(  -2,  -1),
    S( -13,   8), S(   9,   9), S(   0,   0), S(   0,  -2),
    S( -14,  20), S(   1,  22), S(  17,  -4), S(  12, -13),
    S(  -4,  29), S(  10,  21), S(  14,   6), S(  14, -16),
    S(   0,  32), S(  12,  30), S(  21,   7), S(  27, -22),
    S( -44,  11), S( -34,  10), S(  -3, -15), S(   1, -33),
    S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
};
