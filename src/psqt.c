...
const int KingPSQT32[32][PHASE_NB] = {
    {  40, -72}, {  50, -48}, {  30, -36}, {  10, -24},
    {  30, -48}, {  40, -24}, {  20, -12}, {   0,   0},
    {  10, -36}, {  20, -12}, {   0,   0}, { -20,  12},
    {   0, -24}, {  10,   0}, { -10,  12}, { -30,  24},
    { -10, -24}, {   0,   0}, { -20,  12}, { -40,  24},
    { -20, -36}, { -10, -12}, { -30,   0}, { -50,  12},
    { -30, -48}, { -20, -24}, { -40, -12}, { -60,   0},
    { -40, -72}, { -30, -48}, { -50, -36}, { -70, -24},
};
