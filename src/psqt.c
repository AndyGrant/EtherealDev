...
const int KingPSQT32[32] = {
    S(  88,-104), S(  84, -77), S(  39, -32), S(  15, -38),
    S(  75, -53), S(  56, -45), S(  10,  -4), S( -18,   3),
    S(   1, -39), S(  44, -31), S(  16,  -1), S( -15,  14),
    S( -52, -30), S(  33, -19), S(   0,  12), S( -48,  32),
    S( -19, -17), S(  55,   1), S(   7,  29), S( -32,  35),
    S(  39, -16), S(  85,   0), S(  73,  20), S(   9,  18),
    S(  16, -16), S(  52,  -3), S(  35,   0), S(   8,   0),
    S(  29, -80), S(  86, -66), S( -21, -34), S( -15, -35),
};
