...
const int PawnPSQT32[32] = {
    ...
    S( -13,  24), S(  26,  17), S(   2,  16), S(   5,  -1),
    S( -13,  14), S(  11,  11), S(   1,   3), S(   8,  -5),
    S( -13,  26), S(   3,  26), S(  19,  -1), S(  16, -12),
    S(   0,  34), S(  14,  25), S(  14,  11), S(  16, -13),
    S(   2,  42), S(  17,  37), S(  16,  10), S(  32, -15),
    S( -41,  17), S( -35,  14), S(   0, -12), S(   3, -27),
    S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
};
