...
const int PawnPSQT32[32] = {
    ...
    S( -13,  -2), S(  14,   5), S(  -2,   6), S(  -2,   7),
    S( -15,  -1), S(   2,   1), S(  -1,  -4), S(   1,  -2),
    S( -10,   7), S(   0,   9), S(   9,  -5), S(   7, -11),
    S(   0,  21), S(   7,  19), S(   3,   7), S(  11,  -8),
    S(  14,  49), S(  22,  52), S(  24,  33), S(  25,  18),
    S(  55,  67), S(  33,  69), S(  66,  47), S(  68,  38),
    S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
};
