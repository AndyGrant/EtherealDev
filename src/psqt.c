...
const int PawnPSQT32[32] = {
    ...
    S( -20,   3), S(  12,   3), S(  -4,   7), S(  -3,   2),
    S( -27,   0), S(   0,   0), S(  -7,  -5), S(   0,  -8),
    S( -19,   9), S(  -5,   7), S(   5,  -9), S(   6, -20),
    S(  -9,  17), S(  -2,  11), S(  -4,  -1), S(   6, -22),
    S(   2,  34), S(  18,  34), S(  24,  11), S(  31, -15),
    S( -41,  15), S( -47,  15), S(   0, -10), S(   4, -28),
    S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
};
