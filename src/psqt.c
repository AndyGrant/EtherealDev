...
const int PawnPSQT32[32] = {
    ...
    S( -26,   4), S(  11,   1), S(  -9,   4), S(  -1,   0),
    S( -27,   0), S(  -4,  -3), S( -10,  -8), S(   0, -17),
    S( -22,   9), S( -11,   8), S(   1, -15), S(   1, -25),
    S(  -5,  18), S(   1,  13), S(   0,  -2), S(   1, -25),
    S(  10,  30), S(  17,  33), S(  19,   9), S(  28, -17),
    S( -44,  11), S( -35,  13), S(  -3, -13), S(   1, -30),
    S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
};
