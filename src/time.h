...
static const double ScoreDropMax      = 6;
static const double ScoreDropDivisor  = 5;

static const double ScoreJumpMax      = 3;
static const double ScoreJumpDivisor  = 10;

static const double ScoreFactorWeight = 0.02;
