...
typedef struct EvalTrace {
    ...
    int passedPawn[COLOUR_NB][SQUARE_NB];
    int passedPawnConnected[COLOUR_NB][SQUARE_NB];
    int passedPawnCanAdvance[COLOUR_NB][2][RANK_NB];
    int passedPawnSafeAdvance[COLOUR_NB][2][RANK_NB];
