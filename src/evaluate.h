...
struct EvalTrace {
    ...
    int KingSafetyBaseLine[COLOUR_NB];
    int KingSafetyThreatWeight[6][COLOUR_NB];
    int KingSafetyWeakSquares[COLOUR_NB];
    int KingSafetyFriendlyPawns[COLOUR_NB];
    int KingSafetyNoEnemyQueens[COLOUR_NB];
};
