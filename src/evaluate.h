...
struct EvalTrace {
    ...
    int PassedPawnRank[RANK_NB][COLOUR_NB];
    int PassedPawnFile[FILE_NB/2][COLOUR_NB];
    int PassedPawnCanAdvance[RANK_NB][COLOUR_NB];
    int PassedPawnSafeAdvance[RANK_NB][COLOUR_NB];
    int PassedPawnConnected[RANK_NB][COLOUR_NB];
