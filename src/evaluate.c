...
const int ThreatPawnAttackedByOne    = S( -16, -26);

const int ThreatMinorAttackedByPawn  = S( -63, -45);

const int ThreatMinorAttackedByMajor = S( -32, -30);

const int ThreatQueenAttackedByOne   = S( -56, -25);
