...
const int KingShelter[4][8] = {
   {S( -12,  12), S(   0, -10), S(   6,  -1), S(   2,   0), S(  -5,   7), S(  16,  23), S( -45,  45), S(   0,   0)},
   {S( -35,   3), S(   8,   0), S(  -4,  -4), S( -24,  -2), S( -24,   3), S(  15,  20), S(   9,   7), S(   0,   0)},
   {S(  -8,   3), S(  22,   6), S( -16,   7), S(  -4,  -1), S(   5,   0), S(   9,   3), S(  43,  10), S(   0,   0)},
   {S(  -3,  -1), S(   4,   5), S(  -1,  -1), S(  17,  -3), S(   9,  -2), S( -26,  13), S(  16,  15), S(   0,   0)},
};
