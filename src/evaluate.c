...
const int PawnCandidatePasser[2][8] = {
   {S(   0,   0), S( -28, -11), S( -12,   8), S( -13,  28), S(   2,  62), S(  51,  69), S(   0,   0), S(   0,   0)},
   {S(   0,   0), S( -14,  16), S(  -6,  21), S(   4,  45), S(  18,  84), S(  33,  55), S(   0,   0), S(   0,   0)},
};
...
const int KingShelter[2][8][8] = {
  {{S( -12,   4), S(  18, -25), S(  20, -10), S(  11,   3), S(   5,   3), S(   2,   2), S(  -3, -33), S( -50,  19)},
   {S(  17,  -7), S(  25, -19), S(   0,  -5), S( -15,   4), S( -31,  15), S( -70,  69), S(  92,  82), S( -30,   3)},
   {S(  35,  -3), S(  17, -10), S( -28,   7), S( -12,  -8), S( -21,  -4), S( -10,   1), S(   0,  66), S( -15,  -1)},
   {S(   4,  12), S(  21, -10), S(   4, -12), S(  16, -23), S(  24, -36), S( -56,   5), S(-136,  52), S(   4,  -6)},
   {S( -14,   8), S(   3,  -3), S( -26,   1), S( -19,   4), S( -21,  -6), S( -40,   0), S(  33, -17), S(  -8,  -2)},
   {S(  46, -16), S(  26, -19), S( -22,   1), S( -13, -19), S(   5, -25), S(  18, -22), S(  41, -30), S( -26,   1)},
   {S(  25, -11), S(   3, -18), S( -24,  -4), S( -19, -10), S( -31,  -8), S( -35,  32), S(   0,  44), S( -12,   3)},
   {S(  -9, -10), S(   8, -19), S(   9,  -3), S(  -2,   9), S( -11,  14), S( -10,  37), S(-190,  87), S( -19,  15)}},
  {{S(   0,   0), S( -11, -22), S(   2, -18), S( -41,  16), S( -21,   2), S(   3,  42), S(-167,  -8), S( -47,   8)},
   {S(   0,   0), S(  27, -21), S(   7,  -8), S( -19,  -2), S(  -1, -12), S(  26,  67), S(-184,  -3), S( -42,   5)},
   {S(   0,   0), S(  35, -11), S(  -2,  -6), S(   9, -17), S(  14,  -8), S( -88,  47), S( -84, -73), S( -23,  -4)},
   {S(   0,   0), S(  -1,   9), S(  -1,   1), S( -16,   1), S( -27,   1), S( -99,  31), S(   7, -41), S( -25,  -6)},
   {S(   0,   0), S(  11,   3), S(  12,  -6), S(  14, -10), S(  14, -26), S( -57,  15), S(-104, -61), S(  -2,  -7)},
   {S(   0,   0), S(  10,  -8), S( -20,   0), S( -30,  -7), S(  17, -24), S( -38,   3), S(  55,  38), S( -22,  -5)},
   {S(   0,   0), S(  26, -15), S(  13, -13), S(  -9, -10), S( -29,   7), S(  -9,  15), S( -56, -49), S( -34,  13)},
   {S(   0,   0), S(  15, -38), S(  20, -28), S( -18,  -5), S( -17,  18), S(  -4,  19), S(-228, -55), S( -22,   3)}},
};

const int KingStorm[2][4][8] = {
  {{S(  -3,  26), S( 117,  -8), S( -26,  25), S( -22,  10), S( -14,   3), S(  -8,  -3), S( -18,   7), S( -21,  -3)},
   {S(  -2,  47), S(  58,  14), S( -20,  25), S(  -6,  12), S(  -3,   5), S(   6,  -4), S(   1,   0), S( -12,   0)},
   {S(   9,  36), S(  18,  24), S( -26,  22), S( -12,  10), S(   4,   3), S(   9,   0), S(  10,  -7), S(   3,  -1)},
   {S(  -2,  23), S(  17,  21), S( -17,  10), S( -15,   4), S( -13,   3), S(   7, -10), S(   0,  -7), S( -15,   3)}},
  {{S(   0,   0), S( -14, -16), S( -16,  -2), S(  21, -17), S(  13,  -9), S(   1, -19), S(  -5,  -2), S(  17,  29)},
   {S(   0,   0), S( -16, -33), S(  -6, -11), S(  34, -14), S(  -1,  -2), S(  13, -24), S(  -7, -10), S( -17,   2)},
   {S(   0,   0), S( -27, -48), S( -30,  -8), S(  11, -11), S(   3,  -2), S(  -9, -14), S( -12, -15), S( -11,   6)},
   {S(   0,   0), S(  -2, -18), S( -18, -19), S( -12,  -4), S(  -4,  -7), S(   6, -27), S(  73, -10), S(  13,  20)}},
};
