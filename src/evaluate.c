...
const int KingShelter[2][4][8] = {
  {{S( -38,   1), S( -13,  -5), S(  -5,   4), S(  -8,  10),
    S( -11,  -3), S( -24,  -7), S(  38,  -7), S( -46,  18)},
   {S(  14,  -5), S(   1, -13), S( -22,  -7), S( -12, -20),
    S(  -5, -33), S(  15, -47), S(  48, -33), S( -35,   1)},
   {S(  29,  -4), S(   8,   4), S( -25,   6), S(  -6, -20),
    S(  10, -13), S( -32,  12), S(   7,  46), S( -31,   6)},
   {S(  -5,  20), S(   8,   3), S( -12,   0), S(  17,  -8),
    S(  27,   0), S(   2,  30), S(-199,  79), S(  -3,   3)}},
  {{S(   0,   0), S(  -6, -15), S(   0, -13), S(   8, -11),
    S(   7, -21), S( -45,   8), S(-107, -71), S( -29,  10)},
   {S(   0,   0), S(  20,   2), S(   8,  -3), S(  -7,  -6),
    S(  -2, -33), S( -40,   6), S(  57,  45), S( -53,  10)},
   {S(   0,   0), S(   4,   5), S( -21,  -1), S(  -5,  -8),
    S( -14, -10), S(  21,  10), S( -56, -62), S( -43,   4)},
   {S(   0,   0), S(  -6,   8), S(  -4,  -3), S(  12, -10),
    S(  17,  -5), S(   6, -15), S(-238, -72), S(  -9, -13)}},
};
