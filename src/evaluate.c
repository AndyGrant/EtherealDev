...
const int KingStorm[2][FILE_NB/2][RANK_NB] = {
  {{S(   2,   6), S(  34,  20), S(  -6,   7), S( -16,   0),
    S(  11,  -1), S(   3,  -3), S(  -1,   2), S(  10,  14)},
   {S(   5,  26), S(  12,  19), S(  -7,   1), S(  -2,  -4),
    S(  15,  -1), S(  15, -10), S(   5,   1), S(  10,  24)},
   {S(   3,  18), S(   3,  22), S( -12,   5), S( -24,   0),
    S(  17,  -5), S(  11,  -4), S(  -5,  -5), S(  18,  23)},
   {S(   5,  17), S(   6,  21), S(  -9,  -9), S( -47, -14),
    S( -43,  -7), S(   0, -15), S(   6,  -4), S( -35,  17)}},
  {{S(   0,   0), S(   0,   0), S(   6, -15), S(  33, -12),
    S(  10,   1), S(  -3,  -6), S(  -7,  -1), S(   0,   1)},
   {S(   0,   0), S(   0,   0), S(   0, -21), S(  31,  -8),
    S(  -1,   1), S(  -4,   0), S(  -1,   0), S(  -2,   0)},
   {S(   0,   0), S(  -1,  -1), S(  -8, -21), S(  -4,  -4),
    S(  -5,   4), S( -18,  -4), S(  -4,  -1), S(   0,   0)},
   {S(   0,   0), S(   0,   0), S(  -9, -19), S( -21,  -4),
    S( -26,  -8), S(  15, -11), S(  17,   1), S(   1,   1)}},
};
