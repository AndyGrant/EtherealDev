...
const int BishopMobility[14] = {
    S( -65,-146), S( -29, -94), S(  -9, -55), S(   1, -29),
    S(  12, -17), S(  19,  -1), S(  22,   8), S(  23,  13),
    S(  22,  18), S(  24,  20), S(  23,  20), S(  39,  10),
    S(  40,  13), S(  65, -17),
};
...
const int RookMobility[15] = {
    S(-149,-112), S( -52,-116), S( -13, -62), S(  -4, -20),
    S(  -5,   0), S(  -5,  15), S(  -4,  25), S(   1,  28),
    S(   8,  30), S(  12,  35), S(  14,  41), S(  19,  45),
    S(  19,  50), S(  26,  45), S(  69,  17),
};

/* Queen Evaluation Terms */

const int QueenMobility[28] = {
    S( -61,-263), S(-211,-387), S( -60,-201), S( -24,-191),
    S( -12,-140), S(  -6, -89), S(  -1, -61), S(  -1, -34),
    S(   1, -22), S(   2,   0), S(   5,  11), S(   6,  24),
    S(   8,  26), S(  10,  35), S(   8,  40), S(   6,  43),
    S(   4,  47), S(   0,  47), S(   0,  41), S(  -1,  35),
    S(   5,  14), S(  19,  -5), S(  20, -35), S(  22, -53),
...
void initializeEvalInfo(EvalInfo* ei, Board* board, PawnKingTable* pktable){
    ...
    ei->mobilityAreas[WHITE] = ~((ei->pawnAttacks[BLACK] & ~whitePawns) | (white & kings) | ei->blockedPawns[WHITE]);
    ei->mobilityAreas[BLACK] = ~((ei->pawnAttacks[WHITE] & ~blackPawns) | (black & kings) | ei->blockedPawns[BLACK]);
