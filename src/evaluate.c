...
const int PassedPawn[2][2][8] = {
  {{S(   0,   0), S( -27, -24), S( -22,   2), S( -11,   0),
    S(  16,   0), S(  54,   0), S( 140,  31), S(   0,   0)},
   {S(   0,   0), S(  -5,  -7), S( -23,  11), S( -15,  23),
    S(   2,  42), S(  65,  66), S( 190, 136), S(   0,   0)}},
  {{S(   0,   0), S( -13,   4), S( -17,   1), S( -10,  20),
    S(  25,  40), S(  75,  76), S( 238, 158), S(   0,   0)},
   {S(   0,   0), S( -21,  -4), S( -15,   1), S( -14,  37),
    S(   0,  98), S(  42, 217), S( 124, 379), S(   0,   0)}},
};
