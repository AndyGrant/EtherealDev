...
void evaluatePieces(EvalInfo * ei, Board * board){
    ...
    ei->midgame[WHITE] += -8 * popcount(board->colours[WHITE] & ~ei->attacked[WHITE]);
    ei->endgame[WHITE] += -2 * popcount(board->colours[WHITE] & ~ei->attacked[WHITE]);
    ei->endgame[BLACK] += -8 * popcount(board->colours[BLACK] & ~ei->attacked[BLACK]);
    ei->midgame[BLACK] += -2 * popcount(board->colours[BLACK] & ~ei->attacked[BLACK]);
