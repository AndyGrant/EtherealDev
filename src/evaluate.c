...
const int KingShelter[2][FILE_NB/2][RANK_NB] = {
  {{S( -20,   0), S(   1,  -6), S(   7,   2), S(   0,   8), S(  -8,   1), S(   5,   4), S(   0,   0), S( -29,  10)},
   {S(  14,   5), S(  19,  -7), S(   0,  -1), S( -14,   0), S( -11,  -5), S(  -1,   0), S(   0,   0), S( -18,   3)},
   {S(  26,   6), S(  18,   3), S( -19,  15), S(  -2, -13), S(   8, -12), S(   0,  -1), S(   0,   0), S( -18,   6)},
   {S(  -4,  20), S(  13,   0), S(  -1,  -4), S(  26, -17), S(  28, -16), S(  -2,  -3), S(   0,   0), S(   2,   0)}},
  {{S(   0,   0), S(   3,  -7), S(   6,  -7), S( -10,  -2), S(  -1,   1), S(   1,   1), S(   0,   0), S( -17,  12)},
   {S(   0,   0), S(  25,   1), S(  13,   0), S( -13,   4), S( -22,   1), S(  -1,   0), S(  -1,   0), S( -43,  14)},
   {S(   0,   0), S(  21,   1), S(  -3,   0), S(  10,  -7), S(   8,   1), S(   0,  -1), S(   0,   0), S( -31,   3)},
   {S(   0,   0), S(   5,   9), S(  10,   0), S(  24,  -9), S(  20,  -8), S(  -1,  -1), S(   0,   0), S(  -1,  -7)}},
};
