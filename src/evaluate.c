...
const int KingStorm[2][FILE_NB/2][RANK_NB] = {
  {{S(   0,   0), S(  50,  65), S(  -2,  14), S(  -3,   1), S(   0,  -3), S(  -2,  -2), S(   1,   3), S(   5,   3)},
   {S(   0,   0), S(  36,  54), S(   0,  14), S(  -7,  -1), S(  -6,  -3), S(  -2,  -2), S(   4,   1), S(   7,   5)},
   {S(   0,   0), S(  34,  47), S(  -2,   8), S(  -9,   0), S(   4,   0), S(  -1,  -2), S(   0,   0), S(   9,   0)},
   {S(   0,   0), S(  12,  39), S( -11,   1), S( -14,  -3), S(  -9,  -4), S(   7,  -1), S(   3,   3), S(  -1,  -6)}},
  {{S(   0,   0), S( -47, -36), S(  -9,  -4), S(  11,  -4), S(   8,   0), S(  -9,   1), S( -21,  17), S(   0,   0)},
   {S(   0,   0), S( -32, -41), S( -19, -10), S(   1,  -4), S( -11,  -6), S(  -5,  -9), S( -16,  22), S(   0,   0)},
   {S(   0,   0), S( -70, -47), S( -15,  -5), S(   1,  -1), S(  -6,   1), S(   3,   2), S(  10,   5), S(   0,   0)},
   {S(   0,   0), S(-130, -64), S( -14,  -8), S( -13,  -3), S(  -2,  -3), S(  18,   8), S(  38,  35), S(   0,   0)}},
};
