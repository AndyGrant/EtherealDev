...
const int KingStorm[2][FILE_NB/2][RANK_NB] = {
  {{S(   3,   9), S(  38,  23), S(  -6,   9), S( -15,   4),
    S(  -2,  -1), S(  -6,  -1), S( -12,   3), S(  -2,   3)},
   {S(   6,  30), S(  14,  19), S(  -6,   4), S(  -6,  -1),
    S(  -1,  -1), S(   4,  -7), S(   0,   3), S(  -6,   9)},
   {S(   4,  21), S(   4,  23), S( -11,   4), S( -17,   0),
    S(   5,  -4), S(   4,  -4), S(   2,   0), S(   5,   3)},
   {S(   6,  18), S(   7,  21), S(  -5,  -5), S( -21,  -8),
    S(  -9,  -5), S(   3, -11), S(  -2,  -3), S( -15,   3)}},
  {{S(   0,   0), S(   0,   0), S(   9, -14), S(  22, -14),
    S(   5,   0), S(  -1,  -8), S(  -8,  -2), S(   0,   1)},
   {S(   0,   0), S(   0,   0), S(   0, -21), S(  27,  -9),
    S(  -1,   1), S(  -3,   0), S(  -2,   0), S(  -2,   0)},
   {S(   0,   0), S(  -1,  -2), S(  -7, -20), S(  -2,  -3),
    S(  -4,   5), S( -18,  -3), S(  -5,  -1), S(   0,   0)},
   {S(   0,   0), S(   0,   0), S(  -7, -20), S(  -4,  -3),
    S(  -9,  -6), S(   7, -11), S(  18,   1), S(   0,   0)}},
};
