...
const int KingShelter[2][RANK_NB] = {
   {S(   1,  12), S(  10,   4), S(  -4,   8), S(   1,  -5),
    S(  20, -22), S( -11,   0), S(  -3,   1), S( -15,   2)},
   {S(   0,   0), S(   9,  15), S(   4,   6), S(  10, -14),
    S(   9, -13), S( -15,  -2), S(  -2,  -1), S( -15,   9)},
};

const int KingStorm[2][RANK_NB] = {
   {S(   9,  36), S(  35,  25), S(  10,   3), S(  -8,  -4),
    S(  -8,  -3), S(   0, -12), S( -10,   1), S( -18,  18)},
   {S(   0,   0), S(   0,  -1), S( -18, -25), S(   6, -16),
    S(  -4,   2), S(   5, -28), S(   4,   3), S(  -5,   0)},
};
