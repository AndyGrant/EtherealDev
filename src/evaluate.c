...
const int KingShelter[2][FILE_NB/2][RANK_NB] = {
  {{S( -22,   0), S(  -2, -11), S(   6,   0), S(   1,   6), S(  -6,   2), S(   6,   5), S(   0,   0), S( -26,  12)},
   {S(  23,   3), S(  13,  -9), S(  -8,  -1), S( -15,  -1), S( -13,  -5), S(  -1,   0), S(   0,   0), S( -13,   7)},
   {S(  31,   4), S(  17,   3), S( -21,  11), S(  -4, -14), S(  10, -11), S(   1,   0), S(   0,   0), S( -17,   9)},
   {S(  -1,  21), S(  11,   0), S(  -5,  -2), S(  22, -15), S(  27, -18), S(   0,  -1), S(   0,   0), S(   1,   0)}},
  {{S(   0,   0), S(   4, -14), S(  10,  -8), S( -10,   0), S(  -1,   1), S(   1,   1), S(   0,   0), S( -17,  18)},
   {S(   0,   0), S(  23,   0), S(  11,  -2), S( -13,   0), S( -19,   2), S(   0,   0), S(  -1,   0), S( -40,  15)},
   {S(   0,   0), S(  13,   3), S(  -9,   0), S(   7, -10), S(   8,   0), S(   0,   0), S(   0,   0), S( -25,   3)},
   {S(   0,   0), S(   4,  11), S(   8,   1), S(  23, -10), S(  22,  -9), S(   0,   0), S(   0,   0), S(   0,  -6)}},
};
