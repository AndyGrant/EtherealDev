...
const int KingShelter[2][FILE_NB / 2][RANK_NB] = {
  {{S( -10,   0), S(  -3,  -2), S(   4,   1), S(   3,   2), S(  -4,   4), S(  15,  10), S( -71,  16), S(  -6,   4)},
   {S(   6,   3), S(   0,  -2), S( -16,  -3), S( -16,  -6), S( -18,  -5), S(  -9,   6), S(  57,  25), S( -11,   0)},
   {S(   9,   6), S(  13,   1), S( -18,  -1), S(  -7,  -5), S(  -2,  -7), S(  -2,  -9), S(   2,   5), S(  -8,   0)},
   {S(  -7,   8), S(   4,   1), S(  -7,   0), S(  11,  -3), S(   7, -10), S( -23,  -4), S(   8,   8), S(  -2,   0)}},
  {{S(   0,   0), S(   0,  -4), S(   3,  -3), S( -11,  -2), S( -11,  -1), S(   4,   8), S(-109, -39), S( -10,   2)},
   {S(   0,   0), S(   9,   1), S(  -3,   0), S( -19,  -3), S( -16,  -4), S(  10,  11), S( -56, -40), S( -24,   1)},
   {S(   0,   0), S(   3,   3), S( -15,  -1), S(  -5,  -6), S(   4, -10), S( -15,   3), S( -11,   1), S( -13,  -1)},
   {S(   0,   0), S(   0,   5), S(   4,   1), S(  14,   2), S(   5,  -6), S(  -7,  -7), S( -53, -21), S(  -3,  -2)}},
};
...
int evaluateKings(EvalInfo* ei, Board* board, int colour){
    ...
    for (file = MAX(0, kingFile - 1); file <= MIN(7, kingFile + 1); file++){
        ...
        count = 3 + ei->attackCounts[!colour] >= 2;

        eval += count * KingShelter[file == kingFile][square32(file)][distance];
              
        if (TRACE) T.kingShelter[colour][file == kingFile][square32(file)][distance] += count;
    }
