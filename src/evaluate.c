...
const int KingShelter[2][FILE_NB / 2][RANK_NB] = {
  {{S(  -4,   1), S(  -1,   0), S(   0,   2), S(   0,   2), S(  -4,   8), S(   1,  10), S( -63,  48), S(  -6,   5)},
   {S(   0,   3), S(   0,   0), S(  -9,   3), S(  -7,   0), S(  -9,   3), S( -12,  12), S(  20,  18), S(  -9,   4)},
   {S(   1,   4), S(   2,   1), S(  -8,   3), S(  -3,  -2), S(  -1,  -5), S(  -1,  -5), S(  -5,  11), S(  -5,   3)},
   {S(  -5,   7), S(   0,   2), S(  -4,   1), S(   2,  -2), S(   1,  -7), S( -10,   2), S( -11,  12), S(  -1,   2)}},
  {{S(   0,   0), S(   0,  -2), S(   0,  -1), S(  -7,   3), S(  -7,   4), S(  -1,   4), S( -55, -12), S( -12,   9)},
   {S(   0,   0), S(   2,   1), S(  -1,   1), S(  -8,   2), S(  -7,   0), S(  -3,  12), S( -30, -26), S( -12,   5)},
   {S(   0,   0), S(   0,   2), S(  -7,   2), S(  -2,  -2), S(   3,  -6), S( -10,   6), S( -16,   7), S(  -8,   2)},
   {S(   0,   0), S(   0,   3), S(   0,   0), S(   5,  -1), S(   2,  -6), S(  -1,  -3), S( -25,  -1), S(  -1,   0)}},
};
...
int evaluateKings(EvalInfo* ei, Board* board, int colour){
    ...
    for (file = MAX(0, kingFile - 1); file <= MIN(7, kingFile + 1); file++){
        ...
        count = 1 + MIN(3, ei->attackCounts[!colour]);
