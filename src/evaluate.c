...
const int KingStorm[2][FILE_NB/2][RANK_NB] = {
  {{S(   0,   0), S(  74,  23), S( -15,   9), S(  -5,   3), S(   3,   0), S(   1,  -2), S(  -1,   3), S(  -7,  -2)},
   {S(   0,   0), S(   4,  28), S( -26,   0), S(  -3,   2), S(   4,   1), S(   1,  -1), S(   0,   0), S(   0,   0)},
   {S(   0,   0), S( -29,  31), S( -17,   2), S(  -5,   2), S(   2,   3), S(   3,   2), S(   0,  -1), S(   3,   0)},
   {S(   0,   0), S( -12,  35), S( -18,  -3), S( -10,   5), S(   0,   1), S(   6,  -4), S(   1,  -3), S(  -3,   0)}},
  {{S(   0,   0), S(-156,  -9), S(  -2,  -5), S(  11,  -8), S(  19,  -4), S(   3,   0), S(  -2,   9), S(   0,   0)},
   {S(   0,   0), S(   2, -61), S(  -1, -16), S(  22,  -8), S(   8,   3), S(  -2,  -2), S(  -3,  10), S(   0,   0)},
   {S(   0,   0), S( -72,  -3), S(  -9, -17), S(  -1,  -3), S(  -6,   5), S( -22,  -6), S( -16, -15), S(   0,   0)},
   {S(   0,   0), S(-187, -58), S( -12, -14), S(  -1,   0), S(  -1,  -4), S(   2, -11), S(  40,  57), S(   0,   0)}},
};
