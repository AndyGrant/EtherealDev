...
const int PawnConnected[SQUARE_NB] = {
    S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
    S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
    S(   0,  -3), S(   9,  -4), S(   6,   3), S(   6,   9),
    S(   9,  11), S(   2,   0), S(  12,  -3), S(  -4,  -8),
    S(  10,   2), S(  24,  -5), S(  26,   4), S(  24,  11),
    S(  25,  12), S(  24,   4), S(  22,  -4), S(  11,   2),
    S(   6,  -1), S(  18,   1), S(  11,   5), S(  16,  13),
    S(  17,  13), S(   8,   5), S(  17,   0), S(   7,  -2),
    S(   6,  13), S(  17,  18), S(  28,  22), S(  31,  15),
    S(  33,  15), S(  27,  20), S(  18,  17), S(   5,  13),
    S(  47,  25), S(  44,  49), S(  62,  61), S(  73,  69),
    S(  73,  68), S(  63,  61), S(  45,  48), S(  47,  25),
