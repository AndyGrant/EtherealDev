...
const int KingShelter[2][FILE_NB][RANK_NB] = {
  {{S(  -9,   2), S(  14, -26), S(  26,  -9), S(  17,   6), S(  14,   3), S( -51,  20)},
   {S(  16,  -7), S(  21, -19), S(   3,  -5), S( -15,   4), S( -30,  16), S( -18,   0)},
   {S(  36,  -4), S(  10,  -8), S( -30,   7), S( -13,  -8), S( -17,  -5), S( -12,  -1)},
   {S(   2,  12), S(  24, -13), S(   5, -12), S(  15, -21), S(  31, -38), S(   6,  -6)},
   {S( -18,  11), S(   4,  -1), S( -31,   4), S( -20,   8), S( -21,  -6), S(  -8,   2)},
   {S(  48, -18), S(  21, -14), S( -21,   4), S( -11, -19), S(   7, -25), S( -23,   2)},
   {S(  29, -16), S(  -1, -16), S( -26,  -1), S( -22,  -7), S( -31,  -5), S(  -9,   0)},
   {S(  -9, -13), S(   5, -19), S(   8,   2), S(  -1,  12), S( -11,  16), S( -19,  15)}},
  {{S(   0,   0), S( -13, -26), S(   7, -23), S( -39,  20), S( -23,   1), S( -43,   9)},
   {S(   0,   0), S(  25, -22), S(   8,  -6), S( -16,   0), S(   3, -18), S( -30,   4)},
   {S(   0,   0), S(  25, -12), S(  -1, -10), S(   5, -20), S(  21,  -3), S( -19,  -2)},
   {S(   0,   0), S( -10,   9), S(  -6,  -2), S( -25,   5), S( -27,   4), S( -22,  -4)},
   {S(   0,   0), S(  14,   2), S(  12,  -6), S(  15, -13), S(  17, -31), S(  -2,  -3)},
   {S(   0,   0), S(   1,  -6), S( -26,   2), S( -23,  -9), S(  23, -23), S( -17,  -4)},
   {S(   0,   0), S(  23, -17), S(  11, -15), S( -11,  -7), S( -28,  14), S( -31,  12)},
   {S(   0,   0), S(  12, -42), S(  21, -32), S( -19,  -7), S( -20,  19), S( -25,   3)}},
};
...
int evaluateKings(EvalInfo *ei, Board *board, int colour) {
    ...
    for (int file = MAX(0, fileOf(kingSq) - 1); file <= MIN(FILE_NB - 1, fileOf(kingSq) + 1); file++) {
        ...
        int ksclamp = (ourDist == 7) ? 5 : MIN(4, ourDist);
        ei->pkeval[US] += KingShelter[file == fileOf(kingSq)][file][ksclamp];
        if (TRACE) T.KingShelter[file == fileOf(kingSq)][file][ksclamp][US]++;
