...
const int PawnValue[PHASE_NB] = {  0,  0};
...
const int KnightValue[PHASE_NB] = {  0,  0};
...
const int BishopValue[PHASE_NB] = {  0,  0};
...
const int RookValue[PHASE_NB] = {  0,  0};
...
const int QueenValue[PHASE_NB] = {  0,  0};
