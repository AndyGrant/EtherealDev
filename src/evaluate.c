...
const int KingShelter[2][FILE_NB/2][RANK_NB] = {
  {{S(  -2,   0), S(  -3,  -1), S(   3,   3), S(   0,   2), S(  -2,   0), S(   0,   0), S(   0,   0), S( -11,   2)},
   {S(   2,   2), S(  10,  -2), S(   0,  -1), S(  -2,   0), S(   0,   0), S(   0,   0), S(   0,   0), S(  -5,  -3)},
   {S(   9,   6), S(  18,   1), S( -15,   1), S(  -4,  -3), S(   0,   0), S(   0,   0), S(   0,   0), S( -12,   0)},
   {S(   0,   3), S(   4,   0), S(  -8,  -1), S(  17,  -1), S(   9,   0), S(   0,   0), S(   0,   0), S(   0,  -3)}},
  {{S(   0,   0), S(  -2,  -1), S(   0,  -1), S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0), S(  -1,   0)},
   {S(   0,   0), S(  15,   5), S(   2,   1), S(  -8,  -1), S(  -5,   0), S(   0,   0), S(   0,   0), S( -20,   0)},
   {S(   0,   0), S(  12,   2), S(   0,  -1), S(   1,   0), S(   0,   0), S(   0,   0), S(   0,   0), S(  -5,  -4)},
   {S(   0,   0), S(  -2,   4), S(   3,   0), S(  12,   0), S(   4,   0), S(   0,   0), S(   0,   0), S(  -5,  -5)}},
};
