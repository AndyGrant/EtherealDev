...
const int PawnValue   = S( 113, 143);
const int KnightValue = S( 471, 415);
const int BishopValue = S( 496, 436);
const int RookValue   = S( 680, 709);
const int QueenValue  = S(1304,1350);
...
const int PawnPSQT32[32] = {
    ...
    S( -27,   6), S(   3,   3), S( -10,   4), S( -10,  -2),
    S( -28,   1), S( -14,   2), S( -13,  -7), S(  -6, -15),
    S( -22,  11), S( -14,  14), S(   5, -11), S(   8, -25),
    S( -12,  17), S(  -3,  13), S(  -5,  -2), S(   4, -18),
    S(  -6,  33), S(  -1,  28), S(   4,  18), S(  32,  -9),
    S( -20, -60), S( -59, -28), S(   2, -43), S(  46, -57),
    S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
};

const int KnightPSQT32[32] = {
    S( -49, -32), S( -14, -30), S( -16, -31), S(  -2, -17),
    S(  -3, -21), S(   1, -12), S(   1, -28), S(  10, -19),
    S(   5, -28), S(  20, -23), S(  17, -17), S(  29,  -2),
    S(  19,   0), S(  26,   7), S(  35,  20), S(  42,  26),
    S(  27,  14), S(  36,  10), S(  47,  31), S(  45,  42),
    S( -18,  11), S(   3,  14), S(  32,  31), S(  35,  31),
    S(  13, -12), S(  -4,  -1), S(  30, -22), S(  40,   1),
    S(-178, -25), S( -85,  -4), S(-111,  18), S( -33,  -3),
};

const int BishopPSQT32[32] = {
    S(   7, -27), S(  12, -19), S( -13, -12), S(   8, -13),
    S(  30, -35), S(  12, -37), S(  23, -21), S(  13, -10),
    S(  14, -13), S(  29, -15), S(   5, -16), S(  27,  -4),
    S(  16,  -7), S(  21,  -2), S(  19,   6), S(  31,   7),
    S(  -9,  15), S(  24,   7), S(   7,  16), S(  20,  19),
    S(   4,   8), S(  -3,  18), S(   1,   7), S(  16,  15),
    S( -44,  15), S( -50,   5), S(  -7,   8), S( -23,  13),
    S( -58,  -7), S( -45,   6), S( -84,  15), S( -90,  27),
};

const int RookPSQT32[32] = {
    S( -15, -30), S( -17, -19), S(   0, -23), S(  10, -27),
    S( -58, -16), S( -11, -34), S( -10, -33), S(   3, -39),
    S( -32, -16), S(  -5, -12), S( -17, -17), S(   2, -26),
    S( -17,  -2), S( -11,   8), S(  -6,   3), S(  10,  -2),
    S(  -2,  12), S(  11,   9), S(  24,   7), S(  45,   3),
    S( -14,  23), S(  31,   7), S(   8,  22), S(  41,   5),
    S(   3,   9), S( -10,  16), S(  14,   7), S(  30,   9),
    S(  36,  23), S(  28,  24), S(   2,  33), S(  10,  29),
};

const int QueenPSQT32[32] = {
    S(  31, -66), S(   5, -45), S(  11, -60), S(  19, -44),
    S(  13, -42), S(  28, -58), S(  30, -72), S(  17, -27),
    S(  10, -30), S(  26, -20), S(   8,   7), S(   8,   1),
    S(  12,  -8), S(  18,  12), S(   0,  25), S( -12,  66),
    S(  -2,  16), S(  -7,  48), S( -11,  23), S( -27,  76),
    S( -25,  32), S( -16,  20), S( -22,  26), S( -10,  27),
    S(  -1,  27), S( -65,  67), S(  -2,  12), S( -38,  52),
    S( -11,  19), S(  20,   9), S(   9,  10), S(  -5,  21),
};

const int KingPSQT32[32] = {
    S(  47, -80), S(  45, -56), S( -23, -14), S( -35, -26),
    S(  28, -23), S( -13, -13), S( -46,  13), S( -67,  14),
    S(  -5, -22), S(   6, -18), S(  13,   4), S( -16,  22),
    S(   1, -30), S(  95, -32), S(  47,  11), S(  -3,  32),
