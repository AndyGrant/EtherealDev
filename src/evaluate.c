...
const int PawnBackwards[2] = { S(   5,  -9), S( -10, -11) };

const int PawnConnected32[32] = {
    S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
    S(   4,  -1), S(  10,   8), S(   4,   4), S(   2,  19),
    S(  17,   6), S(  31,   9), S(  15,  18), S(  15,  27),
    S(   5,   9), S(  25,  17), S(  19,  18), S(  21,  29),
    S(  10,  17), S(  25,  25), S(  36,  33), S(  47,  27),
    S(  24,  54), S(  26,  66), S(  65,  63), S(  52,  75),
