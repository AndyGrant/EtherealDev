...
const int SafetyKnightWeight    = S(  53,  57);
const int SafetyBishopWeight    = S(  26,  58);
const int SafetyRookWeight      = S(  35,   6);
const int SafetyQueenWeight     = S(  32,  54);

const int SafetyAttackValue     = S(  45,  25);
const int SafetyWeakSquares     = S(  41,  25);
const int SafetyNoEnemyQueens   = S(-228,-264);
const int SafetySafeQueenCheck  = S(  88, 122);
const int SafetySafeRookCheck   = S(  87,  94);
const int SafetySafeBishopCheck = S(  58,  94);
const int SafetySafeKnightCheck = S( 108,  74);
const int SafetyAdjustment      = S( -81,  48);
