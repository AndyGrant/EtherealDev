...
const int KingShelter[2][8][8] = {
  {{S( -17,  15), S(   4, -15), S(  11,  -2), S(  21,   1), S(   8,   7), S(  30,   4), S(   0, -31), S( -30,   1)},
   {S(   4,   6), S(  13,  -9), S(  10, -11), S(  -1,  -7), S( -25,   4), S( -65,  78), S( 100,  92), S( -29,  -3)},
   {S(  13,  13), S(   8,  -9), S( -20,   0), S(  -7,   0), S( -21,   1), S(  14,  -7), S(   4,  64), S( -15,  -1)},
   {S(   9,  31), S(   7,  -1), S( -10,  -7), S(  14, -13), S(  13, -29), S( -22, -29), S(-147,  42), S(  -1,  -4)},
   {S( -19,  20), S(  -2,   3), S( -24,   0), S( -16,   4), S( -19,  -5), S( -39, -14), S(  39,  -7), S(  -7,  -3)},
   {S(  22,   3), S(  13,  -6), S( -28,   0), S( -15, -15), S(   5, -27), S(  16, -46), S(  50, -33), S( -14,  -6)},
   {S(  19,   3), S(   6,  -8), S( -17, -10), S( -22, -11), S( -22, -13), S( -41,  11), S(   6,  46), S( -12,  -2)},
   {S( -19,  -3), S(  -2, -15), S(   3,   0), S(  -1,   1), S( -15,  12), S(   3,  33), S(-201,  79), S( -17,  19)}},
  {{S(   0,   0), S(   3, -15), S(   7, -13), S( -43,  20), S(   0,  -7), S(   8,  50), S(-170, -13), S( -51,   7)},
   {S(   0,   0), S(  10, -12), S(   8,  -8), S(  -5,  -6), S(  12, -28), S(  51, 101), S(-187, -10), S( -46,   0)},
   {S(   0,   0), S(  21,  -2), S(   0,  -6), S(  19, -22), S(  14,  -6), S(-113,  45), S( -89, -82), S( -24,  -8)},
   {S(   0,   0), S(  -7,   9), S( -10,  11), S(  -8,   5), S( -21,   2), S(-115,  12), S(   5, -48), S( -29,  -4)},
   {S(   0,   0), S(   0,   3), S(   3,  -5), S(  18,  -1), S(   6, -16), S( -44,   8), S(-108, -71), S(  -3,  -4)},
   {S(   0,   0), S(  -1,  -6), S( -13,   2), S(  -8,  -5), S(  30, -32), S( -43,   6), S(  58,  46), S( -20,   0)},
   {S(   0,   0), S(   9,  -7), S(  -3,  -3), S( -27,  -2), S( -26,  -9), S(  23,  12), S( -57, -63), S( -37,  10)},
   {S(   0,   0), S(  -1, -34), S(  18, -23), S( -12,  -1), S( -27,  -4), S(   7, -14), S(-239, -71), S( -31,  20)}},
};
...
int evaluateKings(EvalInfo *ei, Board *board, int colour) {
    ...
    for (int file = MAX(0, kingFile - 1); file <= MIN(FILE_NB - 1, kingFile + 1); file++) {
        ...
        uint64_t filePawns = myPawns & Files[file];

        int distance = filePawns ? relativeRankOf(US, (backmost(US, filePawns))) : 7;
