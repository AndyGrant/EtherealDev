...
const int PawnPSQT[SQUARE_NB] = {
    ...
    S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
    S( -15,  13), S(  -2,   4), S(  -9,   5), S(  -5,   1),
    S(  -7,   8), S(   0,   6), S(   5,   2), S( -11,   7),
    S( -18,  10), S( -14,   8), S( -10,  -4), S(  -4, -11),
    S(   0,  -9), S(  -8,  -2), S(  -8,   4), S( -16,   7),
    S( -13,  19), S(  -7,  14), S(   5, -10), S(   7, -20),
    S(   9, -21), S(   6,  -5), S(  -7,  10), S( -14,  14),
    S(  -9,  24), S(  -6,  11), S( -14,  -3), S( -11, -21),
    S( -10, -17), S(  -9,  -5), S(  -9,  10), S( -14,  18),
    S(  -6,  45), S(  -8,  37), S(  -3,  23), S(  19,  -2),
    S(  19,  -1), S(   0,  24), S( -16,  39), S( -10,  41),
    S( -16, -53), S( -36, -19), S(   1, -27), S(  46, -44),
    S(  36, -36), S(   4, -24), S( -48,  -6), S( -15, -42),
    S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
    S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
};

const int KnightPSQT[SQUARE_NB] = {
    S( -55, -26), S(  -6, -11), S( -25,  -5), S(  -8,   9),
    S(  -1,   3), S( -17,  -9), S(  -8,  -8), S( -62,   5),
    S(  -5,   4), S(   0,   7), S(  -3, -11), S(   2,   3),
    S(   0,   5), S(  -5, -10), S(  -6,   5), S(  -6,  10),
    S(  10, -11), S(  12,   3), S(   7,   7), S(  12,  23),
    S(  16,  20), S(   5,   5), S(   9,   1), S(   5, -11),
    S(  16,  23), S(  12,  36), S(  23,  41), S(  22,  49),
    S(  18,  51), S(  18,  44), S(  10,  32), S(  10,  31),
    S(  21,  35), S(  19,  34), S(  30,  52), S(  21,  67),
    S(  17,  65), S(  28,  55), S(  17,  35), S(  11,  36),
    S( -22,  31), S( -10,  40), S(  17,  57), S(  12,  57),
    S(  17,  52), S(  15,  56), S( -22,  41), S( -15,  28),
    S(  16,   9), S(  -9,  21), S(  25,   2), S(  19,  33),
    S(  27,  28), S(  31,  -3), S(  -8,  21), S(  -1,   5),
    S(-169,   2), S( -68,  12), S(-114,  41), S( -41,  20),
    S( -18,  17), S( -94,  48), S( -78,  18), S(-165, -14),
};

const int BishopPSQT[SQUARE_NB] = {
    S(   5, -10), S(   6,  11), S(  -8,  15), S(   1,  12),
    S(   4,  15), S( -11,   9), S(   0,  13), S(   4,  -7),
    S(  21, -10), S(   2, -19), S(  14,   3), S(   5,  14),
    S(   6,  13), S(  12,  -1), S(   8, -20), S(  20, -20),
    S(   8,  10), S(  20,  13), S(  -5,   4), S(  15,  21),
    S(  14,  23), S(  -5,   1), S(  18,   9), S(  15,  14),
    S(   1,  16), S(  11,  22), S(  12,  32), S(  13,  35),
    S(  19,  35), S(   8,  31), S(  16,  21), S(   6,  17),
    S( -18,  36), S(  11,  33), S(  -5,  42), S(  11,  48),
    S(   2,  48), S(   2,  40), S(   9,  36), S( -16,  38),
    S(  -6,  28), S( -18,  46), S(  -8,  26), S(  -2,  44),
    S(   4,  41), S( -20,  37), S( -15,  46), S(  -8,  35),
    S( -48,  42), S( -43,  24), S( -11,  30), S( -26,  40),
    S( -33,  41), S( -13,  36), S( -63,  22), S( -61,  46),
    S( -49,  19), S( -59,  40), S(-110,  49), S( -98,  60),
    S(-106,  54), S( -75,  46), S(  -2,  20), S( -61,  16),
};

const int RookPSQT[SQUARE_NB] = {
    S( -24,  12), S( -22,  17), S( -15,  17), S(  -7,   8),
    S(  -7,   9), S( -12,  15), S( -19,  13), S( -19,   1),
    S( -52,  18), S( -20,   5), S( -16,   6), S( -11,   2),
    S( -10,   1), S( -19,   0), S( -13,  -1), S( -64,  23),
    S( -33,  18), S( -18,  26), S( -25,  21), S( -12,  13),
    S( -11,  15), S( -27,  20), S(  -9,  22), S( -37,  19),
    S( -26,  33), S( -22,  45), S( -19,  44), S(  -6,  35),
    S(  -6,  37), S( -20,  43), S( -16,  44), S( -28,  35),
    S( -16,  51), S(   1,  47), S(  11,  46), S(  27,  39),
    S(  23,  42), S(   6,  45), S(   6,  42), S( -15,  50),
    S( -28,  62), S(  14,  46), S(  -2,  59), S(  23,  43),
    S(  22,  43), S(  -8,  64), S(  23,  41), S( -32,  64),
    S( -11,  45), S( -19,  52), S(  -1,  45), S(  15,  46),
    S(  13,  45), S(  -8,  45), S( -21,  56), S(  -7,  45),
    S(  29,  56), S(  17,  66), S( -10,  75), S(  -6,  71),
    S(  -6,  73), S( -19,  78), S(  26,  65), S(  26,  64),
};

const int QueenPSQT[SQUARE_NB] = {
    S(  21, -17), S(  -3,   6), S(   5,  -6), S(  13,  10),
    S(  13,  11), S(   5, -12), S(   5,  -7), S(  23, -27),
    S(   4,  13), S(  13,   5), S(  17, -13), S(   8,  29),
    S(  12,  25), S(  21, -32), S(  28, -19), S(  12,   0),
    S(   1,  31), S(  15,  38), S(  -1,  61), S(  -4,  56),
    S(  -4,  57), S(  -2,  60), S(  18,  32), S(   6,  11),
    S(   5,  42), S(   6,  67), S(  -9,  82), S( -25, 126),
    S( -26, 126), S( -14,  77), S(  11,  67), S(  -3,  54),
    S(  -9,  64), S( -12,  97), S( -23,  82), S( -41, 138),
    S( -47, 148), S( -34,  97), S( -19, 110), S( -21,  85),
    S( -30,  77), S( -24,  71), S( -37,  90), S( -25,  83),
    S( -28,  91), S( -38,  81), S( -38,  89), S( -49, 100),
    S( -15,  82), S( -67, 124), S( -18,  78), S( -48, 121),
    S( -58, 126), S( -26,  74), S( -56, 129), S(  -3,  94),
    S( -17,  74), S(  12,  59), S( -19,  98), S( -15,  84),
    S( -18,  89), S( -23,  87), S(  47,  73), S(  25,  58),
};

const int KingPSQT[SQUARE_NB] = {
    S(  49, -72), S(  50, -59), S(   3, -21), S( -41, -19),
    S( -12, -36), S( -24, -11), S(  42, -57), S(  51, -83),
    S(  33, -25), S( -11, -22), S( -38,   6), S( -75,  16),
    S( -63,  12), S( -52,   9), S( -16, -18), S(  27, -23),
    S(  -2, -27), S(   9, -26), S(  17,  -3), S( -23,  22),
    S(  -8,  17), S(   6,   1), S(   2, -24), S(  -6, -25),
    S(   8, -35), S(  91, -38), S(  63,   3), S( -30,  37),
    S(   3,  29), S(  47,   8), S(  81, -32), S( -24, -29),
    S(  29, -12), S( 116, -29), S(  56,  15), S( -19,  31),
    S(  -6,  29), S(  61,  18), S(  96, -24), S(  -6, -10),
    S(  51, -25), S( 132, -16), S(  99,  11), S(  22,  11),
    S(  29,   8), S(  98,  11), S( 133, -12), S(  50, -25),
    S(  36, -64), S(  47,  -5), S(  57,   4), S(  31,  -3),
    S( -19,   5), S(  35,   8), S(  66,  -2), S(  35, -65),
    S(  20,-132), S(  61, -57), S(   1, -31), S( -17, -12),
    S( -16, -30), S( -25, -29), S(  51, -66), S( -30,-107),
};
