...
const int KingStorm[2][FILE_NB][RANK_NB] = {
  {{S(   4,  -5), S(   2,  -2), S(  -1,   0), S( -13,  -1), S(  15,  13), S( -26,  15), S( -17,  18), S(   0,   4)},
   {S(   3,   0), S(   1,  -2), S(   0,   1), S(   1,   2), S(  14,  11), S( -10,   4), S(-237,   0), S(  -3,   1)},
   {S(   8,  -2), S(   2,   0), S(   1,   1), S(   0,  -2), S(   1,  -3), S(  25,   5), S(   2,  54), S(   3,   1)},
   {S(  -2,  -3), S(  -1,   2), S(  -2,   0), S(   2,  -1), S(   1,  -6), S( -30,  14), S(  73, -12), S(   0,   0)},
   {S(   1,   1), S(   0,   2), S(   0,   3), S(   0,  -1), S(   1,  -1), S(  -3,   1), S(   7,  33), S(   0,   0)},
   {S(   3,   2), S(   1,   0), S(  -2,   0), S(   0,  -1), S(   7,  -3), S(  17,   9), S(  22,  -2), S(   0,   1)},
   {S(  -2,   2), S(   0,   0), S(   0,   1), S(  -1,   0), S(   5,   2), S( -16,  10), S(  -1, -16), S(   0,   0)},
   {S(   0,   0), S(   0,  -1), S(  -1,   0), S(  -4,   0), S(  -1,   0), S( -28, -11), S(  -3,  37), S(   0,   0)}},
  {{S(-240,  17), S(  -3,   2), S(   8,  -5), S(  20,  -2), S(  -8,  -5), S(   8, -29), S(   0,   0), S(   0,   0)},
   {S(-158, -63), S( -18, -13), S(  14, -14), S(  10,  -6), S(  -9,  -1), S(  33, -25), S(   0,   0), S(   0,   0)},
   {S(  77,   0), S(  -6, -14), S(  17,  -2), S(  11,   1), S(  -4,  -7), S( -15,  29), S(   0,   0), S(   0,   0)},
   {S( -61,  63), S( -15, -10), S(  -4,  -1), S(  -2,  -8), S(  -2, -11), S(  36,  60), S(   0,   0), S(   0,   0)},
   {S(-253,-111), S( -11, -11), S(   0,   0), S(   4,   1), S(   4,  -4), S(  62,   3), S(   0,   0), S(   0,   0)},
   {S( -81, -13), S( -11, -12), S(  -7,  -2), S( -10,   3), S( -25,  -6), S( -14, -14), S(   0,   0), S(   0,   0)},
   {S(  18, -30), S(  -3, -11), S(  18,  -1), S(   5,   5), S(  -4,  -1), S(  -3,  12), S(   0,   0), S(   0,   0)},
   {S(-110, -36), S(  -2,  -4), S(   8,  -3), S(  14,  -1), S(   1,   1), S(   0,   8), S(   0,   0), S(   0,   0)}},
};
