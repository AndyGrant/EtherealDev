...
const int KnightMobility[9] = {
    S( -90, -85), S( -37, -94), S( -27, -44), S(  -6, -20),
    S(   0, -19), S(   6,  -4), S(  19,  -2), S(  32,  -7),
    S(  50, -52),
};
...
const int BishopMobility[14] = {
    S( -58,-127), S( -47, -66), S( -28, -48), S( -14, -29),
    S(   5, -19), S(  16,  -7), S(  22,   3), S(  26,   0),
    S(  28,  10), S(  32,   3), S(  33,   2), S(  42, -23),
    S(  44,  -5), S(  35, -51),
};
...
const int RookMobility[15] = {
    S(-147,-106), S( -74,-120), S( -18, -67), S( -13, -28),
    S(  -8,  -6), S( -11,   8), S( -11,  19), S(  -4,  28),
    S(   3,  33), S(  13,  44), S(  16,  49), S(  22,  57),
    S(  24,  59), S(  27,  45), S(  17,  23),
};

/* Queen Evaluation Terms */

const int QueenMobility[28] = {
    S( -60,-262), S(-215,-389), S( -48,-205), S( -36,-190),
    S( -18,-132), S( -24, -69), S( -13, -91), S( -15, -75),
    S( -15, -62), S( -12, -52), S( -10, -30), S(  -4, -26),
    S(   0, -15), S(   3,  -7), S(   3,  -1), S(   3,   5),
    S(   2,  15), S(   2,  14), S(   9,  20), S(   0,  18),
    S(   0,  17), S(  18,  20), S(   5,   0), S(  30,   3),
