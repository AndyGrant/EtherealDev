...
const int KingShelter[2][FILE_NB/2][RANK_NB] = {
  {{S( -12,  -3), S(  12, -16), S(  20,  -6), S(   0,   7),
    S(  -1,   1), S(  -3,   0), S(  -3, -34), S( -25,  11)},
   {S(  17,  -9), S(  14, -20), S( -10, -10), S( -21,  -3),
    S( -34,  12), S( -74,  66), S(  91,  81), S( -22,  -6)},
   {S(  39,   2), S(  23,   1), S( -21,  14), S( -13,  -8),
    S(   0,  -4), S( -12,   1), S(   0,  67), S( -21,   3)},
   {S(   1,  22), S(  21,  -2), S(   4,  -5), S(  25, -14),
    S(  48, -36), S( -57,   4), S(-135,  51), S(  19,  -8)}},
  {{S(   0,   0), S(  10, -24), S(  14, -18), S(   7, -17),
    S(  16, -30), S( -57,  14), S(-101, -60), S(  -8,   1)},
   {S(   0,   0), S(  32, -11), S(  23, -13), S(  -7, -16),
    S(  -6,  -7), S( -84,  48), S( -84, -74), S( -32,   0)},
   {S(   0,   0), S(  13,  -2), S(  -5,  -8), S(  -6,  -9),
    S( -25,  13), S(  -8,  18), S( -57, -50), S( -31,   2)},
   {S(   0,   0), S(   0,  -2), S(   6, -15), S(   9, -13),
    S(  13,  13), S( -11,  20), S(-228, -56), S(  -5, -14)}},
};
