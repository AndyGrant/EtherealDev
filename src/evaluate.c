...
const int PawnConnected[SQUARE_NB] = {
    S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
    S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
    S(  -1,  -2), S(  10,  -3), S(   4,   3), S(   6,   9),
    S(  10,  12), S(   2,  -1), S(  13,  -2), S(  -5, -10),
    S(  11,   0), S(  23,  -5), S(  26,   4), S(  23,  10),
    S(  25,  13), S(  23,   4), S(  22,  -4), S(  12,   3),
    S(   6,   1), S(  20,   2), S(  11,   5), S(  15,  14),
    S(  17,  14), S(   7,   7), S(  17,   1), S(   8,  -3),
    S(   6,  13), S(  18,  19), S(  27,  23), S(  29,  15),
    S(  33,  17), S(  27,  20), S(  18,  17), S(   3,  12),
    S(  47,  25), S(  43,  49), S(  62,  61), S(  73,  69),
    S(  73,  68), S(  63,  61), S(  44,  48), S(  47,  25),
    S( 111,  -6), S( 203,   0), S( 226,  26), S( 235,  40),
    S( 235,  40), S( 226,  25), S( 203,  -1), S( 111,  -7),
    S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
    S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
};
