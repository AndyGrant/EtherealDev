...
const int KnightMobility[9] = {
    S( -91, -86), S( -45, -97), S( -30, -47), S(  -6, -27),
    S(   0, -23), S(   4,  -7), S(  18,  -3), S(  29,  -7),
    S(  46, -61),
};
...
const int BishopMobility[14] = {
    S( -60,-127), S( -47, -69), S( -25, -54), S( -12, -38),
    S(   6, -25), S(  18, -10), S(  23,   1), S(  26,  -1),
    S(  28,  10), S(  34,   2), S(  34,   3), S(  41, -28),
    S(  45,  -7), S(  28, -77),
};
...
const int RookMobility[15] = {
    S(-148,-107), S( -67,-119), S( -26, -70), S( -14, -31),
    S( -12, -10), S( -14,   8), S( -12,  20), S(  -5,  28),
    S(   2,  39), S(  12,  48), S(  17,  52), S(  26,  61),
    S(  29,  65), S(  33,  48), S(  26,  19),
};

/* Queen Evaluation Terms */

const int QueenMobility[28] = {
    S( -60,-263), S(-216,-389), S( -48,-205), S( -40,-190),
    S( -33,-133), S( -33, -70), S( -20, -92), S( -21, -77),
    S( -16, -62), S( -10, -53), S(  -7, -34), S(  -1, -27),
    S(   1, -16), S(   5,  -7), S(   7,   0), S(   7,   7),
    S(   7,  17), S(   6,  16), S(  13,  22), S(   2,  18),
    S(   1,  18), S(  18,  19), S(   5,  -1), S(  31,   3),
    S(  34,  11), S(  57,  -7), S( -50, -18), S(   0,  -2),
};
