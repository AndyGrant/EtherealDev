...
const int ThreatTabulation[PIECE_NB][PIECE_NB] = {
   {S(  18,  10), S(  -4, -28), S( -10, -27), S(  -9, -36), S(  -5,  -4), S(   0, -16)},
   {S( -53, -31), S(  13,   8), S( -31, -19), S( -21, -33), S( -17, -10), S( -12, -24)},
   {S( -52, -32), S( -34, -27), S(   5,   3), S( -20, -41), S( -14, -11), S(  -9, -20)},
   {S( -28, -17), S( -46, -18), S( -41, -15), S(  11,  -1), S( -10,  -4), S( -13, -25)},
   {S( -44,  -9), S( -11,  -1), S( -40,  -8), S( -38, -13), S(  17,   5), S(   0,   0)},
