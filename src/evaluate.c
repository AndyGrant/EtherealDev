...
const int PawnValue[PHASE_NB] = {  98,  93};



const int PawnIsolated[PHASE_NB] = {  -1, -12};

const int PawnStacked[PHASE_NB] = { -22, -19};

const int PawnBackwards[2][PHASE_NB] = { {   3,   0}, { -11, -14} };
...
const int PawnConnected32[32][PHASE_NB] = {
    ...
    {  12,   4}, {  12,   4}, {   9,   8}, {  16,  17},
    {   7,   2}, {  15,   6}, {   7,   6}, {  16,  12},
    {  18,   6}, {  18,  14}, {  23,  14}, {  24,  17},
    {  32,  -7}, {  46,   2}, {  77,  30}, {  70,  36},
    { 114, -73}, { 149, -68}, { 107, -66}, { 173,   0},
    {   0,   0}, {   0,   0}, {   0,   0}, {   0,   0},
};


const int KnightValue[PHASE_NB] = { 309, 288};

const int KnightOutpost[2][PHASE_NB] = { {  18, -17}, {  35,  15} };
...
const int BishopValue[PHASE_NB] = { 307, 291};

const int BishopWings[PHASE_NB] = {   0,  -3};

const int BishopPair[PHASE_NB] = {  33,  53};

const int BishopOutpost[2][PHASE_NB] = { {  18,  -7}, {  38,  -1} };

const int BishopMobility[14][PHASE_NB] = {
    { -56, -57}, { -30, -46}, { -10, -25}, {  -1, -10},
    {   9,  -2}, {  15,   9}, {  20,  17}, {  22,  17},
    {  26,  21}, {  27,  18}, {  28,  21}, {  23,   2},
    {  28,  16}, { -35, -38},
};


const int RookValue[PHASE_NB] = { 441, 481};

const int RookFile[2][PHASE_NB] = { {  10,   1}, {  25,   3} };

const int RookOnSeventh[PHASE_NB] = {  11,  14};

const int RookMobility[15][PHASE_NB] = {
    {-137,-102}, { -43, -78}, { -12, -40}, {  -3, -16},
    {  -3,  -2}, {  -2,  11}, {  -4,  20}, {  -1,  25},
    {   5,  33}, {  13,  37}, {  17,  40}, {  21,  45},
    {  21,  45}, {  20,  37}, {  16,  31},
};


const int QueenValue[PHASE_NB] = { 891, 902};

const int QueenChecked[PHASE_NB] = { -26, -23};

const int QueenCheckedByPawn[PHASE_NB] = { -28, -22};

const int QueenMobility[28][PHASE_NB] = {
    { -73, -73}, { -90,-244}, { -69, -88}, { -37, -63},
    { -22, -81}, { -18, -37}, {  -9, -33}, {  -7, -28},
    {  -3, -24}, {   0, -16}, {   4,  -8}, {   8,   0},
    {  10,   6}, {  12,  13}, {  13,  18}, {  13,  29},
    {  11,  33}, {  11,  34}, {  12,  36}, {  13,  38},
    {  14,  36}, {  20,  35}, {  23,  37}, {  26,  32},
    {  26,  30}, {  17,  22}, {  37,  40}, {   3,  15},
};


const int PassedPawn[2][2][RANK_NB][PHASE_NB] = {
  {{{   0,   0}, { -29,  -9}, { -24,  -6}, { -21, -14}, {  24, -10}, {  53, -11}, { 109,  11}, {   0,   0}},
   {{   0,   0}, {  -6,   4}, { -10,  12}, {  -9,  21}, {  20,  20}, {  68,  32}, { 136,  56}, {   0,   0}}},
  {{{   0,   0}, {  -6,   5}, { -11,   0}, {  -8,  11}, {  24,  21}, {  81,  45}, { 148,  69}, {   0,   0}},
   {{   0,   0}, {   3,  10}, {  -1,  13}, {  -3,  39}, {  14,  80}, {  67, 149}, { 135, 234}, {   0,   0}}},
};
