...
const int ThreatWeakPawn = S( -25, -34);
const int ThreatMinorAttackedByPawn = S( -66, -53);
const int ThreatMinorAttackedByMinor = S( -26, -12);
const int ThreatMinorAttackedByMajor = S( -44, -43);
const int ThreatRookAttackedByLesser = S( -53, -25);
const int ThreatQueenAttackedByOne = S( -91,   1);
const int ThreatOverloadedPieces = S(  -5, -21);
const int ThreatByPawnPush = S(  23,  17);
