...
const int PawnIsolated[PHASE_NB] = {  -3,  -9};

const int PawnStacked[PHASE_NB] = { -12, -19};
...
const int PawnConnected32[32][PHASE_NB] = {
    ...
    {   9,   1}, {   6,   2}, {   2,   3}, {   7,   2},
    {   3,   1}, {   5,   5}, {   3,   2}, {  10,   5},
    {   4,   9}, {  10,  13}, {   9,  12}, {  25,  19},
    {  12,  22}, {  23,  27}, {  48,  28}, {  39,  29},
    {  45,  15}, {  42,  11}, {  50,  25}, {  45,  24},
    {   0,   0}, {   0,   0}, {   0,   0}, {   0,   0},
};


const int KnightValue[PHASE_NB] = { 314, 299};

const int KnightOutpost[2][PHASE_NB] = { {  13, -11}, {  28,   9} };
...
const int BishopValue[PHASE_NB] = { 312, 300};

const int BishopWings[PHASE_NB] = {  -5,   7};

const int BishopPair[PHASE_NB] = {  36,  48};

const int BishopOutpost[2][PHASE_NB] = { {  12,  -8}, {  28,  -5} };

const int BishopMobility[14][PHASE_NB] = {
    { -40, -50}, { -42, -32}, { -18, -21}, {   0,  -6},
    {   9,   2}, {  18,  11}, {  23,  17}, {  26,  18},
    {  28,  21}, {  26,  20}, {  26,  23}, {  32,  15},
    {  36,  25}, {  19,   7},
};


const int RookValue[PHASE_NB] = { 446, 479};

const int RookFile[2][PHASE_NB] = { {   7,   8}, {  24,   3} };

const int RookOnSeventh[PHASE_NB] = {   1,   9};

const int RookMobility[15][PHASE_NB] = {
    {-117, -89}, { -57, -49}, { -10, -30}, {  -6, -11},
    {  -4,   0}, {   0,  12}, {  -2,  22}, {   0,  25},
    {   4,  32}, {  11,  33}, {  15,  37}, {  18,  41},
    {  18,  43}, {  19,  42}, {  14,  38},
};


const int QueenValue[PHASE_NB] = { 836, 875};

const int QueenMobility[28][PHASE_NB] = {
    {-142, -50}, { -50,-245}, { -93,-117}, { -55, -63},
    { -21, -73}, { -16, -32}, {  -6, -30}, {  -4, -27},
    {  -2, -27}, {   0, -20}, {   1,  -9}, {   4,  -5},
    {   5,   2}, {   8,   8}, {   9,  13}, {  10,  22},
    {  10,  28}, {  10,  30}, {  11,  31}, {  14,  37},
    {  16,  40}, {  26,  40}, {  29,  45}, {  36,  42},
    {  40,  46}, {  34,  36}, {  52,  56}, {  28,  43},
};

const int PassedPawn[2][2][RANK_NB][PHASE_NB] = {
 {{{   0,   0}, {  -8,  -7}, { -16,   4}, { -15,   5}, {  12,  23}, {  43,  28}, {  65,  40}, {   0,   0}},
  {{   0,   0}, {  -4,  -1}, { -15,   9}, {  -8,  20}, {  10,  34}, {  51,  46}, {  82,  74}, {   0,   0}}},
 {{{   0,   0}, {   0,   8}, {  -8,   6}, {  -4,  20}, {  21,  29}, {  67,  55}, { 117, 125}, {   0,   0}},
  {{   0,   0}, {   2,   3}, {  -7,   7}, {  -6,  31}, {  11,  71}, {  73, 164}, { 180, 282}, {   0,   0}}}
};
