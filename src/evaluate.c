...
void initializeEvalInfo(EvalInfo* ei, Board* board, PawnKingTable* pktable){
    ...
    ei->mobilityAreas[WHITE] = ~((ei->pawnAttacks[BLACK] & ~whitePawns) | (white & kings) | (ei->blockedPawns[WHITE] & ~ei->pawnAttacks[BLACK]));
    ei->mobilityAreas[BLACK] = ~((ei->pawnAttacks[WHITE] & ~blackPawns) | (black & kings) | (ei->blockedPawns[BLACK] & ~ei->pawnAttacks[WHITE]));
