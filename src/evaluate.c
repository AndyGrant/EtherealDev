...
const int ThreatWeakPawn[2][PHASE_NB]  = { {  -7,  -7}, {  -3,  -3} };

const int ThreatWeakMinor[2][PHASE_NB] = { { -17, -17}, { -27, -27} };

const int ThreatWeakRook[2][PHASE_NB]  = { { -28, -28}, { -42, -42} };

const int ThreatWeakQueen[2][PHASE_NB] = { { -48, -48}, { -64, -64} };
