...
const int KingShelter[2][FILE_NB/2][RANK_NB] = {
  {{S( -22,   0), S(   0, -11), S(   7,   1), S(   1,   7), S(  -6,   2), S(   6,   5), S(   0,   0), S( -27,  12)},
   {S(  23,   4), S(  14,  -9), S(  -8,  -2), S( -15,  -1), S( -13,  -5), S(  -1,   0), S(   0,   0), S( -14,   6)},
   {S(  31,   6), S(  18,   3), S( -22,  12), S(  -4, -14), S(  10, -11), S(   1,   0), S(   0,   0), S( -18,   8)},
   {S(  -2,  22), S(  10,   0), S(  -7,  -2), S(  23, -16), S(  29, -18), S(  -1,  -2), S(   0,   0), S(   1,   0)}},
  {{S(   0,   0), S(   4, -14), S(  10,  -8), S( -10,  -1), S(  -1,   1), S(   1,   1), S(   0,   0), S( -17,  17)},
   {S(   0,   0), S(  26,   0), S(  13,  -2), S( -14,   1), S( -20,   2), S(   0,   0), S(  -1,   0), S( -41,  15)},
   {S(   0,   0), S(  14,   3), S(  -8,   0), S(   8, -10), S(   8,   0), S(   0,   0), S(   0,   0), S( -26,   3)},
   {S(   0,   0), S(   3,  12), S(   7,   1), S(  24, -10), S(  23,  -9), S(   0,   0), S(   0,   0), S(  -1,  -6)}},
};
