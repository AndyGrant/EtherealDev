...
const int SafetyKnightWeight = S(  10,  15);
const int SafetyBishopWeight = S(  -1,   5);
const int SafetyRookWeight   = S(   8,   7);
const int SafetyQueenWeight  = S(   6,   6);

const int SafetyAttackValue     = S(  33,  33);
const int SafetyWeakSquares     = S(  36,  30);
const int SafetyFriendlyPawns   = S( -36, -23);
const int SafetyNoEnemyQueens   = S(-279,-277);
const int SafetySafeQueenCheck  = S(  95,  93);
const int SafetySafeRookCheck   = S(  94,  93);
const int SafetySafeBishopCheck = S(  51,  51);
const int SafetySafeKnightCheck = S( 123, 123);
const int SafetyAdjustment      = S( -25, -20);
