...
const int KingShelter[2][FILE_NB/2][RANK_NB] = {
  {{S( -24,   3), S(   4,  -5), S(  10,   2), S(   2,   8),
    S(  -4,   0), S(   0,  13), S(  -8,   1), S( -27,  11)},
   {S(  15,   5), S(  20,  -6), S(  -2,   1), S( -13,   4),
    S( -19,  -7), S(  -7,   9), S(   0,   3), S( -15,   4)},
   {S(  28,   4), S(  19,   2), S( -20,  16), S(  -1,  -9),
    S(  17, -30), S(  -1,  -9), S(  -4,   1), S( -16,   8)},
   {S(  -1,  16), S(  21,   0), S(   3,  -4), S(  30, -16),
    S(  32, -31), S(  -7, -21), S(  -8,  -5), S(   7,   0)}},
  {{S(   0,   0), S(   9, -10), S(  13, -12), S( -26,   6),
    S( -10,  11), S(   7,  13), S(   0,   2), S( -28,  16)},
   {S(   0,   0), S(  28,   1), S(  15,   2), S(  -7,   6),
    S( -20,  11), S(  -4,   3), S( -18,  -3), S( -36,  13)},
   {S(   0,   0), S(  17,   2), S(  -8,   5), S(  11, -10),
    S(  22,  -4), S(   2, -10), S(   2,  -4), S( -37,   8)},
   {S(   0,   0), S(  16,   8), S(  18,   0), S(  31,  -9),
    S(  23, -25), S( -14, -12), S(  -9,  -4), S(   0,  -3)}},
};
