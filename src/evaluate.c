...
const int KingShelter[2][2][RANK_NB] = {
  {{S( -11,   2), S(  10,  -6), S(  -9,  -2), S(  -9,   0),
    S(   1,   3), S(  -6,   7), S(  10, -11), S(   0,   0)},
   {S( -10,   8), S(   3, -11), S(  11,  -5), S(   7,   3),
    S(   6,   8), S(  -1,   8), S(  -1,  -4), S(   0,   0)}},
  {{S(  -8,   5), S(  10,  -8), S(   4,  -4), S(   1,  -1),
    S(  -6,  10), S(  -1,  14), S(   6,  -2), S(   0,   0)},
   {S( -10,   9), S(  -8, -19), S(   6, -16), S(   1,  -9),
    S(  -2,   0), S(   2,  13), S(   5,   9), S(   0,   0)}},
};

const int KingStorm[2][2][RANK_NB] = {
  {{S(   1,   5), S( -10,  17), S( -18,  16), S(  -3,   8),
    S(   1,   6), S(   8,  -1), S(   4,  -1), S(   0,   0)},
   {S( -19,   5), S(  24,  11), S(  12,   7), S( -10,   7),
    S(  -8,   5), S(  -3,   1), S( -10,   3), S(   0,   0)}},
  {{S(   0,   0), S(   0,   0), S( -13, -13), S(   6,  -1),
    S(   5,  -7), S(  10, -12), S(   0, -11), S(   0,   0)},
   {S(   0,   0), S(   0,   0), S( -12, -26), S(  18, -10),
    S(   4,  -4), S(   5,  -6), S(   7,   0), S(   0,   0)}},
};
