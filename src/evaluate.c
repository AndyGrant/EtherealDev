...
const int KingShelter[2][8][8] = {
  {{S( -18,  15), S(  14,  -9), S(  18,  -2), S(  14,   0), S(   6,   6), S(  30,   3), S(   0, -33), S( -46,   7)},
   {S(   4,   4), S(  26,  -5), S(  14,  -7), S(  -4,  -9), S( -25,   0), S( -66,  78), S( 100,  93), S( -40,   0)},
   {S(  17,  11), S(  13,   0), S( -22,   3), S(  -6,  -4), S( -22,  -3), S(  13,  -9), S(   4,  65), S( -23,   1)},
   {S(   7,  26), S(  17,   0), S(   6,  -7), S(  18, -19), S(  22, -35), S( -20, -31), S(-147,  41), S(  -5,  -1)},
   {S( -14,  20), S(   3,   2), S( -24,   4), S( -14,   1), S( -25, -15), S( -41, -19), S(  38,  -8), S( -13,  -2)},
   {S(  31,  -3), S(  22,  -6), S( -18,   8), S( -12, -23), S(   4, -34), S(  16, -48), S(  49, -34), S( -26,  -1)},
   {S(  23,  -1), S(   0,  -7), S( -21,   0), S( -22, -12), S( -25, -21), S( -42,   9), S(   6,  47), S( -20,   0)},
   {S( -18,  -1), S(   5,  -7), S(  11,   1), S(  -6,   8), S( -16,   8), S(   2,  30), S(-201,  79), S( -30,  12)}},
  {{S(   0,   0), S(   0, -13), S(   3, -15), S( -46,  18), S(   0, -10), S(   9,  51), S(-170, -14), S( -50,  13)},
   {S(   0,   0), S(  20,  -9), S(   4,  -2), S( -11,  -8), S(   9, -32), S(  51, 102), S(-187, -10), S( -53,   4)},
   {S(   0,   0), S(  39,  -2), S(   6,  -6), S(  13, -26), S(  15,  -7), S(-113,  45), S( -89, -84), S( -28,   1)},
   {S(   0,   0), S(  -3,  12), S(  -2,  10), S(  -9,   4), S( -22,   1), S(-116,  10), S(   5, -50), S( -28,  -3)},
   {S(   0,   0), S(   8,   7), S(  13,  -2), S(  17,  -8), S(  16, -25), S( -44,   7), S(-109, -73), S(  -8,  -8)},
   {S(   0,   0), S(   7,   1), S( -10,   0), S( -14, -13), S(  29, -37), S( -45,   4), S(  59,  46), S( -33,  -1)},
   {S(   0,   0), S(  18,   0), S(  11,  -5), S( -25,  -1), S( -30, -11), S(  18,  10), S( -58, -64), S( -57,  16)},
   {S(   0,   0), S(   9, -22), S(  15, -17), S( -24,  -1), S( -25,  -1), S(   7, -16), S(-239, -73), S( -39,  12)}},
};
