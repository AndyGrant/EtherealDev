...
const int KingShelterStorm[FILE_NB][RANK_NB][RANK_NB] = {
  {{S(   0,   0), S(   0,  -1), S(  -8,  19), S(  -4,   3),
    S(  -7,  -3), S( -10,  -1), S(   0,   0), S( -23,   7)},
   {S(   0,   0), S(   0,   0), S(   7, -30), S(   0, -20),
    S(   2, -26), S(   8, -29), S(   3, -17), S( -10, -24)},
   {S(   1,   2), S(   3,   0), S(   0,   0), S(  38, -20),
    S(   7,  -4), S(  10,  -8), S(   0,   5), S(  -4,  -6)},
   {S(   0,   0), S(   1,   0), S(  -1,   1), S(   0,   0),
    S(  22,   4), S(  11,   2), S(   0,  14), S( -10,   9)},
   {S(   0,   0), S(   0,   0), S(  -1,  -2), S(   0,   0),
    S(   0,   0), S(  20, -27), S( -12,   5), S( -15,   7)},
   {S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   1),
    S(  -1,  -1), S(   0,   0), S( -10,  15), S( -21,  16)},
   {S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
    S(   0,   0), S(   0,   0), S(   0,   0), S(  -1,   4)},
   {S( -17,  55), S(  85,   8), S( -42,  41), S( -44,  31),
    S( -52,  30), S( -39,  26), S( -45,  42), S( -59,  24)}},
  {{S(   0,   0), S(   0,  -1), S(   6,  -1), S(  21,  -6),
    S(  30, -13), S(  34, -21), S(   0,   0), S(   8,  -2)},
   {S(   1,   4), S(   0,   0), S(  22, -32), S(  17, -11),
    S(  24, -15), S(  42, -26), S(  33, -18), S(   9, -11)},
   {S(   1,   3), S(  14,   7), S(   0,   0), S(  56, -24),
    S(  11,  -2), S(  29, -19), S(  23, -12), S(  -3,   0)},
   {S(   1,   1), S(   2,   3), S(   1,  -3), S(   0,   0),
    S(   7,  -9), S(  13, -18), S(   6, -11), S( -12,   6)},
   {S(   1,   1), S(   4,   1), S(   1,  -1), S(  -5,  -2),
    S(   0,   0), S(  19, -30), S(  -6,  -2), S( -10,   1)},
   {S(   0,   0), S(   1,   1), S(   1,   3), S(   0,   4),
    S(  -1,   1), S(   0,   0), S(  19,  29), S(  -4,  56)},
   {S(   0,   0), S(   0,   0), S(   0,   0), S(  -1,   0),
    S(  -1,   0), S(  -1,   0), S(   0,   0), S(   6,  32)},
   {S(  -9,  51), S(  36,  22), S( -36,  21), S( -24,  13),
    S( -24,  11), S( -16,   2), S( -23,   8), S( -38,  11)}},
  {{S(   0,   0), S(  -3,  -2), S(   5,  17), S(  17,   9),
    S(  24,   8), S(  31,   8), S(   0,   0), S(  23,  14)},
   {S(   1,   8), S(   0,   0), S( -11, -12), S( -17,  14),
    S(  -3,   6), S(   7,   0), S(   8,  -4), S(  -1,   9)},
   {S(   2,   6), S(   1,  -3), S(   0,   0), S( -17,  -2),
    S( -30,  12), S( -17,   3), S( -20, -10), S( -27,  12)},
   {S(   0,   0), S(   1,  -1), S(  -5,  -6), S(   0,   0),
    S( -14,  -8), S( -16, -15), S( -15, -19), S( -23,   4)},
   {S(   0,   0), S(   3,   3), S(   2,   0), S( -16,  -7),
    S(   0,   0), S( -19, -13), S(  -9, -18), S( -18,  13)},
   {S(   0,   1), S(   0,   0), S(   1,   2), S(  -4,   0),
    S(  -2,  -1), S(   0,   0), S( -25, -13), S( -23,  26)},
   {S(   0,   0), S(   0,   0), S(   0,   0), S(  -1,   0),
    S(   0,   1), S(  -1,  -1), S(   0,   0), S(   3,  25)},
   {S( -15,  43), S( -12,  29), S( -43,  21), S( -43,  15),
    S( -35,  13), S( -24,   8), S( -31,   6), S( -29,  14)}},
  {{S(   0,   0), S(   1,   1), S(   2,  14), S(   9,   7),
    S(  17,  11), S(  36,   5), S(   0,   0), S(  18,  19)},
   {S(   2,   4), S(   0,   0), S(  10, -24), S(   4,  -9),
    S(  18,  -8), S(  37, -19), S(  28, -20), S(  20,   1)},
   {S(  -2,  -5), S(   7,   6), S(   0,   0), S(  -1,  -8),
    S(   4, -13), S(  22, -22), S(  13, -19), S(   5,  -3)},
   {S(  -1,  -2), S(   2,   3), S(  -1,  -8), S(   0,   0),
    S(  17, -24), S(  27, -31), S(  20, -24), S(   9,  -6)},
   {S(   1,   0), S(   0,   1), S(  -6, -12), S(  -3,  -8),
    S(   0,   0), S(  31, -62), S(  30, -26), S(  11, -13)},
   {S(   0,   1), S(   0,   0), S(  -3,   1), S( -12,  -3),
    S( -26,  -9), S(   0,   0), S(   8,  -2), S( -57,  12)},
   {S(   0,   0), S(   0,   0), S(  -1,  -2), S(  -1,   0),
    S(  -1,  -1), S(  -4,  -1), S(   0,   0), S( -22,  11)},
   {S(  13,  20), S(  21,  12), S( -14,   3), S(  -6,  -6),
    S(  -2,  -3), S(  20, -15), S(  11,  -9), S(   0,   4)}},
  {{S(   0,   0), S(   0,  -4), S( -17,   8), S( -22,   9),
    S(  -1,   8), S(   6,   5), S(   0,   0), S( -18,  19)},
   {S(   7,  14), S(   0,   0), S(   1, -23), S( -14,  -1),
    S(  -6,   2), S(  12, -12), S(   5, -12), S( -11,   8)},
   {S(   1,   5), S(  -1,   3), S(   0,   0), S( -17,  -3),
    S( -13,  -2), S(   8, -20), S(  -2, -17), S( -23,   4)},
   {S(   2,   4), S(   0,  -1), S(  -6,   3), S(   0,   0),
    S(  -7,  -8), S(   5,  -9), S(   1, -17), S( -21,   6)},
   {S(   1,   0), S(  -1,  -4), S(   1,  -4), S( -12,  -6),
    S(   0,   0), S(   0, -46), S(  -4, -14), S( -24,  -3)},
   {S(   0,   0), S(   0,   0), S(  -2,  -3), S( -14,  -2),
    S(  -4,   0), S(   0,   0), S(   5,  -9), S( -45,  -7)},
   {S(   0,   0), S(   0,   0), S(   0,  -1), S(   0,  -1),
    S(   0,   1), S(  -1,  -1), S(   0,   0), S(  -1,   1)},
   {S(   2,  20), S(  -2,  19), S( -28,   7), S( -31,   1),
    S( -30,   7), S( -10,  -4), S( -17,  -2), S( -24,  10)}},
  {{S(   0,   0), S(   4, -11), S(  21,   0), S(  34,  -6),
    S(  48,  -9), S(  47,  -6), S(   0,   0), S(  44,  -1)},
   {S(   7,  15), S(   0,   0), S(   3, -18), S(   5,  -1),
    S(  21,  -5), S(  30, -10), S(  25, -15), S(  22,  -3)},
   {S(  -2,   3), S(  -4,  -4), S(   0,   0), S(   0,  -6),
    S(  -7,   3), S(  -1,  -3), S(  -3,  -7), S(  -9,   4)},
   {S(   0,   1), S(  -6,  -4), S(  -7,  -1), S(   0,   0),
    S(   1, -17), S(   4, -21), S(   5, -31), S(   1, -12)},
   {S(   0,   0), S(   0,   0), S(   0,  -1), S( -11, -14),
    S(   0,   0), S(   5, -36), S(  18, -42), S(  12, -16)},
   {S(   0,   0), S(   0,   0), S(  -2,  -2), S(   2,   1),
    S(  12,  -2), S(   0,   0), S(  22, -32), S(  16,  -3)},
   {S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
    S(   2,   3), S(  -1,  -1), S(   0,   0), S(   8,   8)},
   {S( -19,  39), S(   1,  18), S( -22,  15), S( -20,   8),
    S( -15,   7), S( -11,   4), S( -11,  -1), S( -12,   9)}},
  {{S(   0,   0), S(  -2,  -9), S(  13,   1), S(  27,  -9),
    S(  30, -15), S(  28, -19), S(   0,   0), S(  19, -11)},
   {S(   0,   4), S(   0,   0), S(  16, -30), S(   9,  -5),
    S(  10,  -7), S(  14, -15), S(   9,  -7), S(  -3,  -8)},
   {S(   1,   3), S(  32,  14), S(   0,   0), S(  43, -19),
    S(  -6,   1), S(   6,  -9), S(  -3,  -3), S( -15,  -2)},
   {S(   0,  -2), S(   7,   3), S(  -8,   2), S(   0,   0),
    S( -14,  -6), S( -11, -10), S( -23,  -4), S( -30,  -4)},
   {S(   0,   0), S(   0,   3), S(  -6,   2), S(  -3,   4),
    S(   0,   0), S( -17, -14), S( -36,  14), S( -42,  13)},
   {S(   0,   0), S(   1,   1), S(   1,   2), S(   2,   4),
    S(   7,   7), S(   0,   0), S( -17,  11), S( -23,  24)},
   {S(   0,   0), S(   1,   0), S(   0,   0), S(   1,   0),
    S(   0,   0), S(  -3,  -1), S(   0,   0), S( -25,  -4)},
   {S( -19,  56), S(  27,  32), S( -36,  28), S( -26,  21),
    S( -30,  20), S( -29,  15), S( -41,  23), S( -45,  20)}},
  {{S(   0,   0), S(  -1,  -1), S( -17,  13), S(   0, -10),
    S(   6, -17), S(  17, -22), S(   0,   0), S( -18, -10)},
   {S(   1,   3), S(   0,   0), S(   6, -32), S(   5, -29),
    S(   3, -31), S(  10, -32), S(   8, -23), S(  -4, -31)},
   {S(   0,  -1), S(  12,   1), S(   0,   0), S(  41, -24),
    S(   6,  -4), S(  14,  -6), S(   8,   3), S(  -4,  -6)},
   {S(   0,   1), S(   3,   2), S(   0,   3), S(   0,   0),
    S(  20,   4), S(   3,   4), S(   0,  13), S( -14,   5)},
   {S(   0,   0), S(   0,  -1), S(  -3,   1), S(   1,   2),
    S(   0,   0), S(   8,  -1), S( -13,  23), S( -33,  20)},
   {S(   0,   0), S(   0,   0), S(   0,   1), S(   2,   0),
    S(  -4,  -3), S(   0,   0), S(   1,  54), S( -31,  41)},
   {S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
    S(   0,   0), S(  -1,  -1), S(   0,   0), S( -32,  24)},
   {S( -23,  55), S( 104, -11), S( -31,  37), S( -23,  18),
    S( -26,  17), S( -13,  14), S( -22,  25), S( -34,  17)}},
};
...
int evaluateKings(EvalInfo *ei, Board *board, int colour) {
    ...
    int sfile = fileOf(kingSq) - 1 - (fileOf(kingSq) == 7);
    int efile = fileOf(kingSq) + 1 + (fileOf(kingSq) == 0);


    for (int file = MAX(0, sfile); file <= MIN(FILE_NB-1, efile); file++) {
        ...
        int kRank     = relativeRankOf(US, kingSq);
        int ourRank   =   ours ? abs(kRank - relativeRankOf(US, backmost(US,   ours))) : 7;
        int theirRank = theirs ? abs(kRank - relativeRankOf(US, backmost(US, theirs))) : 7;

        ei->pkeval[US] += KingShelterStorm[file][ourRank][theirRank];
        if (TRACE) T.KingShelterStorm[file][ourRank][theirRank][US]++;
