...
const int KnightOutpost[2][3][FILE_NB] = {
  {{S(   2, -22), S(  23, -28), S(   9, -28), S(  11, -28),
    S(  16, -33), S(  20, -33), S(  29, -41), S(   8, -22)},
   {S(  14, -20), S(   8, -23), S(   7, -26), S(  16, -33),
    S(  16, -34), S(  16, -29), S(  16, -35), S(  13, -23)},
   {S(   5, -21), S(  12, -27), S(  12, -27), S(  13, -31),
    S(  16, -33), S(  20, -31), S(  11, -28), S(  14, -24)}},
  {{S(  20,  -4), S(  34,  -4), S(  37,   0), S(  39,  -1),
    S(  35,  -3), S(  34,  -3), S(  50,  -9), S(  19,  -3)},
   {S(  31, -14), S(  36,  -6), S(  37,  -2), S(  35,   3),
    S(  39,  -3), S(  39,   2), S(  39,  -3), S(  49, -13)},
   {S(   6,  12), S(  35,  -1), S(  43,  -4), S(  37,   2),
    S(  37,   5), S(  31,   0), S(  29,   5), S(  46, -26)}},
};
...
const int BishopOutpost[2][3][FILE_NB] = {
  {{S(  10,  -9), S(  18, -16), S(  12, -14), S(  12, -13),
    S(  23, -17), S(  19, -18), S(  16, -19), S(  15, -10)},
   {S(   5,  -7), S(  15, -14), S(  12, -11), S(  20, -17),
    S(  20, -18), S(  30, -20), S(  23, -20), S(   8, -10)},
   {S(   8, -10), S(  15, -16), S(  18, -15), S(  17, -13),
    S(  19, -15), S(  18, -14), S(  19, -18), S(   7,  -6)}},
  {{S( -12,   1), S(  46,  -2), S(  43,  -7), S(  44,  -1),
    S(  49,   2), S(  40,  -6), S(  41,  -1), S(  10, -18)},
   {S(   5,  -4), S(  43,  -1), S(  47,  -6), S(  49,  -2),
    S(  46,  -7), S(  42,   2), S(  45,  -2), S(  10,   7)},
   {S(   7,   1), S(  38,   0), S(  52,  -8), S(  46,   0),
    S(  44,  -2), S(  69,  -6), S(  37,   3), S(   1,  -7)}},
};
...
int evaluateKnights(EvalInfo *ei, Board *board, int colour) {
    ...
    int sq, rank, kingDistance, defended, count, eval = 0;
    uint64_t attacks;
    ...
    while (tempKnights) {
        ...
        if (     testBit(outpostRanksMasks(US), sq)
            ...
            rank     = relativeRankOf(US, sq) - 3;
            defended = testBit(ei->pawnAttacks[US], sq);
            eval += KnightOutpost[defended][rank][fileOf(sq)];
            if (TRACE) T.KnightOutpost[defended][rank][fileOf(sq)][US]++;
        }
...
int evaluateBishops(EvalInfo *ei, Board *board, int colour) {
    ...
    while (tempBishops) {
        ...
        if (     testBit(outpostRanksMasks(US), sq)
            ...
            rank     = relativeRankOf(US, sq) - 3;
            defended = testBit(ei->pawnAttacks[US], sq);
            eval += BishopOutpost[defended][rank][fileOf(sq)];
            if (TRACE) T.BishopOutpost[defended][rank][fileOf(sq)][US]++;
        }
