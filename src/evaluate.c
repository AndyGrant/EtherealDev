...
const int KingShelter[2][4][8] = {
  {{S( -33,  10), S(   8,  -8), S(  30,   8), S(   1,  17), S( -12,  -8), S( -33, -12), S(  38,  -7), S( -53,   5)},
   {S(  29,   9), S(  10, -22), S( -33,  -8), S( -10, -26), S(  -1, -33), S(  15, -47), S(  48, -34), S( -42, -16)},
   {S(  47,  25), S(  27,   4), S( -39,   4), S( -13, -25), S(  14, -12), S( -35,  11), S(   7,  47), S( -61,   3)},
   {S( -13,  35), S( -24,  16), S( -78,  11), S(  29,  -7), S(  57,  10), S(   6,  32), S(-199,  79), S( -28,   4)}},
  {{S(   0,   0), S(   2, -29), S(   7, -20), S(  18,  -7), S(   7, -24), S( -45,   7), S(-107, -72), S( -25, -18)},
   {S(   0,   0), S(  58,   8), S(  40,   5), S(  -1,  -8), S(   5, -38), S( -43,   5), S(  58,  46), S( -77,  -3)},
   {S(   0,   0), S(   6,  24), S( -20,   2), S(  -7,  -2), S( -16, -11), S(  22,  11), S( -56, -63), S( -59,   5)},
   {S(   0,   0), S( -47,  20), S( -31,   2), S(  43,  -7), S(  28,  -2), S(   7, -15), S(-238, -73), S( -56, -11)}},
};
