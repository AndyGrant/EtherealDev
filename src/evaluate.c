...
const int PassedPawn[2][2][RANK_NB] = {
  {{S(   0,   0), S( -27, -24), S( -23,   4), S( -15,   0),
    S(  17,   1), S(  56,   0), S( 142,  32), S(   0,   0)},
   {S(   0,   0), S(  -5,  -7), S( -23,  11), S( -14,  27),
    S(   4,  42), S(  64,  66), S( 190, 135), S(   0,   0)}},
  {{S(   0,   0), S( -11,   5), S( -19,   4), S( -11,  24),
    S(  28,  41), S(  78,  79), S( 239, 161), S(   0,   0)},
   {S(   0,   0), S( -23, -11), S( -19,  -3), S( -16,  34),
    S(   1, 100), S(  45, 224), S( 127, 385), S(   0,   0)}},
};
