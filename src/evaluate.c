...
const int KnightMobility[9] = {
    S( -58, -72), S( -28, -86), S( -14, -41), S(   0, -21),
    S(   9, -18), S(  15,  -3), S(  26,  -5), S(  39,  -8),
    S(  54, -29),
};
...
const int BishopMobility[14] = {
    S( -55,-112), S( -38, -75), S( -13, -51), S(  -1, -26),
    S(  12, -21), S(  22,  -9), S(  28,  -2), S(  32,  -1),
    S(  35,   4), S(  43,  -6), S(  42,   2), S(  51, -22),
    S(  55, -13), S( 113, -58),
};
...
const int RookMobility[15] = {
    S( -97,-156), S( -48, -96), S(  -1, -66), S(   6, -30),
    S(   7, -14), S(   7,   0), S(   8,  11), S(  12,  17),
    S(  19,  17), S(  23,  24), S(  28,  28), S(  29,  36),
    S(  33,  38), S(  40,  34), S(  26,  39),
};

// Definition of evaluation terms related to Queens

const int QueenMobility[28] = {
    S(-185,-101), S(-185,-101), S( -47,-226), S( -29,-217),
    S( -14,-103), S( -15, -92), S(  -8, -61), S( -10, -30),
    S(  -4, -52), S(  -3, -34), S(   0, -24), S(   0,  -8),
    S(   1,  -1), S(   5,   7), S(   4,  17), S(   6,  13),
    S(   7,  28), S(   6,  23), S(   9,  19), S(  12,  12),
    S(  10,   9), S(  36,   3), S(  35, -19), S(  24,  -8),
    S(  45, -33), S( 125, -59), S(  -9, -35), S(  21, -37),
};
