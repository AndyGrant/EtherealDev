...
const int QueenMobility[28] = {
    S( -61,-263), S(-216,-390), S( -47,-204), S( -33,-190),
    S( -16,-132), S( -16, -70), S(  -7, -90), S(  -7, -72),
    S(  -4, -62), S(  -2, -52), S(   0, -31), S(  -1, -25),
    S(  -2, -15), S(   1,  -4), S(   0,   4), S(  -2,   5),
    S(  -2,  20), S(  -3,  16), S(   0,  20), S(  -5,  20),
    S(  -2,  18), S(  17,  21), S(   6,  -1), S(  29,   0),
    S(  32,   8), S(  58,  -6), S( -50, -18), S(   0,  -2),
};
