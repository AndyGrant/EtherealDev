...
const int KingShelter[4][RANK_NB] = {
   { S( -18,   0), S(   0, -14), S(   5,  -3) ,  S(   1,   2) ,  S( -11,  10) ,  S(   5,  26) ,  S(-180,  25) ,  S( -25,  13) },
   { S(  17,   3), S(  10,  -4), S(  -5,  -2) ,  S( -18,  -8) ,  S( -20, -15) ,  S(  -2,  27) ,  S( -26,  -1) ,  S( -36,   8) },
   { S(  20,   4), S(  16,  -2), S( -19,   0) ,  S(  -2, -18) ,  S(   5, -27) ,  S(   7, -30) ,  S(  35, -10) ,  S( -15,   0) },
   { S( -11,  23), S(   7,   3), S(   0,  -3) ,  S(  19,  -7) ,  S(  10, -25) ,  S( -33, -17) ,  S( -96,  -2) ,  S(  -5,   0) },
};
