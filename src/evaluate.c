...
const int PawnCandidatePasser[2][8] = {
   {S(   0,   0), S( -26, -11), S( -12,   9), S( -12,  27), S(   3,  62), S(  47,  68), S(   0,   0), S(   0,   0)},
   {S(   0,   0), S( -13,  14), S(  -5,  21), S(   4,  44), S(  16,  85), S(  33,  52), S(   0,   0), S(   0,   0)},
};
...
const int KingShelter[2][8][8] = {
  {{S( -12,   4), S(  16, -24), S(  18,  -9), S(   9,   2), S(   4,   3), S(   7,   2), S(  -2, -32), S( -49,  19)},
   {S(  16,  -6), S(  23, -18), S(   0,  -5), S( -17,   2), S( -30,  13), S( -69,  69), S(  93,  84), S( -29,   3)},
   {S(  32,  -1), S(  16,  -9), S( -26,   6), S( -11,  -9), S( -22,  -4), S(  -7,  -1), S(   0,  66), S( -15,   0)},
   {S(   3,  13), S(  20,  -8), S(   3, -11), S(  14, -23), S(  23, -35), S( -51,   1), S(-137,  51), S(   3,  -5)},
   {S( -13,   8), S(   1,  -2), S( -26,   0), S( -18,   2), S( -20,  -8), S( -38,   0), S(  34, -15), S(  -8,  -1)},
   {S(  44, -14), S(  25, -18), S( -21,   0), S( -12, -19), S(   4, -25), S(  17, -23), S(  42, -29), S( -25,   1)},
   {S(  23, -10), S(   1, -17), S( -23,  -4), S( -19, -11), S( -29,  -9), S( -34,  31), S(   0,  44), S( -12,   3)},
   {S( -10,  -8), S(   7, -18), S(   8,  -2), S(  -2,   7), S( -11,  13), S(  -9,  37), S(-190,  87), S( -19,  15)}},
  {{S(   0,   0), S( -10, -22), S(   0, -16), S( -42,  16), S( -18,   0), S(   3,  43), S(-167,  -9), S( -45,  11)},
   {S(   0,   0), S(  25, -20), S(   6,  -8), S( -19,  -3), S(   0, -15), S(  28,  71), S(-184,  -4), S( -42,   6)},
   {S(   0,   0), S(  35, -11), S(  -1,  -6), S(   8, -18), S(  13,  -8), S( -91,  48), S( -85, -75), S( -22,  -3)},
   {S(   0,   0), S(  -1,   9), S(  -1,   1), S( -15,   0), S( -26,   0), S(-101,  29), S(   7, -42), S( -23,  -4)},
   {S(   0,   0), S(  11,   3), S(  11,  -5), S(  13, -11), S(  13, -24), S( -54,  15), S(-105, -63), S(  -2,  -6)},
   {S(   0,   0), S(   9,  -6), S( -20,   0), S( -27,  -8), S(  18, -26), S( -39,   2), S(  56,  39), S( -21,  -3)},
   {S(   0,   0), S(  24, -13), S(  11, -12), S( -10,  -9), S( -29,   5), S(  -8,  14), S( -56, -51), S( -34,  14)},
   {S(   0,   0), S(  14, -36), S(  19, -27), S( -18,  -5), S( -17,  15), S(  -1,  15), S(-229, -57), S( -23,   6)}},
};

const int KingStorm[2][4][8] = {
  {{S(   1,  23), S( 114, -11), S( -26,  24), S( -22,  10), S( -13,   2), S(  -8,  -2), S( -18,   6), S( -22,  -2)},
   {S(   0,  45), S(  57,  11), S( -18,  23), S(  -6,  11), S(  -3,   4), S(   5,  -4), S(   0,   0), S( -12,   0)},
   {S(  11,  34), S(  20,  20), S( -24,  20), S( -13,   9), S(   3,   2), S(   7,   0), S(   8,  -7), S(   2,  -1)},
   {S(   0,  23), S(  20,  18), S( -13,   8), S( -15,   3), S( -13,   1), S(   7, -10), S(   0,  -7), S( -14,   2)}},
  {{S(   0,   0), S( -11, -13), S( -16,  -1), S(  20, -16), S(  11,  -7), S(   0, -17), S(  -7,   0), S(  16,  27)},
   {S(   0,   0), S( -13, -28), S(  -7, -10), S(  32, -13), S(  -1,   0), S(  10, -22), S( -11,  -8), S( -15,   2)},
   {S(   0,   0), S( -23, -42), S( -30,  -8), S(   9, -10), S(   2,  -1), S(  -9, -14), S( -13, -13), S( -10,   5)},
   {S(   0,   0), S(  -1, -14), S( -17, -18), S( -11,  -3), S(  -4,  -5), S(   6, -29), S(  67,  -6), S(  12,  18)}},
};
...
const int PassedPawn[2][2][8] = {
  {{S(   0,   0), S( -38,   0), S( -53,  22), S( -83,  26), S(  -6,  16), S(  66,   0), S( 152,  59), S(   0,   0)},
   {S(   0,   0), S( -26,   1), S( -46,  20), S( -71,  25), S( -13,  27), S(  84,  27), S( 183,  94), S(   0,   0)}},
  {{S(   0,   0), S( -25,  10), S( -47,  17), S( -74,  32), S(  -2,  34), S(  88,  41), S( 258, 123), S(   0,   0)},
   {S(   0,   0), S( -28,   6), S( -40,  13), S( -65,  35), S(  -3,  58), S(  76, 140), S( 156, 302), S(   0,   0)}},
};
