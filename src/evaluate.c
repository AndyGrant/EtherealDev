...
const int KingShelter[2][FILE_NB][RANK_NB] = {
  {{S( -11,   3), S(  14, -27), S(  28,  -9), S(  19,   8),
    S(  19,   3), S(  -4,  -5), S(  -3, -35), S( -52,  21)},
   {S(  16,  -6), S(  24, -20), S(   6,  -6), S( -16,   5),
    S( -29,  18), S( -79,  65), S(  90,  80), S( -11,  -1)},
   {S(  37,  -4), S(  10,  -9), S( -33,   6), S( -15,  -8),
    S( -16,  -5), S( -16,   0), S(   0,  71), S( -11,  -2)},
   {S(  -2,  14), S(  28, -15), S(   6, -13), S(  15, -21),
    S(  33, -39), S( -60,   4), S(-133,  50), S(   8,  -7)},
   {S( -21,  14), S(   6,   0), S( -35,   6), S( -22,  12),
    S( -26,  -3), S( -52, -10), S(  32, -18), S(  -8,   4)},
   {S(  52, -19), S(  23, -14), S( -21,   4), S( -11, -21),
    S(   7, -26), S(  22, -18), S(  41, -34), S( -21,   2)},
   {S(  31, -18), S(   0, -18), S( -26,  -1), S( -24,  -5),
    S( -31,  -3), S( -46,  31), S(   5,  46), S(  -7,  -2)},
   {S( -10, -13), S(   6, -20), S(   9,   3), S(   0,  13),
    S( -11,  18), S( -15,  36), S(-191,  91), S( -18,  15)}},
  {{S(   0,   0), S( -12, -29), S(  13, -28), S( -38,  22),
    S( -25,  -1), S(   4,  44), S(-167,  -7), S( -37,   8)},
   {S(   0,   0), S(  25, -23), S(   8,  -5), S( -19,   5),
    S(   5, -21), S(  24,  63), S(-184,  -4), S( -24,   2)},
   {S(   0,   0), S(  21, -13), S(  -2, -12), S(   0, -22),
    S(  22,   4), S( -85,  50), S( -84, -74), S( -20,  -2)},
   {S(   0,   0), S( -15,  10), S( -12,  -2), S( -31,   8),
    S( -29,   9), S(-102,  29), S(   7, -39), S( -22,  -5)},
   {S(   0,   0), S(  17,   0), S(  14,  -8), S(  17, -15),
    S(  17, -33), S( -57,  13), S( -97, -58), S(  -2,  -3)},
   {S(   0,   0), S(  -2,  -7), S( -32,   3), S( -21,  -9),
    S(  28, -21), S( -36,   4), S(  55,  39), S( -14,  -5)},
   {S(   0,   0), S(  23, -19), S(  12, -18), S( -12,  -7),
    S( -30,  19), S(  -6,  23), S( -60, -50), S( -31,  11)},
   {S(   0,   0), S(  14, -44), S(  25, -34), S( -18,  -8),
    S( -21,  23), S( -14,  24), S(-228, -58), S( -23,   1)}},
};

const int KingStorm[2][FILE_NB/2][RANK_NB] = {
  {{S( -26,  35), S( 109,  -3), S( -20,  24), S(  -9,  -1),
    S( -10,  -2), S(  -4,  -8), S( -12,   0), S( -25,   3)},
   {S( -19,  56), S(  45,  16), S( -19,  20), S(  -1,   7),
    S(   0,   3), S(   8,  -6), S(  -1,   2), S( -10,   4)},
   {S(  -6,  45), S( -12,  33), S( -21,  18), S(  -9,   5),
    S(   5,   0), S(   7,   0), S(  16,  -7), S(   9,   2)},
   {S( -16,  31), S( -13,  32), S( -28,  10), S( -14,  -1),
    S( -12,   1), S(  10, -13), S(   4, -12), S( -12,   4)}},
  {{S(   0,   0), S( -21, -15), S( -13,  -2), S(  26, -21),
    S(  12,  -8), S(  11, -26), S(  10,   4), S(  14,  28)},
   {S(   0,   0), S( -17, -37), S(   8, -11), S(  48, -12),
    S(   7,  -7), S(  21, -27), S(  -5,   0), S( -20,  -1)},
   {S(   0,   0), S( -19, -53), S( -23,  -6), S(  20, -13),
    S(   9,  -3), S(  -7, -14), S( -14, -10), S(  -9,   7)},
   {S(   0,   0), S(  -1, -19), S( -22, -14), S( -15,  -1),
    S(  -2,  -8), S(   2, -24), S(  77, -14), S(  19,  22)}},
};
