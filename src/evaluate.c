...
const int KingShelter[2][4][RANK_NB] = {
  {{S( -27,  10), S( -13,   0), S(  -4,   7), S(  -7,   8),
    S( -18, -12), S( -37, -16), S(  38,  -8), S( -27,   9)},
   {S(  14,  -4), S(   0, -11), S( -22,  -2), S(  -6, -21),
    S(   4, -32), S(  16, -48), S(  49, -34), S( -22,   0)},
   {S(  22,   0), S(  12,   0), S( -23,   0), S(  -6, -15),
    S( -11, -17), S( -41,   9), S(   7,  47), S( -30,   7)},
   {S( -14,   7), S(   4,  -3), S( -20,   0), S(  15,   0),
    S(  10,  12), S(   3,  32), S(-200,  79), S(  -9,   5)}},
  {{S(   0,   0), S( -10,  -7), S(   0, -11), S(  21,  -5),
    S(   9, -23), S( -45,   8), S(-108, -72), S(  -9,   2)},
   {S(   0,   0), S(  16,   2), S(   3,   1), S(  -9, -11),
    S(  18, -38), S( -44,   5), S(  58,  46), S( -43,   5)},
   {S(   0,   0), S(   5,   2), S( -10,  -3), S( -15,  -4),
    S( -18, -12), S(  22,  11), S( -57, -63), S( -44,   7)},
   {S(   0,   0), S( -11,  -8), S( -10,  -8), S(  10,   0),
    S(  -5,  -2), S(   7, -16), S(-239, -73), S( -22,  -2)}},
};
