...
const int PassedPawn[3][8] = {
   {S(   0,   0), S(  -8,  -2), S(  -6,   0), S(  -8,  10), S(  17,  14), S(  42,  54), S( 111, 106), S(   0,   0)},
   {S(   0,   0), S(  -1,   5), S( -11,  14), S(  -1,  29), S(  24,  45), S(  66,  86), S( 172, 177), S(   0,   0)},
   {S(   0,   0), S( -13,   7), S(  -7,  12), S(  -2,  45), S(  18, 100), S(  83, 210), S( 182, 328), S(   0,   0)},
};
