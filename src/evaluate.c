...
const int SafetyKnightWeight = S(  13,  15);
const int SafetyBishopWeight = S(   2,   4);
const int SafetyRookWeight   = S(   9,   8);
const int SafetyQueenWeight  = S(   7,   6);

const int SafetyAttackValue     = S(  39,  34);
const int SafetyWeakSquares     = S(  37,  30);
const int SafetyFriendlyPawns   = S( -30, -22);
const int SafetyNoEnemyQueens   = S(-278,-276);
...
const int SafetyAdjustment      = S( -21, -19);
