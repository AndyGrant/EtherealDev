...
const int KingShelterStorm[FILE_NB][RANK_NB][RANK_NB] = {
  {{S(   0,   0), S(  -7, -28), S( -26,  26), S(  -6,   5),
    S(  -8,  -2), S( -10,   0), S(   0,   0), S( -23,   7)},
   {S(   4,   5), S(   0,   0), S(   7, -20), S(  -1, -12),
    S(   1, -20), S(   8, -24), S(   3, -14), S( -11, -17)},
   {S(  13,  30), S(  60,  -2), S(   0,   0), S(  39, -15),
    S(   7,   1), S(  10,  -3), S(   0,   9), S(  -5,   0)},
   {S(   0,   0), S(  16,   6), S( -13,  12), S(   0,   0),
    S(  21,   8), S(  11,   6), S(   0,  17), S( -11,  14)},
   {S(  -2,  -3), S(  -6,  -5), S( -15, -36), S(  -3,   4),
    S(   0,   0), S(  21, -25), S( -12,  10), S( -15,  12)},
   {S(   0,   0), S(   0,   3), S(  -5,  -6), S(   1,  13),
    S(  -9,  -8), S(   0,   0), S( -11,  25), S( -39,  37)},
   {S(   0,   0), S(  -1,  -2), S(  -4,  -4), S(   0,   0),
    S(  -3,  -5), S(   4,   2), S(   0,   0), S(  -6,  21)},
   {S( -50,  63), S( 100,  30), S( -42,  52), S( -43,  37),
    S( -52,  36), S( -39,  32), S( -44,  44), S( -62,  32)}},
  {{S(   0,   0), S(   5, -16), S(   9,  -2), S(  22,  -6),
    S(  32, -11), S(  33, -17), S(   0,   0), S(   6,   1)},
   {S(  13,  26), S(   0,   0), S(  21, -37), S(  16, -17),
    S(  22, -20), S(  39, -30), S(  30, -23), S(   7, -16)},
   {S(   4,  40), S( 116,  -8), S(   0,   0), S(  55, -29),
    S(   9,  -7), S(  27, -24), S(  20, -17), S(  -5,  -5)},
   {S(  10,  10), S(  24,  15), S(  17, -23), S(   0,   0),
    S(   5, -13), S(  11, -23), S(   4, -15), S( -13,   1)},
   {S(  12,  12), S(  60,   7), S(   6,  -9), S( -26,  -9),
    S(   0,   0), S(  19, -39), S(  -7,  -9), S( -12,  -3)},
   {S(  -2,  -5), S(  14,  17), S(  16,  51), S( -10,  47),
    S(  -7,  10), S(   0,   0), S(  15,  39), S( -33,  69)},
   {S(   0,   0), S(   0,  -4), S(  -3,   9), S( -12,  14),
    S( -20,   4), S(  -6,   5), S(   0,   0), S( -28,  79)},
   {S( -30,  54), S(  44,   9), S( -39,  17), S( -25,   8),
    S( -25,   7), S( -18,  -2), S( -25,   4), S( -40,   8)}},
  {{S(   0,   0), S(  -6, -35), S(  25,  32), S(  37,  22),
    S(  44,  21), S(  50,  21), S(   0,   0), S(  42,  27)},
   {S( -11,  43), S(   0,   0), S(   2,   0), S(   0,  28),
    S(  13,  20), S(  23,  14), S(  24,   8), S(  15,  22)},
   {S(  22,  74), S(  34,   4), S(   0,   0), S(   1,  11),
    S( -14,  27), S(   0,  20), S(  -4,   5), S( -11,  27)},
   {S(   8,  14), S(  22,  10), S(  -5,   3), S(   0,   0),
    S(   3,   6), S(   1,  -1), S(   1,  -5), S(  -7,  17)},
   {S(   1,  12), S(  56,  42), S(  13,  20), S( -12,   5),
    S(   0,   0), S(  -3,   1), S(   7,  -5), S(  -3,  28)},
   {S(   5,  20), S(   3,   9), S(  20,  45), S( -26,  21),
    S( -22,   3), S(   0,   0), S( -21,   0), S( -38,  59)},
   {S(   0,   0), S(  -5,  -5), S(   2,   0), S(  -6,   8),
    S(  -4,  24), S( -22, -10), S(   0,   0), S( -26,  83)},
   {S( -15,  63), S(   3,  45), S( -32,  37), S( -30,  30),
    S( -19,  27), S(  -8,  22), S( -15,  19), S( -14,  28)}},
  {{S(   0,   0), S(  13,   2), S(   1,  13), S(  11,   6),
    S(  18,   9), S(  36,   4), S(   0,   0), S(  20,  18)},
   {S(  12,   2), S(   0,   0), S(  10, -25), S(   5, -11),
    S(  19,  -9), S(  38, -20), S(  28, -19), S(  21,   0)},
   {S( -16, -20), S(  53,  -2), S(   0,   0), S(   0,  -9),
    S(   6, -14), S(  23, -23), S(  14, -21), S(   6,  -4)},
   {S( -13,  -6), S(  25,   8), S(  -7, -13), S(   0,   0),
    S(  19, -25), S(  29, -32), S(  22, -26), S(  10,  -7)},
   {S(  10,   2), S(  -6,   7), S( -10, -38), S(   7, -29),
    S(   0,   0), S(  33, -63), S(  33, -33), S(  12, -14)},
   {S(   6,  27), S(  -3,  -2), S( -55,  10), S( -67,  -1),
    S( -76, -32), S(   0,   0), S(  12,  -9), S( -66,  21)},
   {S(   0,   0), S(  -8,  -3), S( -19, -25), S( -16,   2),
    S( -24, -24), S( -67, -23), S(   0,   0), S(-124,  70)},
   {S(  18,  18), S(  26,  11), S( -14,   3), S(  -5,  -7),
    S(   0,  -4), S(  21, -15), S(  12,  -9), S(   1,   3)}},
  {{S(   0,   0), S(   3, -34), S( -25,   8), S( -25,   8),
    S(  -3,   6), S(   5,   2), S(   0,   0), S( -18,  16)},
   {S(  45,   8), S(   0,   0), S(  -2, -27), S( -14,  -5),
    S(  -5,  -4), S(  14, -17), S(   6, -15), S( -11,   4)},
   {S(  -8,  14), S( -22,   7), S(   0,   0), S( -15,  -7),
    S( -11,  -7), S(  10, -23), S(   0, -20), S( -21,   0)},
   {S(  10,  12), S(   5, -14), S( -30,   9), S(   0,   0),
    S(  -6, -13), S(   7, -13), S(   2, -21), S( -20,   1)},
   {S(  14,  -9), S( -15, -39), S(  -2, -15), S( -14,  -9),
    S(   0,   0), S(   2, -48), S(  -3, -20), S( -23,  -7)},
   {S(   0,   4), S(  -6,  -9), S( -36, -15), S( -97,  19),
    S( -40,  19), S(   0,   0), S(  17, -39), S( -68,   2)},
   {S(   0,   0), S(  -6, -14), S(  -5, -14), S(  -5, -14),
    S(  -5,  25), S( -28, -12), S(   0,   0), S(  -7,  -1)},
   {S(  -2,  17), S(  -2,  14), S( -30,   3), S( -31,  -3),
    S( -29,   3), S(  -8,  -7), S( -16,  -5), S( -23,   5)}},
  {{S(   0,   0), S(   2, -49), S(  42,  18), S(  53,  10),
    S(  68,   5), S(  65,   9), S(   0,   0), S(  63,  12)},
   {S(  40,  52), S(   0,   0), S(  12,  -2), S(  13,  19),
    S(  30,  13), S(  40,   7), S(  35,   0), S(  34,  12)},
   {S(   2,  38), S( -24,  24), S(   0,   0), S(   8,  14),
    S(   0,  26), S(   9,  22), S(   8,  11), S(   1,  23)},
   {S(   4,  17), S(  -5,  15), S( -14,  27), S(   0,   0),
    S(  13,  -1), S(  14,  -2), S(  14, -13), S(  13,   2)},
   {S(  -3,   3), S(  16,  20), S(  22,  11), S(   8, -24),
    S(   0,   0), S(  15, -24), S(  27, -25), S(  25,  -3)},
   {S(   4,   6), S(  10,   9), S(  -3,   8), S(  23,  13),
    S(  62, -19), S(   0,   0), S(  32, -22), S(  31,  13)},
   {S(   0,   0), S(   0,   1), S(  -2,   7), S(  19,   7),
    S(  40,  41), S(  11, -13), S(   0,   0), S(  26,  16)},
   {S( -13,  62), S(  27,  38), S( -16,  34), S( -13,  26),
    S(  -4,  24), S(   1,  24), S(   1,  16), S(  -2,  26)}},
  {{S(   0,   0), S(  12, -67), S(  21,   2), S(  39, -11),
    S(  41, -14), S(  40, -16), S(   0,   0), S(  26,  -8)},
   {S(  -6,  29), S(   0,   0), S(  17, -34), S(   9, -10),
    S(  11, -12), S(  14, -20), S(   9, -13), S(  -4, -13)},
   {S(  14,  35), S( 101, -10), S(   0,   0), S(  43, -24),
    S(  -6,  -4), S(   5, -14), S(  -3,  -9), S( -15,  -6)},
   {S(  -5, -17), S(  57,  -9), S( -29,  28), S(   0,   0),
    S( -11, -12), S( -10, -15), S( -21,  -9), S( -28,  -8)},
   {S( -10,  -8), S( -10,  26), S( -43,  30), S( -17,  21),
    S(   0,   0), S( -15, -20), S( -35,   9), S( -42,   9)},
   {S(  -1,   0), S(  21,   9), S(  10,  34), S( -10,  42),
    S(  28,  64), S(   0,   0), S( -23,  17), S( -32,  29)},
   {S(   0,   0), S(  18,   3), S(   0,   4), S(  18,   4),
    S(   6,  16), S(  -2,  11), S(   0,   0), S( -64,  25)},
   {S( -34,  59), S(  25,  22), S( -35,  23), S( -24,  16),
    S( -25,  14), S( -26,  11), S( -39,  18), S( -40,  16)}},
  {{S(   0,   0), S( -14, -11), S( -20,  12), S(  -1, -12),
    S(   5, -18), S(  15, -23), S(   0,   0), S( -17, -12)},
   {S(  19,  49), S(   0,   0), S(  11, -28), S(  10, -24),
    S(   8, -26), S(  14, -29), S(  12, -21), S(   0, -27)},
   {S(  -7, -17), S( 156, -21), S(   0,   0), S(  48, -23),
    S(  10,  -2), S(  17,  -5), S(  12,   5), S(   0,  -5)},
   {S(   5,  18), S(  58,  30), S( -14,  50), S(   0,   0),
    S(  22,   6), S(   7,   5), S(   4,  15), S( -11,   7)},
   {S(  -3,  -8), S(  10,  -6), S( -36,  29), S(  14,  30),
    S(   0,   0), S(  13,   0), S(  -9,  25), S( -31,  24)},
   {S(   0,   0), S(   8,  10), S(  11,  21), S(  35, -17),
    S( -23, -32), S(   0,   0), S(   4,  56), S( -34,  48)},
   {S(   0,   0), S(   0,   0), S(   1,   2), S(  -1,   4),
    S(  -5,   3), S( -24,  -9), S(   0,   0), S(-132, 101)},
   {S( -38,  57), S( 115,  10), S( -26,  43), S( -17,  21),
    S( -22,  20), S(  -9,  15), S( -17,  27), S( -33,  21)}},
};
...
int evaluateKings(EvalInfo *ei, Board *board, int colour) {
    ...
    for (int file = MAX(0, fileOf(kingSq) - 1); file <= MIN(FILE_NB - 1, fileOf(kingSq) + 1); file++) {
        ...
        // monkaS
        ei->pkeval[US] += KingShelterStorm[file][ourDist][theirDist];
        if (TRACE) T.KingShelterStorm[file][ourDist][theirDist][US]++;
    }
