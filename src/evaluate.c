...
const int PawnPSQT32[32] = {
    ...
    S( -19,  10), S(   5,   4), S( -11,   7), S(  -5,  -1),
    S( -21,   4), S( -11,   4), S(  -8,  -5), S(  -1, -13),
    S( -16,  12), S( -11,  11), S(  14, -12), S(  11, -24),
    S(  -4,  16), S(   3,  11), S(  -1,  -2), S(  13, -21),
...
const int PawnStacked[2] = { S( -10, -17), S(  -9,  -8) };

const int PawnBackwards[2] = { S(   7,  -2), S(  -6, -19) };

const int PawnConnected32[32] = {
    S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
    S(  -2,  -8), S(  10,   1), S(   3,   1), S(   5,  16),
    S(  14,  -1), S(  29,  -2), S(  21,   7), S(  24,  15),
    S(   9,   0), S(  22,   4), S(  10,  11), S(  14,  20),
    S(  13,   8), S(  22,  14), S(  27,  21), S(  31,  20),
...
const int PassedEnemyDistance[8] = {
    S(   0,   0), S(   3,   0), S(   5,   2), S(   9,  10),
    S(   1,  22), S(   7,  30), S(  24,  28), S(   0,   0),
};
