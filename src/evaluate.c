...
const int PassedPawn[2][2][8] = {
  {{S(   0,   0), S( -28, -25), S( -23,   4), S( -15,   0),
    S(  18,   0), S(  57,  -1), S( 143,  32), S(   0,   0)},
   {S(   0,   0), S(  -4,  -6), S( -23,  11), S( -15,  24),
    S(   4,  34), S(  64,  59), S( 190, 130), S(   0,   0)}},
  {{S(   0,   0), S( -12,   5), S( -19,   2), S( -12,  13),
    S(  27,  31), S(  78,  67), S( 237, 152), S(   0,   0)},
   {S(   0,   0), S( -21,  -5), S( -17,   3), S( -16,  40),
    S(   0, 102), S(  43, 218), S( 126, 380), S(   0,   0)}},
};

const int PassedFriendlyDistance = S(   5, -10);

const int PassedEnemyDistance = S(   2,   6);

const int PassedSafePromotionPath = S(   1,  24);
