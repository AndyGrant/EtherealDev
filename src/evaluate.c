...
const int QueenChecked[PHASE_NB] = { -31,  59};

const int QueenCheckedByPawn[PHASE_NB] = { -42,  57};

const int QueenMobility[28][PHASE_NB] = {
    {-307,-103}, { 107,-503}, { -26,-304}, { -29,-142},
    { -21,-206}, { -23, -54}, { -21, -84}, { -17, -84},
...
const int KingShelter[2][FILE_NB][RANK_NB][PHASE_NB] = {
  ...
  {{{   0,   0}, { -18, -20}, { -15, -21}, { -82,   6}, {   7, -20}, {-176,  12}, { -50, 137}, { -60,   7}},
   {{   0,   0}, {  10,  -4}, {   1,  -3}, {   0,   0}, {   3, -20}, {-162,  70}, {-479,  31}, { -42,   3}},
   {{   0,   0}, {  23,   3}, {   4,  -4}, {  18, -23}, {   1,  -3}, { -42,  50}, {-264, -62}, { -17,   0}},
   {{   0,   0}, {   4,  10}, {   1,  12}, { -18,  -4}, { -25, -10}, { -96,  -9}, {  35,   6}, { -21,  -1}},
   {{   0,   0}, {   7,   3}, {   9,  -7}, {  17,  -7}, {   7, -14}, { -53,  20}, { -20, -90}, {  -6,  -3}},
   {{   0,   0}, {  10,   0}, {   0,  -4}, { -28, -12}, {   0, -29}, {-145,  -7}, {-132,   4}, { -26,   0}},
   {{   0,   0}, {  12,  -1}, {   1,   0}, { -14,  -6}, { -29, -18}, {  -1, -12}, { -98, -31}, { -43,  12}},
   {{   0,   0}, {   7, -25}, {  10, -12}, { -26,   4}, { -39,   0}, {   1, -25}, {-100, -25}, { -46,  17}}},
};
...
const int Tempo[COLOUR_NB][PHASE_NB] = { {  25,  14}, { -25, -14} };
