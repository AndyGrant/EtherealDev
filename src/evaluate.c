...
const int KingShelter[4][8] = {
   {S(  13,  25), S(  -1,  -8), S(   4,   4), S(  15,   7), S( -17, -19), S(   0,   0), S(   7,  -9), S(   3,  29)},
   {S( -33, -38), S(  12,  -3), S( -32, -40), S(  17,  10), S( -47, -33), S(   0,   0), S(   0, -25), S(   7,  25)},
   {S( -30, -38), S(   8,   4), S(  10,  -1), S(   9,  14), S( -48, -40), S(   0,   0), S( -34, -41), S(  31,  18)},
   {S(   1,  10), S(   8,   3), S(  10,   0), S(  13,   5), S( -17,  -5), S(   0,   0), S(   6,   0), S(  19,  -4)},
};
