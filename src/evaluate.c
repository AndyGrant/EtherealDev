...
const int SafetyKnightWeight    = S(  51,  71);
const int SafetyBishopWeight    = S(  25,  69);
const int SafetyRookWeight      = S(  35,   3);
const int SafetyQueenWeight     = S(  30,  42);

const int SafetyAttackValue     = S(  45,  28);
const int SafetyWeakSquares     = S(  41,  33);
const int SafetyNoEnemyQueens   = S(-235,-268);
const int SafetySafeQueenCheck  = S(  88, 115);
const int SafetySafeRookCheck   = S(  87, 100);
const int SafetySafeBishopCheck = S(  60, 116);
const int SafetySafeKnightCheck = S( 108,  66);
const int SafetyAdjustment      = S( -83,  29);
