...
const int KnightMobility[9] = {
    S( -83,-101), S( -32,-101), S( -19, -46), S(  -4, -20),
    S(   6,  -9), S(  13,   7), S(  22,  11), S(  32,  11),
    S(  44,  -4),
};
...
const int BishopMobility[14] = {
    S( -64,-146), S( -35, -96), S( -12, -60), S(  -1, -32),
    S(   9, -18), S(  16,  -2), S(  19,   8), S(  20,  13),
    S(  18,  20), S(  23,  19), S(  19,  21), S(  37,   3),
    S(  40,  11), S(  64, -29),
};
...
const int RookMobility[15] = {
    S(-150,-111), S( -94,-119), S( -13, -71), S(  -6, -27),
    S(  -6,  -2), S(  -5,  10), S(  -7,  25), S(   0,  27),
    S(   6,  30), S(  10,  35), S(  12,  42), S(  15,  48),
    S(  16,  53), S(  22,  47), S(  72,  12),
};

/* Queen Evaluation Terms */

const int QueenMobility[28] = {
    S( -61,-263), S(-212,-388), S( -60,-204), S( -30,-193),
    S( -15,-142), S( -11, -92), S(  -5, -65), S(  -5, -39),
    S(  -3, -27), S(  -3,  -4), S(  -1,   9), S(   0,  21),
    S(   2,  23), S(   3,  32), S(   2,  38), S(   0,  40),
    S(   0,  42), S(  -5,  43), S(  -4,  36), S(  -6,  30),
    S(  -2,   8), S(  17, -12), S(  17, -40), S(  20, -60),
    S(   5, -73), S(  20, -99), S( -58, -40), S( -29, -57),
};
