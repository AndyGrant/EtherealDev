...
const int KnightMobility[9] = {
    S( -91,-128), S( -44,-108), S( -23, -43), S( -10,  -9),
    S(   3,   0), S(   7,  17), S(  14,  20), S(  24,  19),
    S(  37,   1),
};
...
const int BishopMobility[14] = {
    S( -88,-176), S( -44,-117), S( -17, -58), S(  -7, -24),
    S(   4, -12), S(  11,   5), S(  13,  17), S(  14,  20),
    S(  13,  28), S(  21,  28), S(  21,  28), S(  43,  13),
    S(  48,  26), S(  71, -15),
};
...
const int RookMobility[15] = {
    S(-125,-135), S( -54,-113), S( -25, -77), S( -13, -29),
    S( -11,  -4), S( -15,  17), S( -13,  29), S(  -6,  32),
    S(   1,  37), S(   5,  39), S(   7,  48), S(  15,  51),
    S(  15,  56), S(  32,  44), S(  90,   2),
};
...
const int QueenMobility[28] = {
    S(-101,-271), S(-246,-397), S(-117,-220), S( -46,-220),
    S( -24,-165), S( -14, -89), S(  -8, -42), S(  -7,  -9),
    S(  -1,  -3), S(   1,  16), S(   7,  21), S(   9,  37),
    S(  12,  28), S(  15,  39), S(  13,  40), S(  11,  45),
    S(  12,  43), S(   5,  44), S(   3,  41), S(   7,  28),
    S(  15,   9), S(  26, -12), S(  23, -32), S(  19, -50),
    S(  -4, -59), S(   6, -96), S( -51, -42), S( -26, -55),
};
