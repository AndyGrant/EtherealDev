...
const int KingShelter[2][4][8] = {
  {{S( -14,   9), S(  20,  -7), S(  35,   9), S(   6,  15), S(  -3,  -2), S(   0,   1), S(   0,   0), S( -50,  10)},
   {S(  21,  16), S(  40, -17), S(  -2,   0), S( -16,   0), S( -14,  -6), S(   0,   0), S(   0,   0), S( -29, -14)},
   {S(  46,  18), S(  35, -13), S( -37,  14), S( -25, -27), S(  11, -17), S(   7,   0), S(   0,   0), S( -35,   1)},
   {S( -15,  36), S(   6,  10), S( -23,  -2), S(  12, -18), S(  42, -15), S(   9,  -1), S(   0,   0), S( -22,   0)}},
  {{S(   0,   0), S(  22, -20), S(  20, -13), S( -14,  -8), S(  -1,   0), S(   0,   0), S(   0,   0), S( -28,  -7)},
   {S(   0,   0), S(  54,   6), S(  47,   0), S(  -6,   7), S( -29,   2), S(  -1,   0), S(   0,   0), S( -69,  20)},
   {S(   0,   0), S(  32,  10), S(  -4,   7), S(   6,  -3), S(  11,   2), S(   0,   0), S(   0,   0), S( -50,   6)},
   {S(   0,   0), S(   0,  21), S(  12,  -2), S(  16, -11), S(  19,  -7), S(   1,   0), S(   0,   0), S( -38, -12)}},
};
const int KingStorm[2][4][8] = {
  {{S(   5,  16), S(  47,  27), S( -13,  10), S( -25,   0), S(  -3,  -4), S(  -5,  -7), S( -21,   0), S( -12,  24)},
   {S(  10,  48), S(  20,  28), S(  -2,   7), S( -11,  -2), S(  12,  -4), S(  16, -19), S(  -3,   4), S( -13,  34)},
   {S(   8,  35), S(   6,  41), S( -21,   8), S( -44,   1), S(   2, -10), S(  10, -19), S(  17, -27), S(   4,  25)},
   {S(   9,  32), S(  12,  40), S( -12,  -1), S( -34, -13), S( -23,  -1), S(  28, -34), S(  29, -10), S( -23,  27)}},
  {{S(   0,   0), S(   0,   0), S(  -2, -35), S(  32, -32), S(  14,   7), S(  -2,  -8), S(  -3,   0), S(   0,   1)},
   {S(   0,   0), S(   0,   0), S( -14, -37), S(  24, -17), S( -10,  -3), S(  -3,   0), S(  -1,   0), S(  -2,   0)},
   {S(   0,   0), S(   0,   0), S( -18, -21), S(  -2,  -8), S(   0,   0), S( -22, -10), S(   3,   0), S(   0,   0)},
   {S(   0,   0), S(   0,   0), S( -19, -26), S( -19,   0), S(  -8, -15), S(  15, -30), S(  32,   0), S(   0,   0)}},
};
