...
const int KnightMobility[9] = {
    S( -81,-101), S( -33, -99), S( -17, -42), S(  -2, -17),
    S(   9,  -6), S(  16,   8), S(  25,  12), S(  34,  12),
    S(  44,   0),
};
...
const int BishopMobility[14] = {
    S( -64,-146), S( -28, -95), S(  -9, -55), S(   1, -29),
    S(  11, -16), S(  19,  -1), S(  21,   8), S(  22,  13),
    S(  22,  18), S(  24,  20), S(  23,  20), S(  39,   9),
    S(  40,  13), S(  65, -19),
};
...
const int RookMobility[15] = {
    S(-149,-112), S( -52,-116), S( -13, -62), S(  -5, -20),
    S(  -5,   0), S(  -5,  15), S(  -4,  25), S(   1,  28),
    S(   8,  30), S(  12,  35), S(  14,  41), S(  18,  46),
    S(  18,  50), S(  25,  45), S(  69,  17),
};

/* Queen Evaluation Terms */

const int QueenMobility[28] = {
    S( -61,-263), S(-211,-387), S( -60,-201), S( -25,-192),
    S( -13,-140), S(  -8, -89), S(  -2, -61), S(  -3, -34),
    S(   0, -23), S(   1,   0), S(   3,  10), S(   5,  23),
    S(   6,  24), S(   8,  34), S(   6,  39), S(   5,  42),
    S(   3,  46), S(   0,  45), S(   0,  39), S(  -2,  33),
...
void initializeEvalInfo(EvalInfo* ei, Board* board, PawnKingTable* pktable){
    ...
    ei->mobilityAreas[WHITE] = ~((ei->pawnAttacks[BLACK] & ~white) | (white & kings) | ei->blockedPawns[WHITE]);
    ei->mobilityAreas[BLACK] = ~((ei->pawnAttacks[WHITE] & ~black) | (black & kings) | ei->blockedPawns[BLACK]);
