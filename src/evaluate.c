...
const int KingSafety[256] = { // int(math.floor(800.0 / (1.0 + math.pow(math.e, -.047 * (x - 96)))))
  0,   0,   0,   1,   1,   2,   3,   3,   4,   5,   6,   7,   8,  10,  11,  12,
 14,  15,  17,  19,  20,  22,  24,  26,  28,  30,  32,  35,  37,  39,  42,  44,
 47,  49,  52,  55,  57,  60,  63,  66,  69,  72,  75,  78,  82,  85,  88,  91,
 95,  98, 102, 105, 109, 113, 116, 120, 124, 128, 132, 136, 140, 144, 148, 152,
156, 160, 164, 169, 173, 177, 181, 186, 190, 195, 199, 204, 208, 213, 217, 222,
227, 231, 236, 241, 246, 250, 255, 260, 265, 270, 275, 280, 285, 290, 295, 300,
305, 310, 315, 320, 325, 330, 335, 340, 345, 350, 356, 361, 366, 371, 376, 381,
387, 392, 397, 402, 408, 413, 418, 423, 428, 434, 439, 444, 449, 455, 460, 465,
470, 475, 481, 486, 491, 496, 501, 506, 512, 517, 522, 527, 532, 537, 542, 547,
552, 557, 562, 567, 572, 577, 582, 587, 592, 597, 601, 606, 611, 616, 621, 625,
630, 635, 639, 644, 648, 653, 657, 662, 666, 671, 675, 679, 684, 688, 692, 696,
700, 705, 709, 713, 717, 721, 725, 728, 732, 736, 740, 743, 747, 751, 754, 758,
761, 765, 768, 771, 774, 778, 781, 784, 787, 790, 793, 796, 798, 801, 804, 806,
809, 812, 814, 816, 819, 821, 823, 825, 827, 829, 831, 833, 835, 837, 838, 840,
841, 843, 844, 845, 847, 848, 849, 850, 851, 852, 852, 853, 854, 854, 855, 855,
855, 855, 855, 855, 855, 855, 855, 855, 854, 854, 853, 852, 852, 851, 850, 849,
};

const int KingThreatMissingPawns = 6;

const int KingThreatWeight[PIECE_NB] = {   3,   6,   6,   9,  12,   0};
