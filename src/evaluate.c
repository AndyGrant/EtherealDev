...
const int KingSafety[64] = { // P(x) = -.000082 .007005 .054010 1.987151 -2.968148
     -2,   0,   1,   3,   6,   9,  12,  15,
     19,  23,  28,  33,  39,  45,  51,  58,
     65,  73,  82,  91, 101, 111, 122, 133,
    145, 157, 170, 184, 198, 212, 227, 243,
    259, 275, 292, 310, 327, 345, 363, 382,
    401, 420, 439, 458, 478, 497, 517, 536,
    556, 575, 594, 613, 631, 649, 667, 684,
    701, 717, 732, 747, 761, 773, 785, 796,
};
