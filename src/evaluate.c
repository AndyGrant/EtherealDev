...
const int KingShelter[2][FILE_NB/2][RANK_NB] = {
  {{S(  -5,  -1), S(  -2,  -2), S(   4,   3), S(   0,   4), S(  -5,   0), S(   0,   0), S(   0,   0), S( -21,   5)},
   {S(   5,   4), S(  14,  -5), S(  -1,  -2), S(  -4,  -1), S(  -2,  -1), S(   0,   0), S(   0,   0), S(  -9,  -2)},
   {S(  15,   8), S(  18,   0), S( -18,   5), S(  -4,  -6), S(   2,  -1), S(   0,   0), S(   0,   0), S( -16,   2)},
   {S(   0,   7), S(   8,   0), S(  -7,  -2), S(  20,  -5), S(  17,  -1), S(   0,   0), S(   0,   0), S(   0,  -2)}},
  {{S(   0,   0), S(  -2,  -3), S(   0,  -2), S(  -2,   0), S(   0,   0), S(   0,   0), S(   0,   0), S(  -3,   1)},
   {S(   0,   0), S(  20,   4), S(   6,   2), S( -13,   0), S( -10,  -1), S(   0,   0), S(   0,   0), S( -33,   3)},
   {S(   0,   0), S(  18,   2), S(  -1,  -2), S(   3,  -1), S(   1,   0), S(   0,   0), S(   0,   0), S( -11,  -3)},
   {S(   0,   0), S(   0,   8), S(   5,   1), S(  18,   0), S(  10,   0), S(   0,   0), S(   0,   0), S(  -5,  -8)}},
};
