...
const int PawnStacked[PHASE_NB] = { -14, -21};

const int PawnBackwards[2][PHASE_NB] = { {   1,  -2}, { -10,  -7} };
...
const int PawnConnected32[32][PHASE_NB] = {
    ...
    {   5,   0}, {   9,   0}, {   8,   5}, {  13,  13},
    {   5,   0}, {  12,   3}, {  10,   4}, {  15,   9},
    {   4,   8}, {  14,  11}, {  12,  12}, {  24,  16},
    {  27,  27}, {  23,  26}, {  60,  33}, {  42,  40},
    { 136,  20}, { 107,  -6}, { 110,  11}, { 113,  36},
    {   0,   0}, {   0,   0}, {   0,   0}, {   0,   0},
};

const int KnightValue[PHASE_NB] = { 298, 270};

const int KnightAttackedByPawn[PHASE_NB] = { -44, -22};

const int KnightOutpost[2][PHASE_NB] = { {  13, -22}, {  28,   3} };
...
const int BishopValue[PHASE_NB] = { 298, 272};

const int BishopWings[PHASE_NB] = {  -5,  -3};

const int BishopPair[PHASE_NB] = {  24,  40};

const int BishopAttackedByPawn[PHASE_NB] = { -40, -32};

const int BishopOutpost[2][PHASE_NB] = { {  14, -10}, {  33,  -9} };

const int BishopMobility[14][PHASE_NB] = {
    { -55, -65}, { -38, -36}, { -14, -26}, {  -5, -11},
    {   4,  -3}, {  12,   2}, {  15,   8}, {  19,   3},
    {  21,   7}, {  24,   3}, {  22,   3}, {  30,  -8},
    {  21,   1}, {   2, -23},
};
...
const int RookMobility[15][PHASE_NB] = {
    ...
    {  -6,  -7}, {  -5,   5}, {  -5,  13}, {  -3,  18},
    {   0,  23}, {   5,  21}, {   8,  26}, {  13,  31},
    {  12,  33}, {  15,  32}, {  11,  27},
};

const int QueenValue[PHASE_NB] = { 782, 820};

const int QueenChecked[PHASE_NB] = { -36,   0};

const int QueenCheckedByPawn[PHASE_NB] = { -57, -21};

const int QueenMobility[28][PHASE_NB] = {
    {-197, -66}, { -64,-322}, { -94,-196}, { -42, -99},
    { -28,-106}, { -22, -50}, { -16, -49}, { -12, -48},
    { -11, -47}, {  -7, -41}, {  -7, -30}, {  -4, -22},
    {  -1, -14}, {  -3,  -8}, {  -1,  -8}, {  -1,  -1},
    {  -2,   5}, {  -3,   6}, {  -1,   8}, {  -4,  12},
    {  -2,  14}, {   5,  15}, {   7,   8}, {  23,  12},
    {  23,  13}, {  17,   0}, {  28,  17}, {  -3,   5},
};
...
const int KingShelter[2][FILE_NB][RANK_NB][PHASE_NB] = {
  {{{  -3,   8}, {   9,  -5}, {  17,   0}, {  12,  -2}, {  17,   2}, {   7,  -4}, {  23,  27}, { -19,   2}},
   {{   0,   7}, {  11,   0}, {  23,  -5}, {  -5, -11}, {  -5, -16}, { -50,  61}, { -37,  74}, { -16,   0}},
   {{  10,   9}, {   7,   4}, { -12,   2}, {  -4,  -1}, {   0,  -7}, {  22, -24}, {   7, -33}, {  -6,  -1}},
   {{  14,  17}, {   7,   1}, {  -2,  -5}, {  10,  -5}, {   8,  -6}, { -18, -23}, { -44,  18}, {   0,   0}},
   {{   1,  12}, {   0,   1}, { -14,   0}, { -13,  -6}, { -20, -20}, {  -2, -23}, {  12, -22}, {  -8,   0}},
   {{  10,   2}, {  11,   0}, {  -2,  -2}, {  -6, -14}, {   4, -25}, {  -9, -10}, { -12,  -6}, { -11,   0}},
   {{   6,   1}, {   0,  -5}, { -14,  -6}, { -17, -13}, { -23, -16}, { -38,  13}, {  44,  17}, { -18,   6}},
   {{  -9,  -4}, {   1,  -5}, {   2,   0}, {  -1,   0}, { -17,  -4}, {  -8,  25}, {  -1,  40}, { -12,   9}}},
  {{{   0,   0}, {  -7, -10}, {   4, -14}, { -33,   9}, { -27,  -4}, { -30,  45}, {  28,  90}, { -29,   6}},
   {{   0,   0}, {  14,   0}, {  15,  -2}, { -13,  -2}, {  -3, -24}, { -83,  -1}, {-236,  93}, { -23,   1}},
   {{   0,   0}, {  17,   2}, {   4,  -1}, {  17, -18}, {  10,  -5}, { -72, -11}, { -53, -87}, {  -7,   0}},
   {{   0,   0}, {   6,   7}, {  -4,  11}, { -20,  -5}, {  -6,  -2}, {  -1,  14}, { -22,  15}, { -13,  -2}},
   {{   0,   0}, {   0,   6}, {   7,   0}, {   6,  -8}, {   3, -10}, { -15,  -2}, { -49,  16}, {  -1,  -2}},
   {{   0,   0}, {   0,   1}, {  -5,   0}, { -13, -13}, {   4, -14}, { -69, -32}, {-108,  26}, { -14,   0}},
   {{   0,   0}, {   8,  -1}, {  -1,  -1}, {  -7,  -8}, { -21, -13}, {  -1,  17}, { -19, -69}, { -27,   7}},
   {{   0,   0}, {   1, -12}, {   6,  -8}, { -35,  -1}, { -25,   1}, {  -7, -13}, {-121, -70}, { -26,  10}}},
};

const int PassedPawn[2][2][RANK_NB][PHASE_NB] = {
  {{{   0,   0}, { -23,  -8}, { -23,   0}, { -18, -10}, {  16,  -9}, {  42, -17}, {  94,   6}, {   0,   0}},
   {{   0,   0}, {  -4,   0}, { -11,  13}, { -11,  20}, {   9,  26}, {  59,  35}, { 124,  73}, {   0,   0}}},
  {{{   0,   0}, {  -2,   5}, { -10,   2}, {  -7,  11}, {  20,  15}, {  70,  33}, { 140,  87}, {   0,   0}},
...
void evaluateImbalance(EvalInfo* ei, Board* board){
    ...
    for (own = KNIGHT; own <= QUEEN; own++){
        for (opp = PAWN; opp < own; opp++){
            ei->midgame[WHITE] += Imbalance[own][opp][MG] * counts[WHITE][own] * counts[BLACK][opp] / 8;
            ei->endgame[WHITE] += Imbalance[own][opp][EG] * counts[WHITE][own] * counts[BLACK][opp] / 8;
            ei->midgame[BLACK] -= Imbalance[own][opp][MG] * counts[BLACK][opp] * counts[BLACK][own] / 8;
            ei->endgame[BLACK] -= Imbalance[own][opp][EG] * counts[BLACK][opp] * counts[BLACK][own] / 8;
        }
    }
}
