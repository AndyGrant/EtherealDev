...
const int PassedPawn[2][2][RANK_NB][PHASE_NB] = {
  {{{   0,   0}, { -12,  -7}, { -17,   6}, { -17,   2}, {   9,  14}, {  37,  13}, {  74,  30}, {   0,   0}},
   {{   0,   0}, {  -6,  -5}, { -20,  10}, { -14,  18}, {   4,  31}, {  46,  37}, {  96,  74}, {   0,   0}}},
  {{{   0,   0}, {   0,   4}, { -11,   5}, {  -9,  16}, {  15,  21}, {  60,  42}, { 121, 117}, {   0,   0}},
   {{   0,   0}, {  -3,  -1}, { -15,   3}, { -19,  28}, {  -8,  63}, {  32, 143}, { 120, 245}, {   0,   0}}},
};
...
void evaluatePassedPawns(EvalInfo* ei, Board* board, int colour){
    ...
    while (tempPawns != 0ull){
        ...
        canAdvance =  !(destination & notEmpty)
                    || (destination & (ei->pawnAttacks[colour] | ei->attackedBy2[colour]) & ~ei->attacked[!colour]);
