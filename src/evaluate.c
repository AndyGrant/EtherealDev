...
const int PawnBackwards[2] = { S(   5,  -3), S(  -9,  -5) };

const int PawnConnected32[32] = {
    S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
    S(   0, -17), S(   7,   1), S(   4,  -6), S(   4,  19),
    S(   8,  -1), S(  23,  -1), S(  14,   7), S(  17,  19),
    S(   7,   0), S(  18,   2), S(  12,   4), S(  16,  16),
    S(   6,  10), S(  19,  20), S(  21,  24), S(  35,  22),
    S(  22,  54), S(  23,  65), S(  65,  62), S(  49,  74),
