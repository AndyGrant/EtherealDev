...
const int QueenMobility[28] = {
    S( -54,-236), S(-195,-351), S( -43,-184), S( -34,-171),
    S( -11,-118), S( -25, -62), S( -15, -81), S( -19, -68),
    S( -10, -54), S(  -9, -45), S(  -2, -25), S(  -1, -24),
    S(  -3, -14), S(   2,  -6), S(   1,  -1), S(   0,   2),
    S(   5,  14), S(   0,  11), S(  10,  18), S(   0,  18),
    S(   0,  16), S(  17,  19), S(   4,   0), S(  28,   4),
    S(  30,  11), S(  50,  -5), S( -45, -15), S(   0,   0),
};
