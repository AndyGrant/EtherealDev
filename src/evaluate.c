...
const int PassedPawn[2][2][RANK_NB] = {
  {{S(   0,   0), S( -28, -25), S( -23,   4), S( -15,   0),
    S(  19,   0), S(  58,   0), S( 144,  33), S(   0,   0)},
   {S(   0,   0), S(  -5,  -7), S( -23,  10), S( -15,  25),
    S(   5,  37), S(  65,  62), S( 191, 132), S(   0,   0)}},
  {{S(   0,   0), S( -12,   4), S( -20,   0), S( -13,  14),
    S(  28,  36), S(  80,  73), S( 238, 154), S(   0,   0)},
   {S(   0,   0), S( -22,  -8), S( -17,   0), S( -16,  41),
    S(   0, 106), S(  44, 222), S( 126, 382), S(   0,   0)}},
};

const int PassedFriendlyDistance = S(   7, -10);

const int PassedEnemyDistance = S(   1,  11);

const int PassedSafePromotionPath = S(   2,  28);
