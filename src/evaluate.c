...
const int KingShelter[2][8][8] = {
  {{S( -16,  13), S(  10,  -9), S(  17,   0), S(  21,   0), S(   6,   6), S(  29,   3), S(   0, -31), S( -29,  13)},
   {S(   3,   5), S(  17,  -8), S(  13,  -8), S(  -2, -12), S( -25,   0), S( -65,  78), S(  99,  92), S( -30,   3)},
   {S(  14,  10), S(  12,  -2), S( -18,   0), S(  -7,  -2), S( -21,  -2), S(  14,  -8), S(   3,  64), S( -15,   2)},
   {S(   8,  28), S(  11,  -1), S(  -5,  -7), S(  20, -15), S(  16, -35), S( -22, -31), S(-146,  41), S(  -4,  -5)},
   {S( -17,  18), S(   0,   1), S( -26,   2), S( -11,   2), S( -23, -16), S( -40, -18), S(  38,  -7), S( -15,  -6)},
   {S(  23,   0), S(  25,  -3), S( -16,   1), S( -15, -21), S(   6, -31), S(  16, -48), S(  49, -32), S( -22,   0)},
   {S(  20,   0), S(   2, -11), S( -27,  -5), S( -17, -14), S( -24, -21), S( -43,   8), S(   6,  45), S( -26,  11)},
   {S( -18,  -3), S(   3,  -7), S(  15,   4), S(   0,   3), S( -15,  12), S(   2,  32), S(-200,  79), S( -24,  18)}},
  {{S(   0,   0), S(   4, -15), S(   5, -13), S( -46,  19), S(   0,  -8), S(   9,  51), S(-169, -13), S( -51,  13)},
   {S(   0,   0), S(  20,  -5), S(   9,  -5), S(  -5,  -7), S(  11, -31), S(  50, 101), S(-188, -11), S( -44,  11)},
   {S(   0,   0), S(  26,   0), S(   0,  -6), S(  19, -26), S(  13,  -7), S(-113,  43), S( -89, -83), S( -21,   0)},
   {S(   0,   0), S(  -5,   7), S(  -8,  13), S( -13,   2), S( -23,   0), S(-115,  10), S(   4, -49), S( -30,  -9)},
   {S(   0,   0), S(   4,   4), S(   4,  -6), S(  21,  -4), S(  12, -22), S( -44,   6), S(-107, -71), S(  -9, -10)},
   {S(   0,   0), S(  11,   0), S( -15,   0), S( -11, -14), S(  28, -37), S( -44,   4), S(  58,  47), S( -29,   2)},
   {S(   0,   0), S(  12,   0), S(   6,   2), S( -23,  -4), S( -22, -13), S(  21,  10), S( -57, -64), S( -49,  17)},
   {S(   0,   0), S(   4, -28), S(  11, -15), S( -22,   0), S( -27,  -2), S(   5, -16), S(-239, -72), S( -45,  15)}},
};
