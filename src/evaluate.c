...
const int KingShelter[2][FILE_NB/2][RANK_NB] = {
  {{S( -11,  -5), S(  -4,  -8), S(   4,   2), S(   0,   5), S(  -4,   0), S(   2,   2), S(   0,   0), S( -22,  10)},
   {S(  16,   4), S(  10,  -9), S(  -9,  -4), S(  -8,  -4), S(  -4,  -2), S(   0,   0), S(   0,   0), S( -11,   4)},
   {S(  24,   7), S(  17,   1), S( -20,   6), S(  -4, -10), S(   3,  -1), S(   1,   0), S(   0,   0), S( -16,   7)},
   {S(   3,  11), S(   7,   0), S(  -8,  -2), S(  18,  -8), S(  17,  -4), S(   0,   0), S(   0,   0), S(   0,   0)}},
  {{S(   0,   0), S(   0, -11), S(   4,  -3), S(  -3,  -1), S(   0,   0), S(   0,   0), S(   0,   0), S(  -4,  11)},
   {S(   0,   0), S(  20,   0), S(   7,   0), S( -14,  -2), S( -12,  -1), S(   0,   0), S(   0,   0), S( -35,  10)},
   {S(   0,   0), S(  12,   3), S(  -7,  -3), S(   1,  -4), S(   1,   0), S(   0,   0), S(   0,   0), S( -10,  -1)},
   {S(   0,   0), S(   2,  11), S(   6,   2), S(  19,  -2), S(  14,  -1), S(   0,   0), S(   0,   0), S(  -1,  -6)}},
};
