...
const int KingShelter[2][FILE_NB/2][RANK_NB] = {
  {{S(  -6,   0), S(   1, -13), S(   9,   1), S(   2,   1), S(  -8,   0), S(   2,   1), S(   0,   0), S(  -9,   7)},
   {S(  19,  10), S(   8,  -6), S( -15,  -5), S(  -7,  -5), S(  -4,  -2), S(   0,   0), S(   0,   0), S(   0,   0)},
   {S(  15,  19), S(  24,  -4), S( -23,   1), S( -12,  -8), S(   0,  -2), S(   0,  -1), S(   0,   0), S(  -4,   3)},
   {S(   2,   9), S(  -2,   9), S( -20,   4), S(  10,  -5), S(   6,  -6), S(  -1,   0), S(   0,   0), S(   2,   4)}},
  {{S(   0,   0), S(   5, -12), S(  11,  -3), S(  -4,  -2), S(  -1,  -1), S(   0,   0), S(   0,   0), S(   0,   5)},
   {S(   0,   0), S(  28,  -3), S(  10,   0), S( -22,  -4), S( -10,  -3), S(   0,   0), S(   0,   0), S( -16,   9)},
   {S(   0,   0), S(   0,  10), S( -10,   0), S(  -4,  -3), S(   0,  -1), S(   0,   0), S(   0,   0), S(   2,   0)},
   {S(   0,   0), S(  -4,   8), S(   4,   2), S(  15,   0), S(   2,  -2), S(   0,   0), S(   0,   0), S(  -5,   3)}},
};
