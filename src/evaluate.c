...
const int KingShelter[2][FILE_NB/2][RANK_NB] = {
  {{S(  -9, -13), S(   7, -25), S(   9,  -9), S(  -2,   0),
    S( -11,   6), S(  -6,  22), S(  -8,  -2), S( -20,   7)},
   {S(  27,  -6), S(  18, -18), S( -10,  -4), S( -16,  -6),
    S( -30,   0), S(  -9,  18), S(   0,   4), S( -12,   3)},
   {S(  44,  -2), S(  27,  -8), S( -20,   8), S( -10, -11),
    S(   4, -14), S(   6,   0), S(   3,   6), S( -23,   9)},
   {S(  -6,  13), S(  20,  -6), S(   2,  -8), S(  18, -17),
    S(  25, -30), S( -45,   6), S(  -6,  -1), S(   8,  -2)}},
  {{S(   0,   0), S(  16, -26), S(  20, -16), S( -16,   6),
    S( -12,  20), S(   0,  22), S(   0,   0), S( -19,  18)},
   {S(   0,   0), S(  34,  -3), S(  20,  -1), S(  -2,   0),
    S( -17,  15), S(   2,  18), S(  -7,   0), S( -25,  19)},
   {S(   0,   0), S(  19,   0), S( -14,   6), S(   2, -12),
    S(  15,  -9), S(   1,   0), S(  -1,   0), S( -23,   4)},
   {S(   0,   0), S(  16,   4), S(  17,  -5), S(  21, -15),
    S(  20, -22), S( -31,   7), S(  -5,  -1), S(   4,  -8)}},
};
