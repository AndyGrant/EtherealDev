...
const int KingShelter[2][8][8] = {
  {{S(  -2,   0), S(   2,  -2), S(   8,   1), S(  10,   2), S(   2,   7), S(  13,  12), S( -15,   0), S(  -8,   0)},
   {S(   7,   2), S(   9,   0), S(   6,   0), S(  -3,  -1), S(  -2,   2), S(  32,  21), S( -91,  12), S( -10,  -1)},
   {S(   1,   3), S(   6,   0), S(  -9,  -3), S(  -1,  -3), S(  -9,  -5), S(   2,   4), S(   7,  28), S(  -7,  -1)},
   {S(  12,   9), S(   3,   2), S(  -7,   0), S(  13,   0), S(   9,  -6), S( -18,  -1), S(  12,  -7), S(   0,   0)},
   {S(  -7,   4), S(  -1,   1), S(   0,   0), S(   9,   0), S(  -1,  -7), S( -17,  -7), S(   3,   7), S(  -3,  -1)},
   {S(   9,   5), S(  12,   3), S( -17,  -2), S(  -9,  -5), S(  -5,  -7), S(  -5,  -6), S(  29,  10), S(  -8,   0)},
   {S(   5,   2), S(   4,   0), S(  -5,  -1), S( -17,  -4), S( -22,  -7), S(   0,   6), S( -32, -21), S( -14,   0)},
   {S(  -9,  -1), S(  -2,  -2), S(   4,   1), S(   0,   1), S(  -8,   0), S(   7,   8), S( -82,   0), S(  -1,   4)}},
...
int evaluateKings(EvalInfo* ei, Board* board, int colour){
    ...
    for (int file = MAX(0, kingFile - 1); file <= MIN(FILE_NB - 1, kingFile + 1); file++){
        ...
        pkeval += KingShelter[0][file][distance];
        if (TRACE) T.KingShelter[0][file][distance][US]++;
    }
