...
const int KnightMobility[9] = {
    S( -47, -92), S( -24, -43), S( -13, -21),
    S(  -8, -12), S(   0, -12), S(   6,   0),
    S(  12,  -4), S(  20,  -9), S(  26, -31),
};
...
const int BishopMobility[14] = {
    S( -32, -61), S( -22, -38), S(  -8, -28), S(  -2, -17),
    S(   5,  -6), S(  11,   1), S(  14,   3), S(  17,   3),
    S(  20,   6), S(  24,   0), S(  25,   0), S(  36, -19),
    S(  39, -15), S(  74, -46),
};
...
const int RookMobility[15] = {
    S( -94, -50), S( -12, -49), S(   1, -26), S(   3, -21),
    S(   0,  -2), S(   3,   1), S(   8,   1), S(  11,   7),
    S(  16,   8), S(  19,  13), S(  24,  14), S(  26,  17),
    S(  33,  15), S(  43,  12), S(  34,  16),
};
...
const int QueenMobility[28] = {
    S(   0,   0), S(  -7,-164), S( -16, -99), S( -13, -77),
    S( -13, -45), S( -13, -31), S( -11, -18), S(  -7, -18),
    S(  -5, -14), S(   0, -14), S(   1,  -2), S(   4,  -7),
    S(   4,   1), S(   7,   4), S(   8,   6), S(  10,   6),
    S(  13,   5), S(  12,   1), S(  10,   2), S(  18,  -4),
    S(  26, -18), S(  23,  -9), S(  30, -25), S(  14, -12),
    S(  30, -22), S(  36, -21), S( -33, -25), S(  -2, -26),
};
