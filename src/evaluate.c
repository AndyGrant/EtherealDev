...
const int PawnValue   = S( 105, 126);
const int KnightValue = S( 455, 408);
const int BishopValue = S( 477, 426);
const int RookValue   = S( 661, 687);
...
const int PawnPSQT32[32] = {
    ...
    S( -21,   8), S(   2,   2), S( -10,   4), S(  -7,  -2),
    S( -25,   3), S( -14,   4), S( -12,  -4), S(  -6, -13),
    S( -20,  11), S( -14,  12), S(   7,  -9), S(   8, -22),
    S( -11,  14), S(  -5,   9), S(  -9,  -5), S(  -2, -19),
...
const int KnightPSQT32[32] = {
    S( -48, -31), S(  -4, -28), S( -12, -29), S(   2, -15),
    S(   0, -20), S(   3, -11), S(   4, -27), S(  11, -17),
    S(  11, -26), S(  21, -22), S(  16, -16), S(  25,  -4),
    S(  21,   1), S(  25,   6), S(  32,  17), S(  32,  23),
...
const int BishopPSQT32[32] = {
    S(   8, -26), S(  12, -18), S(  -6,  -8), S(  11, -11),
    S(  30, -35), S(  12, -35), S(  22, -20), S(  12, -11),
    S(  16, -13), S(  29, -15), S(   5, -17), S(  24,  -5),
    S(  15,  -7), S(  20,  -3), S(  17,   4), S(  26,   5),
    S( -10,  14), S(  20,   5), S(   5,  14), S(  15,  17),
...
const int QueenPSQT32[32] = {
    ...
    S(  14, -42), S(  28, -58), S(  30, -71), S(  19, -26),
    S(  11, -30), S(  26, -20), S(   7,   7), S(   8,   1),
    S(  13,  -8), S(  16,  12), S(  -1,  24), S( -15,  65),
...
const int KingPSQT32[32] = {
    S(  46, -77), S(  38, -49), S( -16, -10), S( -32, -20),
    S(  27, -21), S( -14, -12), S( -44,  12), S( -63,  14),
    S(  -4, -20), S(   6, -18), S(  13,   3), S( -17,  19),
    S(   1, -30), S(  95, -34), S(  46,   7), S(  -4,  27),
    S(  10, -14), S( 108, -31), S(  56,  13), S(  12,  21),
...
const int PawnStacked[2] = { S(  -6, -19), S(  -8,  -8) };

const int PawnBackwards[2][RANK_NB] = {
   {S(   0,   0), S(   3,  -6), S(   8,  -6), S(  10, -11),
    S(   7, -12), S(   0,   0), S(   0,   0), S(   0,   0)},
   {S(   0,   0), S( -11, -28), S(  -6, -24), S(   5, -26),
    S(  28, -30), S(   0,   0), S(   0,   0), S(   0,   0)},
};

const int PawnConnected32[32] = {
    S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
    S(  -2,  -5), S(  11,   1), S(   2,   1), S(   5,  12),
    S(  15,   0), S(  27,  -4), S(  20,   5), S(  23,  12),
    S(   8,  -1), S(  24,   1), S(  10,   8), S(  16,  15),
    S(  10,   9), S(  21,  14), S(  26,  21), S(  32,  19),
...
const int KnightMobility[9] = {
    S( -78,-106), S( -31,-102), S( -15, -42), S(  -3, -15),
    S(   7,  -6), S(  12,  10), S(  20,  13), S(  29,  12),
    S(  42,  -3),
};
...
const int RookFile[2] = { S(  14,   4), S(  33,   4) };
...
const int KingShelter[2][FILE_NB][RANK_NB] = {
  {{S(  -9,   2), S(  14, -26), S(  26,  -9), S(  17,   6),
   ...
   {S(  48, -18), S(  22, -13), S( -21,   4), S( -11, -19),
    S(   7, -25), S(  19, -21), S(  40, -32), S( -23,   1)},
   {S(  29, -16), S(  -1, -16), S( -26,  -1), S( -22,  -7),
    S( -31,  -5), S( -41,  30), S(   1,  44), S(  -9,  -1)},
   {S(  -9, -13), S(   5, -18), S(   8,   2), S(  -1,  12),
  ...
  {{S(   0,   0), S( -13, -26), S(   7, -23), S( -39,  20),
   ...
   {S(   0,   0), S(  13,   2), S(  12,  -6), S(  14, -13),
    S(  17, -31), S( -57,  14), S(-101, -60), S(  -1,  -3)},
   {S(   0,   0), S(   2,  -6), S( -26,   2), S( -23,  -9),
    S(  23, -23), S( -37,   3), S(  55,  39), S( -17,  -5)},
   {S(   0,   0), S(  24, -16), S(  11, -15), S( -11,  -7),
    S( -28,  14), S(  -8,  19), S( -57, -50), S( -32,  11)},
...
const int KingStorm[2][FILE_NB/2][RANK_NB] = {
  {{S( -13,  32), S( 112,  -6), S( -23,  25), S( -14,   3),
    S( -11,   0), S(  -6,  -6), S( -15,   2), S( -24,   2)},
   {S(  -8,  53), S(  51,  14), S( -20,  22), S(  -3,   8),
    S(  -2,   4), S(   6,  -5), S(  -2,   2), S( -10,   4)},
   {S(   3,  43), S(   4,  28), S( -22,  19), S( -10,   6),
    S(   3,   1), S(   8,   0), S(  12,  -6), S(   6,   3)},
...
const int PassedFriendlyDistance[FILE_NB] = {
    ...
    S(   4, -12), S(  -9,  -9), S( -17,  -1), S(   0,   0),
};

const int PassedEnemyDistance[FILE_NB] = {
    S(   0,   0), S(   2,  -1), S(   4,   0), S(   9,  10),
    S(   2,  24), S(   8,  30), S(  27,  26), S(   0,   0),
};
...
const int ThreatWeakPawn             = S(  -7, -26);
