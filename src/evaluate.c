...
const int KnightMobility[9] = {
    S( -90, -85), S( -34, -93), S( -19, -42), S(  -4, -15),
    S(   4, -15), S(   9,   0), S(  20,  -3), S(  33,  -7),
    S(  50, -43),
};
...
const int BishopMobility[14] = {
    S( -58,-127), S( -46, -66), S( -18, -46), S(  -4, -20),
    S(   8, -10), S(  18,  -1), S(  22,   5), S(  24,   3),
    S(  26,   8), S(  31,   1), S(  34,   3), S(  45, -16),
    S(  45,  -4), S(  40, -35),
};
...
const int RookMobility[15] = {
    S(-147,-106), S( -73,-120), S( -15, -67), S(  -8, -25),
    S(  -7,  -2), S(  -5,  13), S(  -6,  25), S(  -1,  32),
    S(   3,  34), S(   8,  38), S(  10,  42), S(  15,  47),
    S(  19,  50), S(  25,  46), S(  19,  47),
};

/* Queen Evaluation Terms */

const int QueenMobility[28] = {
    S( -61,-263), S(-216,-390), S( -48,-205), S( -36,-190),
    S( -12,-132), S( -23, -69), S( -13, -91), S( -15, -75),
    S( -10, -61), S(  -9, -51), S(  -7, -29), S(  -4, -26),
    S(  -5, -15), S(  -1,  -8), S(  -1,  -3), S(  -2,   3),
    S(   3,  16), S(   0,  14), S(  10,  21), S(  -1,  19),
    S(   0,  18), S(  19,  22), S(   5,   0), S(  31,   4),
