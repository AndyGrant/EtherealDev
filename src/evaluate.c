...
const int KingDefenders[12] = {
    S( -23,  -3), S(  -9,   0), S(   0,   2), S(   7,   4),
    S(  16,   4), S(  26,   1), S(  33,   0), S(  13,   0),
    S(  12,   6), S(  12,   6), S(  12,   6), S(  12,   6),
};

const int KingShelter[2][FILE_NB/2][RANK_NB] = {
  {{S(  -8,  -5), S(  10, -16), S(  12,  -1), S(   1,   8), S(  -4,   6), S(   0,   6), S(  -1,   0), S( -15,  12)},
   {S(  21,   0), S(  16, -11), S( -11,   1), S( -13,  -1), S( -17,  -2), S(  -1,   3), S(   0,   0), S( -14,   8)},
   {S(  39,   0), S(  24,  -5), S( -22,  11), S( -12,  -6), S(   0,  -7), S(   1,   0), S(   0,   0), S( -23,  11)},
   {S( -10,  16), S(  14,  -1), S(  -5,  -1), S(  11,  -8), S(  15, -15), S( -17,  -2), S(   0,   0), S(   0,   3)}},
  {{S(   0,   0), S(  12, -19), S(  15,  -9), S( -11,   3), S(  -1,   6), S(   0,   2), S(   0,   0), S( -17,  15)},
   {S(   0,   0), S(  30,  -5), S(  16,  -4), S(  -4,   0), S( -19,   6), S(   0,   3), S(  -1,   0), S( -30,  17)},
   {S(   0,   0), S(  18,  -1), S( -16,   5), S(   0,  -8), S(   4,  -1), S(   0,   0), S(   0,   0), S( -24,   2)},
   {S(   0,   0), S(   8,   7), S(   7,   0), S(  12,  -6), S(   7,  -9), S(  -6,   0), S(   0,   0), S(  -5,  -3)}},
};

const int KingStorm[2][FILE_NB/2][RANK_NB] = {
  {{S(   0,  21), S( 115,  -9), S( -26,  24), S( -22,  10), S( -14,   3), S(  -9,  -1), S( -20,   9), S( -22,  -2)},
   {S(   0,  46), S(  58,  11), S( -18,  24), S(  -7,  12), S(  -4,   5), S(   3,  -2), S(  -2,   1), S( -16,   1)},
   {S(  10,  36), S(  19,  22), S( -24,  21), S( -14,  11), S(   3,   2), S(   7,   0), S(   8,  -8), S(   3,  -1)},
   {S(   0,  23), S(  19,  19), S( -10,   7), S( -12,   2), S(  -5,   0), S(  11, -13), S(   7, -13), S( -10,   1)}},
  {{S(   0,   0), S( -12, -14), S( -12,  -4), S(  21, -18), S(  10,  -6), S(  -2, -10), S(  -5,   7), S(  13,  26)},
   {S(   0,   0), S( -13, -30), S(  -8, -11), S(  29, -13), S(  -5,   0), S(   4, -19), S( -10,  -5), S( -16,   3)},
   {S(   0,   0), S( -24, -44), S( -32,  -7), S(   7,  -9), S(   3,  -2), S(  -9, -17), S( -10, -14), S(  -9,   6)},
   {S(   0,   0), S(  -1, -15), S( -13, -18), S(  -8,  -4), S(   2,  -9), S(  12, -37), S(  59,  -8), S(  10,  17)}},
};
