...
const int KingShelter[2][4][8] = {
  {{S( -24,  13), S(  -9,   2), S(  -4,   9), S( -11,  10), S( -24, -13), S( -38, -17), S(  38,  -8), S( -33,   9)},
   {S(   6,  -4), S(   6, -11), S( -18,   0), S(  -6, -19), S(   4, -32), S(  16, -48), S(  49, -33), S( -21,   0)},
   {S(  18,   0), S(  14,  -4), S( -24,   2), S(  -9, -11), S(  -9, -18), S( -42,   9), S(   6,  46), S( -27,   6)},
   {S( -17,   6), S(   1,  -5), S( -17,   0), S(  19,  -3), S(  13,  12), S(   2,  31), S(-200,  78), S(  -4,   1)}},
  {{S(   0,   0), S( -10,  -3), S(   0, -10), S(  20,  -6), S(   9, -22), S( -44,   8), S(-108, -72), S(  -9,   2)},
   {S(   0,   0), S(  15,   2), S(   1,   7), S( -13,  -9), S(  13, -38), S( -44,   5), S(  58,  46), S( -39,   6)},
   {S(   0,   0), S(  10,  -2), S(  -9,  -1), S( -14,  -4), S( -18, -12), S(  22,  11), S( -57, -64), S( -48,   9)},
   {S(   0,   0), S( -10, -13), S(  -8, -10), S(  12,  -1), S(  -3,  -3), S(   6, -17), S(-239, -73), S( -23,  -5)}},
};
