...
const int PawnConnected32[32] = {
    ...
    S(   4, -28), S(  24,   3), S(  14, -10), S(   0,  23),
    S(  15,   4), S(  36,   8), S(  11,  22), S(  19,  34),
    S(   2,  11), S(  13,  13), S(   9,   4), S(  24,  17),
    S(   7,  17), S(  25,  31), S(  32,  31), S(  58,  21),
    S(  24,  57), S(  25,  68), S(  69,  67), S(  52,  77),
    S( 106, -13), S( 199,  16), S( 227,  21), S( 250,  76),
    S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
};
