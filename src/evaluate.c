...
const int PawnValue   = S( 107, 137);
const int KnightValue = S( 486, 475);
const int BishopValue = S( 527, 510);
const int RookValue   = S( 692, 798);
const int QueenValue  = S(1523,1619);
...
const int PawnPSQT[SQUARE_NB] = {
    ...
    S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
    S( -21,   6), S( -14,  13), S(  -7,  13), S(  -9,  10),
    S(  -5,  14), S(   7,   2), S( -10,  10), S( -26,   7),
    S( -14,  -2), S( -26,  12), S(  -2,  -4), S(   1, -10),
    S(   2,  -6), S(  -1,  -3), S( -15,   6), S( -22,   5),
    S( -12,   9), S( -24,  19), S(   8,  -8), S(  14, -22),
    S(  13, -20), S(  12, -13), S( -19,  18), S( -16,  10),
    S( -10,  11), S( -11,  10), S(  -7,  -8), S(  17, -27),
    S(  13, -22), S(   4, -13), S( -12,  10), S( -16,  14),
    S(  -7,  26), S(  -6,  34), S(   9,  22), S(  41, -11),
    S(  52,  -9), S(  28,  12), S(  14,  31), S(  -3,  30),
    S( -50, -64), S( -72,  -7), S(  12, -33), S(  75, -28),
    S(  74, -39), S(  46, -26), S( -42,   0), S( -69, -51),
    S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
    S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
};

const int KnightPSQT[SQUARE_NB] = {
    S( -21, -21), S( -25, -14), S( -19,  -6), S( -10,  -4),
    S(  -2,   1), S( -19, -12), S( -23, -15), S( -26,   4),
    S(  -3,  -4), S(   1,   9), S(   0, -13), S(  -3,   2),
    S(   4,  -2), S(   2, -12), S(   9,   8), S(   0,  -5),
    S(   1, -10), S(   9,   1), S(   3,   1), S(  16,  15),
    S(  16,  14), S(   5,   4), S(  24,  -4), S(   6,  -7),
    S(  24,  17), S(  19,  28), S(  23,  33), S(  27,  38),
    S(  21,  44), S(  34,  27), S(  19,  28), S(  31,  20),
    S(  29,  26), S(  24,  26), S(  31,  40), S(  40,  49),
    S(  34,  52), S(  33,  45), S(  26,  36), S(  38,  25),
    S(  11,  24), S(  25,  31), S(  41,  37), S(  50,  43),
    S(  49,  41), S(  47,  39), S(  29,  36), S(  20,  26),
    S(  20,  23), S(  23,  25), S(  51,  11), S(  67,  24),
    S(  64,  24), S(  69,   8), S(  22,  31), S(  22,  23),
    S(-209,  21), S(  -5,  37), S( -61,  48), S(  11,  34),
    S(  50,  30), S(-156,  75), S(   8,  33), S(-112,   2),
};

const int BishopPSQT[SQUARE_NB] = {
    S(  12, -25), S(  20,   6), S(  -4,  -2), S(   2,   6),
    S(  11,   0), S( -21,  15), S(  12,   4), S(  -4, -23),
    S(  38,   1), S(   9, -27), S(  19,   6), S(   7,   8),
    S(  11,   8), S(  19,   3), S(  15, -30), S(  28,  -6),
    S(  18,   6), S(  35,  11), S(   5,  -8), S(  21,  24),
    S(  19,  23), S(   6, -13), S(  31,   9), S(  20,  15),
    S(  11,  12), S(   8,  25), S(  23,  35), S(  26,  37),
    S(  28,  35), S(  22,  28), S(  14,  24), S(  12,   7),
    S( -13,  18), S(  18,  30), S(  14,  37), S(  28,  47),
    S(  22,  44), S(  28,  36), S(  14,  33), S(  -1,  20),
    S( -19,  23), S(  12,  35), S(  -4,  18), S(  36,  33),
    S(  35,  36), S(  23,  10), S(  12,  40), S(   0,  21),
    S(  -9,  25), S( -26,  11), S(   2,  33), S(  13,  32),
    S(   0,  31), S(  13,  30), S( -34,   7), S( -24,  32),
    S( -72,  19), S( -31,  37), S( -49,  45), S( -27,  38),
    S(  -2,  31), S( -63,  40), S( -22,  35), S( -51,   4),
};

const int RookPSQT[SQUARE_NB] = {
    S( -25,   3), S( -17,   3), S( -14,   5), S(   1,  -8),
    S(   9, -13), S(  -4,  -9), S( -26,   6), S( -20, -14),
    S( -48,   5), S( -23,  -3), S( -13,  -3), S(  -8,  -7),
    S(  -5, -14), S( -11, -17), S( -20, -15), S( -72,   7),
    S( -39,  12), S( -19,  13), S( -25,  13), S( -16,   9),
    S(  -8,   2), S( -29,  11), S( -11,   1), S( -39,   4),
    S( -33,  29), S( -23,  33), S(  -9,  31), S(  -6,  25),
    S(   1,  21), S( -13,  26), S( -15,  26), S( -31,  23),
    S( -20,  46), S(   2,  41), S(  12,  41), S(  17,  34),
    S(  28,  30), S(  11,  33), S(  10,  36), S( -15,  38),
    S( -11,  56), S(  10,  47), S(  12,  51), S(  38,  36),
    S(  39,  34), S(  14,  43), S(  15,  40), S( -17,  57),
    S( -12,  46), S( -17,  51), S(  11,  43), S(  22,  40),
    S(  28,  36), S(   1,  41), S( -19,  51), S(   4,  36),
    S(  36,  51), S(  38,  57), S(  32,  56), S(  44,  50),
    S(  39,  50), S(  24,  54), S(  51,  50), S(  57,  43),
};

const int QueenPSQT[SQUARE_NB] = {
    S(  23, -32), S(   2,  -7), S(   1, -18), S(   7, -14),
    S(  15, -21), S(  -2, -29), S(  12, -50), S(  39, -42),
    S(   6,   3), S(  10,  -6), S(  24, -27), S(  19,  -7),
    S(  22,  -6), S(  34, -53), S(  32, -59), S(  23, -20),
    S(   9,  14), S(  19,  11), S(   6,  35), S(   9,  27),
    S(  10,  36), S(  15,  15), S(  32,  -2), S(  26,  -9),
    S(  19,   7), S(  -6,  64), S(  -5,  73), S( -21, 107),
    S(  -3,  74), S(  -8,  52), S(   7,  56), S(  12,  21),
    S(  -4,  58), S(  -8,  86), S( -12,  90), S( -36, 126),
    S( -26, 102), S( -26,  62), S( -16,  68), S(  15,   7),
    S( -20,  80), S(  -7,  83), S( -20, 103), S( -17,  97),
    S( -26,  78), S( -23,  64), S( -25,  71), S( -14,  60),
    S( -22,  99), S( -31, 110), S( -20, 106), S( -10,  90),
    S( -38,  89), S(  -5,  43), S( -20, 114), S(  21,  58),
    S( -20,  88), S(  17,  60), S(  22,  52), S(  10,  54),
    S(   7,  52), S(   5,  41), S(   8,  70), S(  14,  65),
};

const int KingPSQT[SQUARE_NB] = {
    S(  72, -72), S(  57, -49), S(   8, -12), S( -59,   6),
    S( -14, -17), S( -34,   3), S(  46, -48), S(  66, -75),
    S(  39, -17), S(  -8, -13), S( -39,  10), S( -50,  14),
    S( -49,  25), S( -43,  18), S( -10, -17), S(  29, -17),
    S( -18, -23), S(  -4, -17), S(  16,   8), S(  23,  18),
    S(  17,  32), S(  24,   8), S(   9, -23), S(  -3, -16),
    S( -16, -42), S(  73, -28), S(  52,  12), S(  20,  28),
    S(  25,  39), S(  77,   6), S(  80, -23), S( -18, -29),
    S(  21, -23), S(  84, -23), S(  41,  17), S(  22,  10),
    S(   3,  28), S(  43,  17), S(  51, -18), S( -17,  -6),
    S(  58, -42), S( 132, -18), S( 109,   4), S(  28, -10),
    S(   5,   1), S( 111, -11), S(  96, -13), S(   2, -35),
    S(  36, -88), S(  57, -31), S(  16, -14), S(  50, -37),
    S(  14, -29), S(  83, -26), S(  57, -32), S(  26, -95),
    S( -50, -79), S(  47, -99), S( -49, -64), S( -30, -31),
    S( -90, -30), S(  43, -79), S(  57, -82), S(-132, -73),
};

/* Pawn Evaluation Terms */

const int PawnCandidatePasser[2][RANK_NB] = {
   {S(   0,   0), S( -35,  24), S(  -7,  13), S(  -8,  18),
    S( -20,  54), S(   6,  77), S(   0,   0), S(   0,   0)},
   {S(   0,   0), S(  -4,  18), S(  -5,  23), S(   3,  33),
    S(   8,  64), S(  38,  78), S(   0,   0), S(   0,   0)},
};

const int PawnIsolated[FILE_NB] = {
    S( -18,  -4), S(  -1, -15), S(  -4, -16), S(  -7, -15),
    S(  -4, -17), S(  -1, -15), S(  -7, -16), S(  -9, -11),
};

const int PawnStacked[2][FILE_NB] = {
   {S(   0, -30), S(   2, -29), S(  -8, -16), S(  -8,  -9),
    S(  -7, -10), S(   1, -20), S(  14, -28), S(  -1, -34)},
   {S(   0, -15), S(   4, -19), S(  -7, -10), S( -12,   1),
    S( -10,   0), S(  -6,  -8), S(   6, -16), S(  -1, -19)},
};

const int PawnBackwards[2][RANK_NB] = {
   {S(   0,   0), S(  -5,  -4), S(   7,  -6), S(   3, -11),
    S(   8, -18), S(   0,   0), S(   0,   0), S(   0,   0)},
   {S(   0,   0), S( -12, -21), S(  -1, -21), S(   8, -20),
    S(  41, -19), S(   0,   0), S(   0,   0), S(   0,   0)},
};

const int PawnConnected32[32] = {
    S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
    S(   1,  -8), S(  11,   1), S(   0,  -4), S(   7,   9),
    S(   9,   2), S(  22,  -2), S(  18,   4), S(  16,  11),
    S(   7,   3), S(  18,   6), S(  10,   8), S(   8,  15),
    S(  10,  14), S(  15,  22), S(  33,  26), S(  17,  27),
    S(  45,  35), S(  43,  49), S(  58,  60), S(  66,  61),
    S( 186,  56), S( 216,  47), S( 148,  91), S( 218,  71),
    S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
};
...
const int KnightBehindPawn = S(   5,  18);

const int KnightInSiberia[4] = {
    S(  -7,   0), S(  -7, -12), S( -18, -21), S( -34, -40),
};

const int KnightMobility[9] = {
    S( -64,-169), S( -26, -72), S( -10, -23), S(   3,   1),
    S(  15,  14), S(  24,  27), S(  32,  31), S(  41,  35),
    S(  50,  29),
};

/* Bishop Evaluation Terms */

const int BishopPair = S(  38,  74);
...
const int BishopBehindPawn = S(   6,  14);

const int BishopLongDiagonal = S(  23,  29);

const int BishopMobility[14] = {
    S( -46,-113), S( -22, -50), S(  -1, -21), S(  15,  -7),
    S(  23,   8), S(  30,  17), S(  34,  24), S(  36,  28),
    S(  39,  31), S(  41,  32), S(  42,  32), S(  51,  25),
    S(  49,  31), S(  53,  22),
};

/* Rook Evaluation Terms */

const int RookFile[2] = { S(  23,  11), S(  43,   0) };

const int RookOnSeventh = S(  13,  28);

const int RookMobility[15] = {
    S(-140,-105), S( -46, -92), S( -17, -32), S(  -9,  -8),
    S(  -2,   9), S(   2,  23), S(   3,  33), S(   7,  37),
    S(  10,  41), S(  13,  46), S(  15,  52), S(  16,  57),
    S(  19,  57), S(  19,  59), S(  31,  46),
};

/* Queen Evaluation Terms */

const int QueenRelativePin = S( -17, -15);

const int QueenMobility[28] = {
    S(-182,-299), S( -25,-388), S( -35,-134), S(  -9,-115),
    S(  -4, -48), S(   4, -27), S(   9, -15), S(  13,   4),
    S(  15,  16), S(  16,  28), S(  16,  34), S(  17,  43),
    S(  18,  46), S(  19,  48), S(  19,  51), S(  17,  52),
    S(  16,  55), S(  14,  51), S(  11,  50), S(  10,  39),
    S(  17,  20), S(  22,   5), S(  18, -10), S(  23, -33),
    S(  34, -68), S(  27, -79), S(  -5,-119), S(  20,-115),
};

/* King Evaluation Terms */

const int KingDefenders[12] = {
    S( -12,  -4), S(  -9,   2), S(   0,   4), S(   8,   5),
    S(  15,   5), S(  23,   0), S(  26,  -9), S(  21,  29),
    S(  57,  16), S(  12,   6), S(  12,   6), S(  12,   6),
};

const int KingPawnFileProximity[FILE_NB] = {
    S(  42,  40), S(  14,  33), S(  19,  15), S(  14, -18),
    S(  11, -56), S(   8, -72), S( -18, -61), S( -28, -30),
};

const int KingShelter[2][FILE_NB][RANK_NB] = {
  {{S(  -4,  -9), S(   8, -13), S(  24, -10), S(  17,   1),
    S(  -6,   8), S( -17,  21), S( -92, -18), S( -39,  11)},
   {S(  18,  -9), S(   7, -10), S(   0,  -2), S(  -2,  -4),
    S( -15,  -1), S(   1,  -8), S( -24,  49), S( -30,   4)},
   {S(  24,  -3), S(   9,  -4), S( -24,   8), S( -15,  -5),
    S(   0, -15), S(  -1, -16), S( -15,  12), S( -18,  -2)},
   {S(  22,   3), S(  21,  -9), S(  -5,  -5), S(  12, -16),
    S(  17, -30), S( -12,  -7), S( -35,  -4), S(  -7,  -9)},
   {S(  -6,  10), S(  -2,   0), S( -22,   3), S( -15,  -1),
    S( -23,  -7), S( -54,   7), S( -64,  11), S( -16,  -3)},
   {S(  28,  -8), S(  13, -13), S( -16,   2), S(  -9, -11),
    S( -12,  -2), S(   0, -12), S(   9,   9), S( -17,  -8)},
   {S(  33, -13), S(   8, -16), S( -11,  -4), S( -13,  -2),
    S( -25,  -6), S( -22,   4), S(  -6, -14), S( -22,  -1)},
   {S(   8,  -9), S(   7,  -9), S(  11,  -2), S(   1,  11),
    S( -14,  19), S( -23,  31), S(-140,  38), S( -22,  11)}},
  {{S(   0,   0), S(  -4, -25), S(   6, -27), S( -25, -12),
    S( -22,   4), S( -70,  25), S( -59,   6), S( -58,  14)},
   {S(   0,   0), S(  16, -13), S(  10, -10), S(  -7, -10),
    S( -27,  -6), S( -16,  14), S(-101, 123), S( -33,   5)},
   {S(   0,   0), S(  23, -11), S( -10,  -1), S(   9, -20),
    S(  20, -30), S(  -6, -15), S( -60, -26), S(  -3,  -6)},
   {S(   0,   0), S(  -6,   7), S(  -8,  -2), S( -17,  -8),
    S( -32, -17), S( -94,  10), S( -37, -46), S( -35,  -1)},
   {S(   0,   0), S(  11,  -7), S(  10, -11), S(  18, -17),
    S(  -2, -19), S( -41,   6), S(-166,  30), S( -19,  -5)},
   {S(   0,   0), S(   5,  -5), S(  -7,  -7), S( -18,  -9),
    S( -11, -13), S(  10, -36), S( -34,  -2), S( -21,  -3)},
   {S(   0,   0), S(  29, -13), S(  14,  -7), S(  -8,  -2),
    S( -21,   0), S( -22,  -3), S( -37,  24), S( -24,   8)},
   {S(   0,   0), S(  19, -41), S(  13, -25), S( -16, -12),
    S( -27,   3), S( -38,  14), S(-190,  21), S( -31,  -5)}},
};

const int KingStorm[2][FILE_NB/2][RANK_NB] = {
  {{S(  13,  22), S(  90,   9), S(  -7,  14), S( -11,   5),
    S(  -9,  -1), S(  -7,  -6), S( -16,   6), S( -25,   3)},
   {S(  24,  36), S(  83,  18), S(  -9,  20), S(   7,  11),
    S(   0,   7), S(   5,  -2), S(   0,  -3), S( -13,   8)},
   {S(  23,  37), S(  57,  22), S(  -7,  14), S(  -7,   9),
    S(  -5,   8), S(   4,   2), S(   0,   2), S(   7,   7)},
   {S(  13,  24), S(  10,  20), S( -31,  10), S( -25,   3),
    S( -16,   1), S(   2,  -1), S(   8,  -9), S( -14,   4)}},
  {{S(   0,   0), S( -18, -16), S( -12,  -9), S(  15, -13),
    S(   6, -10), S(   4, -15), S(   0,  -6), S(  18,  43)},
   {S(   0,   0), S( -15, -42), S(  15, -25), S(  40, -19),
    S(   8,  -6), S(   6, -13), S(  -9,  -3), S( -16,   5)},
   {S(   0,   0), S( -34, -62), S(   5, -19), S(  12,  -9),
    S(  -4,   3), S(  14, -25), S( -11,  -5), S(  -5, -15)},
   {S(   0,   0), S(  -1, -26), S( -16, -23), S( -13,  -6),
    S( -14,  -1), S(   8,  -9), S(  79, -48), S(  10,  -6)}},
};
...
const int PassedPawn[2][2][RANK_NB] = {
  {{S(   0,   0), S( -15,  12), S( -23,  27), S( -20,  23),
    S(   0,  32), S(  54,  30), S( 153,  93), S(   0,   0)},
   {S(   0,   0), S(   0,   7), S(  -5,  15), S( -13,  25),
    S(   1,  41), S(  66,  44), S( 165, 103), S(   0,   0)}},
  {{S(   0,   0), S( -14,  19), S(  -9,  20), S( -17,  36),
    S(   3,  52), S(  59,  65), S( 249, 139), S(   0,   0)},
   {S(   0,   0), S(  -7,  17), S(  -5,  18), S( -12,  38),
    S(   9,  68), S(  88, 101), S( 364, 183), S(   0,   0)}},
};

const int PassedFriendlyDistance[FILE_NB] = {
    S(   0,   0), S(  -3,  -2), S(   1,  -5), S(   3,  -9),
    S(   4, -13), S(  -6, -12), S( -15,  -7), S(   0,   0),
};

const int PassedEnemyDistance[FILE_NB] = {
    S(   0,   0), S(   3,   1), S(   1,   4), S(   3,  10),
    S(   3,  20), S(   8,  34), S(  25,  35), S(   0,   0),
};

const int PassedSafePromotionPath = S(  -4,  28);

/* Threat Evaluation Terms */

const int ThreatWeakPawn             = S( -12, -45);
const int ThreatMinorAttackedByPawn  = S( -66, -57);
const int ThreatMinorAttackedByMinor = S( -23, -34);
const int ThreatMinorAttackedByMajor = S( -31, -61);
const int ThreatRookAttackedByLesser = S( -57, -37);
const int ThreatMinorAttackedByKing  = S( -59, -30);
const int ThreatRookAttackedByKing   = S(-113, -16);
const int ThreatQueenAttackedByOne   = S( -49, -62);
const int ThreatOverloadedPieces     = S(  -2, -14);
const int ThreatByPawnPush           = S(  18,  20);

/* Space Evaluation Terms */

const int SpaceRestrictPiece = S(  -4,  -1);
const int SpaceRestrictEmpty = S(  -5,   0);
const int SpaceCenterControl = S(   1,   5);

/* Closedness Evaluation Terms */

const int ClosednessKnightAdjustment[9] = {
    S(  11,  20), S(  19,  29), S(  24,  31), S(  29,  34),
    S(  34,  35), S(  38,  36), S(  42,  34), S(  40,  40),
    S(  42,  35),
};

const int ClosednessRookAdjustment[9] = {
    S(  67,  61), S(  35,  67), S(  43,  52), S(  44,  38),
    S(  49,  22), S(  59,   5), S(  57, -16), S(  58, -34),
    S(  45, -69),
};
