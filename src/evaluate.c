...
const int KingDefenders[3] = {
    S( -15,   3), S(   1,  -2), S(  13,   0),
};

const int KingShelter[2][8][8] = {
  {{S( -16,  14), S(   7, -11), S(  16,   0), S(  22,   1), S(   7,   7), S(  30,   4), S(  -1, -32), S( -30,   3)},
   {S(   4,   6), S(  16,  -8), S(  12,  -9), S(  -2, -12), S( -27,   0), S( -65,  79), S( 100,  93), S( -29,   1)},
   {S(  14,  12), S(   9,  -2), S( -19,   0), S(  -7,  -2), S( -22,  -3), S(  14,  -8), S(   4,  65), S( -16,   2)},
   {S(   9,  30), S(  14,   0), S(  -2,  -7), S(  11, -17), S(  13, -36), S( -22, -32), S(-148,  41), S(  -5,  -1)},
   {S( -18,  20), S(  -1,   2), S( -29,   2), S( -12,   4), S( -24, -16), S( -40, -18), S(  39,  -7), S( -12,   0)},
   {S(  24,   4), S(  20,  -6), S( -22,   0), S( -16, -22), S(   5, -32), S(  16, -49), S(  49, -33), S( -16,   0)},
   {S(  21,   4), S(   5, -10), S( -28,  -6), S( -17, -14), S( -24, -21), S( -42,   9), S(   6,  47), S( -21,   8)},
   {S( -18,  -2), S(   3, -10), S(   8,   1), S(  -2,   2), S( -14,  13), S(   3,  32), S(-201,  79), S( -19,  15)}},
  {{S(   0,   0), S(   5, -15), S(   6, -13), S( -45,  19), S(   0,  -9), S(   9,  51), S(-170, -14), S( -50,  11)},
   {S(   0,   0), S(  18,  -7), S(   8,  -6), S(  -5,  -8), S(  10, -32), S(  51, 103), S(-188, -11), S( -44,   5)},
   {S(   0,   0), S(  24,   0), S(   0,  -6), S(  19, -27), S(  13,  -8), S(-113,  45), S( -89, -83), S( -22,  -2)},
   {S(   0,   0), S(  -5,   9), S(  -9,  13), S( -14,   3), S( -23,   0), S(-116,  10), S(   4, -50), S( -28,   0)},
   {S(   0,   0), S(   7,   4), S(   8,  -6), S(  15,  -4), S(   6, -23), S( -44,   7), S(-109, -72), S(  -9,  -4)},
   {S(   0,   0), S(  11,   1), S( -16,   0), S( -12, -14), S(  30, -38), S( -45,   5), S(  59,  47), S( -28,   1)},
   {S(   0,   0), S(  14,  -2), S(   0,   0), S( -26,  -5), S( -23, -13), S(  22,  12), S( -58, -64), S( -40,  16)},
   {S(   0,   0), S(  10, -27), S(  13, -15), S( -22,   0), S( -27,  -3), S(   6, -16), S(-240, -73), S( -41,  17)}},
};
...
int evaluateKings(EvalInfo *ei, Board *board, int colour) {
    ...
    uint64_t myDefenders  = (board->pieces[KNIGHT] & board->colours[US])
    ...
    count = MIN(2, popcount(myDefenders & ei->kingAreas[US]));
