...
const int PawnKingPSQT[2][64][64] = {
  {{S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
    S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
    S(   0,  -1), S(   1,   0), S(   0,   0), S(   0,   0),
    S(   0,   0), S(   0,   0), S(   0,   0), S(  -1,  -1),
   ...
   {S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
    S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
    S(   2,  -2), S(   3,   0), S(   3,   1), S(   2,   1),
    S(  -2,  -1), S(  -1,   0), S(  -2,   0), S(  -3,  -1),
    S(  -1,   1), S(   3,  -1), S(   1,   0), S(   1,   1),
    S(  -1,   0), S(   0,   0), S(  -3,  -1), S(   0,   0),
    S(  -1,  -1), S(   0,   0), S(   0,  -1), S(   2,   0),
    S(   0,   0), S(   0,  -1), S(   0,  -1), S(   1,   0),
    S(  -2,  -2), S(   1,   0), S(   0,   0), S(   3,   0),
    S(  -2,  -1), S(   0,  -1), S(  -3,  -1), S(   0,   0),
   ...
   {S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
    S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
    S(   5,   1), S(   0,   1), S(   2,   0), S(  -1,  -1),
    S(  -1,   0), S(   3,   1), S(  -1,   0), S(  -3,   1),
    S(   2,   2), S(   3,   0), S(   2,   0), S(  -1,   0),
    S(   0,   0), S(  -2,   0), S(   0,   1), S(  -1,   0),
    S(   1,  -1), S(   1,   0), S(  -1,  -1), S(  -1,   0),
    S(   0,  -1), S(   2,   0), S(  -2,  -1), S(   0,   0),
    S(   0,  -1), S(   1,   0), S(  -2,  -1), S(   0,   0),
    S(  -1,  -1), S(  -1,   0), S(  -2,  -1), S(   0,   0),
   ...
   {S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
    S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
    S(   1,   0), S(   1,   1), S(  -3,  -2), S(   1,  -1),
    S(   1,   0), S(   0,   0), S(   3,   1), S(   1,   0),
    S(  -1,   0), S(   1,   1), S(   0,   0), S(   0,   0),
    S(   0,   0), S(   1,   0), S(   0,   1), S(  -1,   0),
   ...
   {S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
    S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
    S(  -4,   0), S(   5,   2), S(   5,   1), S(  -1,   0),
    S(  -1,   0), S(  -3,  -4), S(  10,   1), S(   4,   1),
    S(   2,   0), S(   0,   0), S(   1,   1), S(   0,   0),
    S(   1,  -1), S(  -3,   0), S(   9,   2), S(   0,   0),
    S(   0,   0), S(  -1,  -1), S(   1,  -1), S(  -2,   0),
    S(  -3,  -1), S(   0,   1), S(  -2,   0), S(  -2,   0),
    S(  -1,   0), S(  -2,  -1), S(  -2,   0), S(  -4,  -1),
    S(  -4,   0), S(   1,   0), S(  -2,   0), S(  -3,   0),
    S(   0,   0), S(   0,   0), S(   0,   0), S(  -1,   0),
    S(   0,   0), S(   0,   0), S(  -1,   0), S(   0,   0),
    S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
    S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
   ...
   {S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
    S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
    S(   0,   0), S(   0,   0), S(   0,   0), S(   1,   0),
    S(   1,   0), S(  -1,  -1), S(  -1,   0), S(   0,   0),
    S(  -1,   0), S(   0,   0), S(   0,   0), S(   0,   0),
    S(  -1,  -1), S(   1,   0), S(   0,  -1), S(  -1,   1),
    S(  -1,   0), S(  -1,   0), S(  -1,  -1), S(   0,   0),
    S(  -1,   0), S(  -1,  -1), S(   0,   0), S(   0,  -1),
    S(   0,   0), S(  -1,  -1), S(  -1,  -1), S(  -1,  -1),
    S(  -1,  -1), S(  -1,   0), S(   0,   0), S(   0,   0),
    S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
    S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
    S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
    S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
   ...
   {S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
    S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
    S(  -3,   0), S(  -2,   0), S(  -3,  -1), S(   2,   1),
    S(   1,   3), S(   4,   0), S(   4,  -2), S(   4,  -2),
    S(  -1,   1), S(  -3,  -1), S(   0,  -1), S(  -1,   1),
    S(   4,   3), S(   4,  -1), S(   5,  -3), S(   5,   0),
    S(   0,   0), S(   2,   0), S(   0,  -3), S(  -1,   0),
    S(   1,  -1), S(   0,   1), S(   5,   0), S(   3,  -1),
    S(   1,   2), S(   0,  -1), S(  -1,  -1), S(  -2,  -4),
    S(  -1,  -3), S(   1,   0), S(   2,  -1), S(   1,   0),
    S(   5,   3), S(  -2,  -1), S(  -1,  -1), S(   1,   0),
    S(   0,   0), S(   2,   1), S(  -1,   0), S(   2,   1),
    S(   0,   0), S(   1,   0), S(   0,   0), S(   0,   0),
    S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
    S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
    S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0)},
   {S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
    S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
    S(  -2,  -1), S(  -1,  -1), S(   0,   0), S(   0,   0),
    S(   1,   1), S(  -1,   1), S(  -2,  -1), S(   1,  -1),
    S(   0,  -1), S(  -2,  -2), S(   0,  -1), S(   0,   0),
    S(   1,   1), S(   4,   1), S(  -3,  -1), S(   2,   2),
    S(   0,   0), S(   0,  -1), S(  -1,  -1), S(   1,   0),
    S(   1,  -1), S(   0,  -1), S(   0,  -1), S(  -1,   0),
    S(   1,   1), S(  -1,   0), S(  -2,  -1), S(  -2,  -1),
    S(   0,  -2), S(   1,   0), S(   0,   0), S(   0,   0),
    S(   1,   1), S(   0,   0), S(   0,   0), S(   0,   0),
    S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
    S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
    S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
   ...
   {S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
    ...
    S(  -1,   0), S(   0,   0), S(   0,   0), S(  -1,  -1),
    S(   1,   1), S(   0,  -1), S(   0,   0), S(   0,   0),
    S(   1,   0), S(   0,   0), S(   0,  -1), S(   0,  -1),
   ...
   {S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
    S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
    S(   0,  -1), S(   0,   0), S(   2,   1), S(   0,   1),
    S(   0,   0), S(  -1,  -1), S(  -1,  -1), S(  -1,   0),
    S(   0,   1), S(   1,   0), S(   1,   0), S(   0,   0),
    S(   0,   0), S(   0,   0), S(  -1,  -1), S(   0,  -1),
    S(   0,   0), S(   0,   0), S(   0,   0), S(   1,   0),
   ...
   {S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
    ...
    S(   1,   0), S(   0,  -1), S(   0,   0), S(   0,   0),
    S(   0,   0), S(   0,   0), S(   0,  -1), S(   1,   0),
    S(   0,   0), S(   1,   0), S(   0,   0), S(   0,   0),
    S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
    S(   0,   0), S(   0,   0), S(   0,   0), S(   0,  -1),
    S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
    S(   0,   0), S(   0,  -1), S(  -1,  -1), S(   0,   0),
    S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
    S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
    S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
    S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
   ...
   {S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
    ...
    S(   0,   0), S(  -1,  -3), S(   1,   1), S(   1,   1),
    S(   0,   0), S(   1,   1), S(   1,   1), S(   0,   1),
    S(   1,   0), S(   0,   0), S(   1,   1), S(   0,   0),
    S(   1,   1), S(   0,   0), S(   0,   0), S(   0,   0),
    S(   0,   1), S(   1,   1), S(   0,   0), S(   0,  -1),
    S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
    S(   0,   1), S(   0,   0), S(   0,   0), S(   0,   0),
    S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
    S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
   ...
   {S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
    S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
    S(   0,   0), S(   0,   1), S(   0,   0), S(   0,   0),
    S(   1,   1), S(   0,   0), S(  -2,  -2), S(  -1,   1),
    S(  -1,   0), S(  -1,   0), S(   0,   1), S(   0,   0),
    S(   0,   0), S(   0,   1), S(   0,   0), S(  -1,  -1),
    S(   0,   0), S(   0,   0), S(   0,  -1), S(   0,   0),
    S(  -1,   0), S(   0,   0), S(   0,  -1), S(   0,   0),
    S(   0,   0), S(   0,   0), S(   0,  -1), S(  -1,  -1),
    S(   0,   1), S(   0,   0), S(   0,   1), S(   0,  -1),
    S(   0,   0), S(   0,   0), S(   0,  -1), S(   0,   0),
    S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
    S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
    S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
   ...
   {S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
    S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
    S(  -2,   0), S(  -2,  -2), S(  -3,  -1), S(   0,   0),
    S(   1,   2), S(   4,   2), S(   0,   0), S(   1,   0),
    S(  -1,  -1), S(  -1,  -1), S(  -1,  -1), S(   1,   1),
    S(   0,   1), S(   2,   0), S(   0,   0), S(  -2,   2),
    S(   0,   0), S(   0,  -1), S(   1,  -1), S(  -1,   0),
    S(   1,   0), S(   1,   0), S(  -1,  -1), S(   0,   0),
    S(   0,   0), S(  -1,  -1), S(  -1,  -1), S(   0,  -1),
    S(  -1,  -1), S(   0,   0), S(   0,   0), S(   0,  -1),
    S(   0,   0), S(  -1,  -1), S(   0,  -1), S(   0,  -1),
    S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
    S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
    S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
    S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
   ...
   {S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
    S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
    S(  -3,  -2), S(  -2,  -2), S(  -1,  -1), S(  -2,   0),
    S(  -1,   0), S(   4,   4), S(   3,   2), S(   0,   0),
    S(  -1,  -1), S(  -1,  -2), S(   0,  -1), S(   2,   0),
    S(   2,   2), S(  -1,   0), S(  -3,  -2), S(   2,   2),
    S(   1,  -2), S(   0,  -1), S(   1,  -2), S(   0,  -1),
    S(   1,  -1), S(   4,   0), S(  -1,  -1), S(  -1,   1),
    S(   1,   0), S(   0,  -1), S(  -1,  -1), S(   0,  -1),
    S(   2,   0), S(   0,  -1), S(  -1,   0), S(   0,   0),
    S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
    S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
    S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
    S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
   ...
   {S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
    ...
    S(   0,   0), S(   0,   0), S(   0,   0), S(  -1,   0),
    S(   0,   0), S(   0,   1), S(   0,   0), S(   0,   0),
    S(   0,   0), S(   0,   0), S(  -1,  -2), S(   0,   1),
    S(   0,   1), S(   0,   0), S(   0,   0), S(   0,   0),
    S(   0,   0), S(   0,   2), S(   0,   1), S(   0,  -1),
    S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
    S(   0,   1), S(   0,   0), S(   0,   0), S(   0,   0),
    S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
    S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
   ...
   {S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
    ...
    S(   1,   2), S(  -1,   0), S(   0,   0), S(   0,   1),
    S(   0,  -1), S(   0,   0), S(   0,   0), S(   0,   1),
    S(   0,   0), S(   0,   0), S(  -1,   0), S(   0,   1),
    S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
    S(   0,   0), S(   0,   0), S(  -1,   0), S(  -1,  -1),
    S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
    S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
    S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
    S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
  ...
  {{S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
   ...
   {S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
    S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
    S(   0,   1), S(   0,   0), S(   0,   0), S(   0,   0),
    S(   0,   0), S(   1,   1), S(   2,   1), S(   0,   0),
    S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
    S(   1,   1), S(   0,   0), S(   0,  -1), S(   2,   1),
    S(   0,   1), S(   0,   0), S(   0,   0), S(   0,   0),
    S(   1,   0), S(   0,   0), S(   0,   0), S(   0,  -1),
    S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
    S(  -1,  -1), S(   0,   0), S(   0,   0), S(   0,   0),
    S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
    S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
   ...
   {S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
    S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
    S(   0,   0), S(   2,   1), S(   0,   0), S(   0,   0),
    S(   0,   0), S(   0,   0), S(  -1,   0), S(   1,   0),
    S(   0,   1), S(  -1,   0), S(   1,   0), S(   1,   0),
    S(   0,   0), S(   0,   0), S(   2,   1), S(   0,   1),
    S(  -1,  -1), S(  -1,   0), S(  -1,   0), S(   0,   0),
    S(   0,   1), S(   0,   0), S(   0,   1), S(   0,   1),
    S(   0,  -1), S(   0,   0), S(   0,   0), S(   0,   0),
    S(  -1,  -1), S(  -1,   0), S(  -1,   0), S(   0,   0),
    S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
   ...
   {S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
    ...
    S(  -1,   0), S(  -1,  -1), S(   0,   0), S(   1,   1),
    S(  -1,   0), S(  -1,   0), S(   0,   0), S(  -1,   0),
    S(   0,   0), S(   0,   0), S(  -1,  -1), S(   0,   0),
    S(  -1,   0), S(  -1,   1), S(   0,   0), S(  -1,   0),
    S(   0,   0), S(   0,  -1), S(   0,   0), S(   0,   0),
    S(   0,   1), S(   0,   0), S(   0,   0), S(   0,  -1),
    S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
    S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
   ...
   {S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
    S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
    S(   0,   0), S(   1,   1), S(   0,   0), S(   0,   0),
    S(   0,   0), S(   2,   0), S(   1,   0), S(   0,   0),
    S(   1,   1), S(   0,   0), S(   0,   0), S(   0,   0),
    S(   1,   0), S(   0,   1), S(   0,  -1), S(   1,   0),
    S(   1,   1), S(   0,   0), S(   0,   0), S(   0,   0),
   ...
   {S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
    S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
    S(   1,   1), S(   0,   0), S(   1,   0), S(   0,   0),
    S(   1,   1), S(   3,   0), S(   3,  -1), S(  -2,   0),
    S(   2,   1), S(   3,   1), S(   0,   0), S(   0,   0),
    S(   2,   1), S(   0,   0), S(  -3,   0), S(   2,   0),
    S(   1,   2), S(   0,   1), S(   0,   0), S(   0,   1),
    S(  -2,   0), S(  -1,   1), S(  -1,  -1), S(   1,   1),
    S(  -1,   1), S(  -1,   0), S(   0,   0), S(  -2,  -2),
    S(   2,   2), S(  -1,  -1), S(  -1,  -1), S(  -1,  -2),
    S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
    S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
    S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
    S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
   ...
   {S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
    S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
    S(   0,   1), S(   1,   1), S(  -1,   0), S(   0,   0),
    S(  -2,   1), S(   2,   2), S(   4,   0), S(  -1,   0),
    S(   1,   1), S(   1,   1), S(   0,   0), S(  -3,   0),
    S(   2,   2), S(   2,   0), S(  -3,   0), S(   0,   0),
    S(   0,   1), S(  -1,   0), S(   0,   1), S(  -1,   0),
    S(  -2,  -1), S(   0,   0), S(   0,  -1), S(   1,   0),
    S(   0,   0), S(   0,   0), S(  -2,  -1), S(  -3,  -1),
    S(  -2,  -2), S(   0,   0), S(  -1,  -1), S(  -1,  -1),
    S(   0,   0), S(  -1,  -1), S(  -1,   0), S(   0,   0),
    S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
    S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
    S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
    S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
   ...
   {S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
    S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
    S(  -2,  -1), S(   1,   1), S(   2,   2), S(  -2,   0),
    S(   1,   1), S(  -2,   0), S(   1,   0), S(   3,   0),
    S(  -3,   1), S(  -2,   0), S(   1,   0), S(   1,   1),
    S(  -1,   0), S(   2,   0), S(   2,   1), S(   2,   1),
    S(  -1,  -1), S(  -1,  -1), S(   2,   1), S(   1,   0),
    S(   1,   0), S(  -1,   0), S(   0,   1), S(   0,   2),
    S(  -1,  -2), S(  -2,  -1), S(   0,  -1), S(   1,  -1),
    S(  -1,   0), S(  -1,   0), S(  -1,   0), S(   0,   1),
    S(   0,   1), S(   0,   0), S(   0,   0), S(   0,   0),
    S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
    S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
    S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
   ...
   {S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
    S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
    S(  -4,  -1), S(  -3,  -1), S(  -3,  -1), S(   3,   1),
    S(   2,   1), S(   0,   0), S(   2,   0), S(   5,   0),
    S(  -4,   0), S(  -2,   0), S(  -1,   0), S(   2,   0),
    S(   1,   1), S(   1,   0), S(   3,   1), S(   0,   1),
    S(   0,  -2), S(   3,   0), S(  -2,  -1), S(   2,   1),
    S(   1,   0), S(   2,   0), S(  -1,   0), S(   1,   1),
    S(  -1,  -1), S(   4,   1), S(  -1,  -1), S(   2,   1),
   ...
   {S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
    S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
    S(  -1,   0), S(   0,   1), S(   1,   0), S(   4,   1),
    S(   2,   0), S(  -3,   0), S(  -2,   0), S(  -3,   1),
    S(  -1,   0), S(  -2,   0), S(   1,   0), S(   1,   1),
    S(   2,   1), S(   1,   0), S(   3,   1), S(  -1,  -1),
    S(  -1,   0), S(   0,   0), S(   0,  -1), S(   2,   1),
    S(  -1,   0), S(   2,   1), S(   2,   0), S(   0,  -1),
   ...
   {S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
    S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
    S(   3,   0), S(   4,   0), S(   2,  -1), S(   1,   1),
    S(  -1,   3), S(   4,   2), S(  -1,   1), S(  -1,  -2),
    S(   3,   2), S(   4,   0), S(   5,  -1), S(   0,   0),
    S(   2,   2), S(   1,   1), S(   0,  -1), S(  -1,   1),
    S(   3,   3), S(   2,   2), S(   3,  -3), S(   0,  -1),
    S(   2,  -1), S(   4,   1), S(  -1,  -3), S(  -1,  -1),
    S(   1,   3), S(   0,   1), S(   0,   2), S(  -2,  -2),
    S(   0,  -2), S(   2,  -1), S(  -4,  -3), S(  -2,  -2),
    S(   3,   3), S(  -1,   0), S(   0,   0), S(   0,   0),
    S(   1,   0), S(   2,   1), S(  -1,   0), S(   2,   2),
    S(   0,   1), S(   0,   0), S(   0,   0), S(   0,   0),
    S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
    S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
    S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0)},
   {S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
    S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
    S(   0,  -1), S(   1,  -1), S(   1,   0), S(  -1,   0),
    S(  -1,   0), S(   0,   2), S(   1,   0), S(   2,  -1),
    S(   2,   0), S(   2,   0), S(  -1,   0), S(  -2,   0),
    S(   1,   1), S(   0,   0), S(   0,   0), S(   0,   0),
    S(   0,   0), S(  -2,   0), S(   1,   0), S(  -3,  -1),
    S(  -2,  -1), S(   2,   0), S(   0,  -1), S(  -1,  -1),
    S(  -1,   0), S(  -1,   0), S(  -2,  -1), S(  -1,  -1),
    S(  -2,  -2), S(   0,  -1), S(   1,   0), S(  -3,  -1),
    S(   0,   0), S(  -1,   0), S(   0,   0), S(   0,   0),
    S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
    S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
    S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
...
int evaluatePawns(EvalInfo *ei, Board *board, int colour) {
    ...
    while (tempPawns) {
        ...
        pkeval += PawnKingPSQT[0][ourKing  ][relativeSquare(US, sq)];
        pkeval += PawnKingPSQT[1][theirKing][relativeSquare(US, sq)];

        if (TRACE) T.PawnKingPSQT[0][ourKing  ][relativeSquare(US, sq)][US]++;
        if (TRACE) T.PawnKingPSQT[1][theirKing][relativeSquare(US, sq)][US]++;
    }
