...
const int QueenMobility[28] = {
    S( -43,-236), S(-156,-351), S( -34,-184), S( -27,-171),
    S(  -8,-118), S( -20, -62), S( -12, -81), S( -15, -68),
    S(  -8, -54), S(  -7, -45), S(  -1, -25), S(   0, -24),
    S(  -2, -14), S(   1,  -6), S(   0,  -1), S(   0,   2),
    S(   4,  14), S(   0,  11), S(   8,  18), S(   0,  18),
    S(   0,  16), S(  13,  19), S(   3,   0), S(  22,   4),
    S(  24,  11), S(  40,  -5), S( -36, -15), S(   0,   0),
};
