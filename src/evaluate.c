...
const int KingShelter[2][4][8] = {
  {{S( -27,  12), S(   0,  -6), S(  17,  14), S(   2,  16), S( -13,  -8), S( -33, -13), S(  38,  -7), S( -47,   5)},
   {S(  25,   8), S(   6, -17), S( -30,  -7), S(  -9, -24), S(   0, -33), S(  15, -48), S(  49, -33), S( -39, -16)},
   {S(  42,  21), S(  21,   7), S( -33,   1), S(  -9, -22), S(   1, -14), S( -37,  10), S(   7,  47), S( -47,   0)},
   {S( -11,  26), S( -13,  10), S( -53,   3), S(  23,  -5), S(  35,  11), S(   4,  32), S(-199,  79), S( -20,   0)}},
  {{S(   0,   0), S(  -3, -19), S(   4, -17), S(  18,  -7), S(   8, -23), S( -45,   7), S(-108, -72), S( -23, -17)},
   {S(   0,   0), S(  46,  13), S(  28,   7), S(  -5,  -8), S(  12, -36), S( -43,   5), S(  58,  46), S( -66,  -3)},
   {S(   0,   0), S(   7,  17), S( -14,   1), S( -12,  -4), S( -17, -11), S(  22,  11), S( -56, -62), S( -54,   6)},
   {S(   0,   0), S( -34,  11), S( -22,  -2), S(  29,  -4), S(  13,  -2), S(   7, -15), S(-238, -72), S( -39, -14)}},
};
