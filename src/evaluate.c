...
const int KingShelter[2][4][RANK_NB] = {
  {{S( -33,  12), S(  -6, -12), S(  -5,   0), S(  -8,   9), S( -29, -10), S( -28, -13), S(  38,  -8), S( -21,  10)},
   {S(  28,  10), S(   7, -13), S( -37,  -4), S( -15, -27), S(  -2, -35), S(  16, -48), S(  49, -34), S(  -9,   1)},
   {S(  21,  23), S(  22,  -5), S( -36,   0), S( -16, -24), S( -13, -22), S( -40,   6), S(   7,  47), S( -15,   5)},
   {S( -12,  19), S(  -4,  11), S( -19,  11), S(   9,  -6), S(   4,   0), S(   0,  30), S(-200,  78), S(  -6,  12)}},
  {{S(   0,   0), S(   0, -19), S(  18, -14), S(   8, -10), S(   6, -25), S( -45,   7), S(-109, -73), S(  -8,  11)},
   {S(   0,   0), S(  29,  -5), S(   6,  -4), S( -28, -11), S(   8, -40), S( -41,   6), S(  58,  46), S( -29,  11)},
   {S(   0,   0), S(  -5,  14), S( -24,   6), S( -21,  -8), S( -19, -14), S(  22,  11), S( -58, -64), S( -24,   7)},
   {S(   0,   0), S(  -5,  -2), S(   1,  -6), S(   3,  -2), S( -11,  -9), S(   5, -18), S(-239, -74), S( -31,   5)}},
};
