...
const int PawnBackwards[2] = { S(  -1,  -7), S( -16, -17) };

const int PawnConnected32[32] = {
    S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
    S(   1,  -5), S(  12,   5), S(   2,   2), S(   4,  17),
    S(  16,   3), S(  29,   1), S(  13,   9), S(  19,  17),
    S(   4,   2), S(  21,   7), S(  17,   8), S(  20,  18),
    S(   6,  12), S(  22,  16), S(  26,  25), S(  42,  20),
    S(  24,  53), S(  24,  64), S(  64,  61), S(  50,  73),
    S( 104, -13), S( 197,  15), S( 227,  20), S( 248,  73),
    S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
};
