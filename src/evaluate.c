...
const int QueenMobility[28] = {
    S( -54,-263), S(-195,-390), S( -43,-205), S( -34,-190),
    S( -11,-132), S( -25, -69), S( -15, -90), S( -19, -76),
    S( -10, -61), S(  -9, -51), S(  -2, -28), S(  -1, -27),
    S(  -3, -16), S(   2,  -7), S(   1,  -2), S(   0,   3),
    S(   5,  16), S(   0,  13), S(  10,  21), S(   0,  20),
    S(   0,  18), S(  17,  22), S(   4,  -1), S(  28,   5),
    S(  30,  13), S(  50,  -6), S( -45, -17), S(   0,   0),
};
...
const int Tempo[COLOUR_NB] = { S(  20,  20), S( -20, -20) };
