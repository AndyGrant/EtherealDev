...
const int KnightMobility[9] = {
    S( -91, -86), S( -34, -94), S( -11, -40), S(  19, -13),
    S(  40,  -9), S(  49,   9), S(  59,   5), S(  75,   5),
    S(  84, -39),
};
...
const int BishopMobility[14] = {
    S( -63,-128), S( -58, -69), S(  -8, -48), S(   9, -19),
    S(  34, -15), S(  50,   2), S(  54,  14), S(  58,  15),
    S(  58,  18), S(  58,  13), S(  47,  11), S(  51, -12),
    S(  47,  -3), S(  40, -34),
};
...
const int RookMobility[15] = {
    S(-148,-107), S( -89,-122), S( -31, -73), S(  -3, -26),
    S(  -3,  -2), S(   1,  16), S(   8,  28), S(  16,  41),
    S(  26,  45), S(  29,  57), S(  37,  61), S(  48,  71),
    S(  40,  68), S(  39,  62), S(  28,  65),
};

/* Queen Evaluation Terms */

const int QueenMobility[28] = {
    S( -61,-263), S(-217,-390), S( -48,-205), S( -42,-190),
    S( -27,-132), S( -50, -69), S( -30, -91), S( -32, -75),
    S( -18, -64), S( -11, -56), S(  -2, -32), S(   1, -27),
    S(   1, -15), S(  16,  -6), S(  16,   2), S(  14,   9),
    S(  29,  26), S(  17,  22), S(  27,  30), S(   9,  25),
    S(   6,  23), S(  26,  29), S(   6,   0), S(  34,   7),
    S(  35,  14), S(  58,  -4), S( -50, -18), S(   0,  -1),
};
