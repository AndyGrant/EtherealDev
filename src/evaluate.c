...
const int PawnValue   = S(  94, 122);
const int KnightValue = S( 433, 409);
const int BishopValue = S( 449, 421);
const int RookValue   = S( 633, 680);
const int QueenValue  = S(1275,1352);
...
const int PawnPSQT32[32] = {
    ...
    S( -23,   2), S( -15,   2), S( -10,  -7), S(  -5, -14),
    S( -18,   9), S( -14,  10), S(   7, -13), S(   7, -25),
    S(  -9,  11), S(  -5,   7), S(  -8,  -7), S(  -1, -22),
    S(  -7,  24), S(  -6,  20), S(   0,  10), S(  26, -17),
    S( -18, -48), S( -67, -17), S(   0, -32), S(  37, -47),
    S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
};

const int KnightPSQT32[32] = {
    S( -48, -26), S(  -6, -32), S( -11, -27), S(   1, -17),
    S(  -1, -21), S(   4, -12), S(   4, -28), S(   9, -18),
    S(   8, -24), S(  20, -23), S(  13, -18), S(  22,  -6),
    S(  20,   3), S(  20,   6), S(  28,  13), S(  26,  21),
    S(  23,  16), S(  24,   9), S(  35,  23), S(  27,  34),
    S( -14,  15), S(   6,  12), S(  30,  24), S(  27,  26),
    S(   9, -11), S(  -7,   1), S(  31, -20), S(  41,  -1),
...
const int QueenPSQT32[32] = {
    ...
    S(  13, -39), S(  25, -57), S(  26, -69), S(  16, -27),
    S(   9, -24), S(  22, -22), S(   6,   0), S(   7,  -4),
    S(  10,  -8), S(  11,  13), S(  -2,  15), S( -15,  55),
...
const int PawnConnected32[32] = {
    ...
    S(  10,   9), S(  19,  15), S(  26,  21), S(  26,  20),
    S(  52,  22), S(  45,  45), S(  63,  52), S(  79,  55),
...
const int KnightMobility[9] = {
    S( -73,-104), S( -33, -96), S( -21, -41), S( -11, -18),
    S(  -2,  -8), S(   2,   7), S(   9,  11), S(  17,  11),
    S(  27,  -2),
};
...
const int BishopMobility[14] = {
    S( -63,-146), S( -33, -92), S( -18, -51), S( -10, -27),
    S(  -1, -16), S(   5,  -4), S(   7,   5), S(   8,  10),
    S(   7,  15), S(  10,  16), S(  11,  15), S(  31,   4),
    S(  39,  14), S(  68, -18),
};
...
const int RookMobility[15] = {
    S(-147,-113), S( -52,-111), S( -21, -56), S( -14, -19),
    S( -14,  -1), S( -15,  13), S( -14,  23), S(  -8,  26),
    S(  -2,  29), S(   0,  33), S(   3,  38), S(   7,  41),
    S(   8,  45), S(  21,  34), S(  75,  -5),
};
...
const int KingStorm[2][FILE_NB/2][RANK_NB] = {
  {{S(  -5,  28), S( 111, -10), S( -23,  24), S( -16,   6),
    S( -14,   2), S(  -9,  -3), S( -17,   6), S( -22,   3)},
   {S(  -4,  49), S(  54,  12), S( -16,  21), S(  -3,   8),
    S(  -4,   4), S(   3,  -4), S(  -3,   2), S( -11,   5)},
   {S(   7,  38), S(  14,  24), S( -20,  18), S( -10,   6),
    S(   1,   1), S(   4,   0), S(   7,  -6), S(   2,   3)},
   {S(  -2,  26), S(  12,  18), S( -17,   8), S( -13,   0),
    S( -11,   0), S(   6, -11), S(   1,  -8), S( -10,   4)}},
  {{S(   0,   0), S( -16, -16), S( -12,  -3), S(  17, -16),
    S(   7,  -5), S(   2, -18), S(  -3,  -1), S(  18,  29)},
...
const int PassedPawn[2][2][RANK_NB] = {
  {{S(   0,   0), S( -36,   4), S( -50,  24), S( -73,  32),
   ...
   {S(   0,   0), S( -29,   9), S( -47,  30), S( -66,  37),
    S(  -9,  34), S(  91,  26), S( 183,  94), S(   0,   0)}},
  {{S(   0,   0), S( -24,  18), S( -47,  29), S( -68,  43),
    S(  -1,  39), S(  87,  38), S( 258, 108), S(   0,   0)},
...
const int ClosednessKnightAdjustment[9] = {
    S( -16, -10), S( -15,   5), S( -16,  13), S( -12,  13),
    S( -11,  18), S(  -8,  14), S(  -5,  11), S( -15,  26),
    S( -14,  15),
};
