...
int evaluateScaleFactor(Board *board) {
    ...
    balance = popcount(white & pawns) - popcount(black & pawns);
    balance = MAX(0, MIN(3, abs(balance)));
    ...
    return (balance * SCALE_NORMAL + factor * (3 - balance)) / 3;
