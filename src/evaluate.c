...
const int KingShelter[2][FILE_NB][RANK_NB][PHASE_NB] = {
  {{{  -6,  15}, {   7,  15}, {  14,  15}, {   5,  15}, {  15,  15}, { -14,  15}, {  25,  15}, { -14,  15}},
   {{  -1,   2}, {   7,   2}, {  20,   2}, {   0,   2}, {   3,   2}, { -13,  15}, { -13,   2}, { -13,   2}},
   {{   5,   0}, {   2,   0}, {  -5,   1}, {   0,   0}, {  10,   0}, {  42,   0}, {  -5,   0}, {  -5,   0}},
   {{  10,  11}, {   8,  -1}, {   0,  -2}, {  11,  -2}, {   3,  -2}, {   0,  -2}, {   0,   7}, {   0,  -2}},
   {{   0,  12}, {   1,   4}, {  -8,   1}, {  -8,  -2}, {  -8,  -2}, {  -8,  -2}, {  14,  -2}, {  -8,  -2}},
   {{   5,   0}, {   9,   3}, {   0,   0}, {  -4,  -0}, {  12,  -0}, {   4,   0}, {  15,  10}, {  -9,   0}},
   {{   2,  -1}, {   0,  -7}, {  -8,  -5}, {  -8,  -7}, { -16, -18}, { -16,  -6}, {  35,   6}, { -16,   6}},
   {{  -9,  -8}, {   0,  10}, {   3,  10}, {   1,  10}, { -12,  10}, {  -8,  24}, {   1,  26}, { -12,  10}}},
  {{{   0,   0}, { -12,   8}, {   0,   8}, { -23,   7}, {  -8,  44}, { -25, 100}, {  51,   8}, { -25,   8}},
   {{   0,   0}, {  11,   4}, {  15,   5}, {  -5,   5}, {   6,   5}, { -21,   5}, { -21,   5}, { -21,   5}},
   {{   0,   0}, {  11,   0}, {   4,   0}, {  18,   0}, {  16,   1}, {  -6,   0}, {  -6,   0}, {  -6,   0}},
   {{   0,   0}, {   7,   3}, {   1,  14}, { -11, -10}, { -11,  -7}, {   0,  -5}, { -11,   8}, { -11,  -5}},
   {{   0,   0}, {   2,  10}, {  10,   2}, {   7,  -8}, {  -1,  -1}, {  -1,  -1}, {  -1,  12}, {  -1,  -5}},
   {{   0,   0}, {   0,   2}, {  -3,   0}, {  -8,  -8}, {   3,  -9}, { -13,  -5}, { -13,  65}, { -13,   0}},
   {{   0,   0}, {   5,   0}, {   1,   2}, {  -1,  -3}, { -14,  -8}, {  -5,  16}, {  13, -26}, { -26,   5}},
   {{   0,   0}, {   0,   6}, {   4,   6}, { -26,   6}, { -16,  19}, { -10,   6}, { -24,   6}, { -24,   6}}}
};
