...
const int PawnStacked = S(  -3, -32);
const int PawnBackwards[2] = {
    S(   8,  -4), S( -14, -13),
};
const int PawnConnected32[32] = {
    S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0),
    S(   4, -17), S(  15,   1), S(   5,  -3), S(   3,  20),
    S(  12,   1), S(  28,   2), S(  16,   9), S(  21,  21),
    S(   6,   1), S(  16,   4), S(  13,   6), S(  19,  17),
    S(   6,  11), S(  19,  20), S(  20,  24), S(  38,  23),
...
const int KnightMobility[9] = {
    S( -91, -86), S( -36, -94), S( -21, -43), S(  -2, -14),
    S(  13, -14), S(  25,   3), S(  36,   1), S(  50,  -1),
    S(  59, -43),
};
const int BishopPair = S(  54,  72);
const int BishopRammedPawns = S( -11,  -7);
const int BishopOutpost[2] = {
    S(  31,   3), S(  40,   0),
};
const int BishopMobility[14] = {
    S( -59,-128), S( -53, -67), S( -27, -47), S( -11, -22),
    S(   9, -12), S(  24,   0), S(  30,   9), S(  35,   7),
    S(  35,  12), S(  40,   6), S(  39,   6), S(  47, -14),
    S(  46,  -3), S(  40, -35),
};
...
const int RookMobility[15] = {
    S(-147,-107), S( -75,-120), S( -26, -69), S( -14, -27),
    S( -11,  -4), S(  -8,  12), S(  -6,  22), S(   2,  31),
    S(  11,  36), S(  15,  40), S(  18,  47), S(  25,  53),
    S(  24,  54), S(  28,  49), S(  21,  49),
};
const int QueenMobility[28] = {
    S( -61,-263), S(-217,-390), S( -48,-205), S( -36,-190),
    S( -13,-132), S( -31, -69), S( -17, -91), S( -24, -76),
    S( -15, -61), S( -12, -52), S(  -5, -29), S(  -2, -27),
    S(  -4, -16), S(   5,  -8), S(   5,  -2), S(   0,   3),
    S(   9,  17), S(   2,  15), S(  14,  23), S(   0,  19),
...
const int KingDefenders[12] = {
    S( -33,  -4), S( -13,   9), S(   1,   1), S(  11,   0),
    S(  22,  -7), S(  31,   2), S(  30,  11), S(  23,   0),
    S(  12,   6), S(  12,   6), S(  12,   6), S(  12,   6),
};

const int KingShelter[2][FILE_NB][RANK_NB] = {
  {{S( -16,  15), S(   7, -11), S(  17,   1), S(  23,   1), S(   8,   6), S(  31,   3), S(  -1, -33), S( -31,   2)},
   {S(   4,   6), S(  16,  -8), S(  11, -10), S(  -2, -13), S( -27,   0), S( -66,  78), S( 100,  93), S( -29,   0)},
   {S(  12,  13), S(   8,  -2), S( -20,   0), S(  -7,  -2), S( -22,  -3), S(  14,  -9), S(   4,  64), S( -16,   3)},
   {S(   9,  31), S(  10,   0), S(  -9,  -8), S(  22, -16), S(  17, -36), S( -22, -32), S(-147,  41), S(  -1,   2)},
   {S( -18,  20), S(  -1,   4), S( -33,   1), S( -12,   5), S( -25, -17), S( -41, -19), S(  38,  -8), S( -15,   2)},
   {S(  26,   8), S(  24,  -6), S( -25,   0), S(  -6, -22), S(   6, -32), S(  17, -49), S(  50, -33), S( -11,   0)},
   {S(  22,   5), S(  -2, -11), S( -33,  -9), S( -17, -14), S( -24, -21), S( -43,   9), S(   7,  47), S( -25,   7)},
   {S( -18,  -2), S(   0, -13), S(  11,   1), S(   3,   2), S( -12,  13), S(   4,  33), S(-201,  79), S( -17,  16)}},
  {{S(   0,   0), S(   4, -16), S(   6, -14), S( -46,  18), S(   0, -10), S(   9,  51), S(-171, -15), S( -51,  10)},
   {S(   0,   0), S(  18,  -7), S(   8,  -7), S(  -4,  -8), S(  11, -33), S(  52, 103), S(-188, -11), S( -44,   4)},
   {S(   0,   0), S(  25,   0), S(   0,  -6), S(  19, -27), S(  14,  -8), S(-113,  44), S( -90, -84), S( -22,  -1)},
   {S(   0,   0), S(  -6,   9), S( -11,  13), S( -14,   3), S( -24,   0), S(-117,   9), S(   4, -50), S( -28,   2)},
   {S(   0,   0), S(   0,   5), S(   9,  -7), S(  25,  -4), S(   9, -23), S( -45,   7), S(-109, -73), S(  -6,  -1)},
   {S(   0,   0), S(   6,   1), S( -18,   0), S( -12, -14), S(  29, -38), S( -44,   5), S(  59,  47), S( -27,   3)},
   {S(   0,   0), S(  18,  -2), S(   2,   0), S( -22,  -5), S( -21, -13), S(  22,  12), S( -58, -64), S( -40,  15)},
   {S(   0,   0), S(   5, -30), S(   9, -16), S( -22,   0), S( -27,  -3), S(   6, -17), S(-240, -74), S( -43,  15)}},
};
...
const int PassedPawn[2][2][RANK_NB] = {
  {{S(   0,   0), S( -30, -26), S( -24,   7), S( -15,  -2), S(  20,   0), S(  59,  -4), S( 147,  33), S(   0,   0)},
   {S(   0,   0), S(   0,   2), S( -18,  24), S( -10,  38), S(   6,  46), S(  66,  63), S( 191, 133), S(   0,   0)}},
  {{S(   0,   0), S(  -5,  15), S( -12,  10), S(  -3,  29), S(  32,  35), S(  78,  66), S( 234, 152), S(   0,   0)},
   {S(   0,   0), S(  -5,  13), S(  -8,  22), S( -15,  59), S(  -3, 114), S(  40, 211), S( 125, 377), S(   0,   0)}},
};
