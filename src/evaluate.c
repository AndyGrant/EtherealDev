...
const int KingSafetyThreatWeight[PIECE_NB] = { 12, 11, 8, 7, 9, 0 };

const int KingSafetyBaseLine = 16;

const int KingSafetyWeakSquares = 8;

const int KingSafetyFriendlyPawns = -5;

const int KingSafetyNoEnemyQueens = -43;
