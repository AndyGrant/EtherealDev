...
const int PassedPawn[2][2][8] = {
  {{S(   0,   0), S( -29, -26), S( -25,   6), S( -16,  -3), S(  27,   1), S(  64,  -2), S( 147,  33), S(   0,   0)},
   {S(   0,   0), S(   3,   7), S( -13,  32), S(  -2,  56), S(  16,  62), S(  72,  72), S( 192, 136), S(   0,   0)}},
  {{S(   0,   0), S(  -9,  17), S( -16,  12), S(  -3,  34), S(  49,  42), S(  92,  72), S( 240, 157), S(   0,   0)},
   {S(   0,   0), S(   5,  34), S(   0,  43), S(  -7,  84), S(   9, 135), S(  43, 207), S( 125, 378), S(   0,   0)}},
};
