...
const int MaterialSynergy[5][5] = {
   ...
   {S(   0,   4), S(  -3,  -4), S(   0,   0), S(   0,   0), S(   0,   0)},
   {S(  -1,   2), S(  -4,   0), S(   0,  -1), S(   0,   0), S(   0,   0)},
   {S(  -3,   6), S(  -1,   1), S(  -1,   0), S(  -1, -10), S(   0,   0)},
   {S(  -3,   0), S(  -3,   0), S(  -4,  -2), S(  -7,  -9), S(  -3,  -1)},
};

const int MaterialImbalance[5][5] = {
   {S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0)},
   {S(  -1,   3), S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0)},
   {S(   0,   5), S(   0,  -4), S(   0,   0), S(   0,   0), S(   0,   0)},
   {S(   0,   6), S(   1,   3), S(  -1,   1), S(   0,   0), S(   0,   0)},
   {S(  -5,  16), S(   2,   1), S(   3,   4), S(  -4,   5), S(   0,   0)},
};
