...
const int KnightMobility[9] = {
    S( -60,-147), S( -31, -86), S( -25, -40),
    S( -19, -23), S(  -7, -18), S(   0,  -8),
    S(   7,  -3), S(  18,  -2), S(  28, -58),
};
...
const int BishopMobility[14] = {
    S( -39, -68), S( -39, -50), S( -21, -48), S( -12, -28),
    S(   0, -15), S(   8,  -6), S(  12,   1), S(  17,  -1),
    S(  21,   9), S(  27,   0), S(  29,   0), S(   9, -22),
    S(  47, -11), S(-267, -97),
};
...
const int RookMobility[15] = {
    S(-141, -83), S( -23, -59), S(  -9, -40), S(  -6, -41),
    S( -11, -20), S(  -7,  -9), S(  -2,  -5), S(   4,   0),
    S(  12,   9), S(  20,  18), S(  28,  16), S(  38,  20),
    S(  41,  21), S(  53,   5), S(  51, -23),
};
...
const int QueenMobility[28] = {
    S( -78, -48), S( -29,-135), S( -39,-106), S( -28, -87),
    S( -16, -87), S( -22, -43), S( -18, -36), S( -13, -24),
    S(  -7, -18), S(  -2, -16), S(   3, -10), S(   8,  -6),
    S(  10,   0), S(  15,   4), S(  17,   5), S(  18,   3),
    S(  22,   1), S(  21,  -2), S(  23,  -6), S(  29, -19),
    S(  15, -21), S(  30, -27), S(  25, -25), S(   2, -31),
    S(  -8, -27), S( -22, -32), S(  17, -17), S( -55, -37),
};
...
void initializeEvalInfo(EvalInfo* ei, Board* board, PawnKingTable* pktable){
    ...
    b = (white & pawns) & (ei->blockedPawns[WHITE] | RANK_2 | RANK_3);
    ei->mobilityAreas[WHITE] = ~(b | (white & (queens | kings)) | ei->pawnAttacks[BLACK]);

    b = (black & pawns) & (ei->blockedPawns[BLACK] | RANK_7 | RANK_6);
    ei->mobilityAreas[BLACK] = ~(b | (black & (queens | kings)) | ei->pawnAttacks[WHITE]);
