...
const int KingShelter[2][8] = {
   {S(  -2,   3), S(  11,   0), S(   0,   1), S(   8,   0), S(   4,  10), S( -19,  37), S(   7,  42), S(   0,   0)},
   {S( -23,   0), S(   3,   0), S(   6,  -2), S(   8,  -2), S(   1,   7), S( -12,  30), S(   7,  37), S(   0,   0)},
};
const int KingStorm[2][2][8] = {
  {{S(   7,   2), S( -92, 109), S( -47,  47), S( -13,  17), S(   5,   9), S(   9,  -2), S(  -2,   4), S(   0,   0)},
   {S( -11,   0), S(  36, 108), S( -30,  73), S(   0,  24), S(   3,  10), S(  11,  -3), S(  -6,   0), S(   0,   0)}},
  {{S(   0,   0), S(   0,   0), S( -13, -28), S(   8,  -1), S(  15,  -8), S(  10, -17), S(  21, -23), S(   0,   0)},
   {S(   0,   0), S(   0,   0), S( -16, -91), S(  15, -17), S(  12, -16), S(  10, -26), S(  16, -24), S(   0,   0)}},
};
