...
const int KingShelter[2][FILE_NB/2][RANK_NB] = {
  {{S( -16,  -6), S(   3, -19), S(   5,  -3), S(  -5,   5),
    S( -12,   6), S( -26,  15), S(  30, -16), S( -23,  10)},
   {S(  22, -13), S(  16, -24), S( -12, -10), S( -16, -11),
    S( -21, -20), S(  11, -16), S(  42, -27), S( -15,  -3)},
   {S(  37,  -6), S(  21, -12), S( -26,   6), S( -15, -13),
    S(  -4, -14), S( -26,  23), S(   0,  42), S( -27,   5)},
   {S( -16,  18), S(  12,   0), S(  -8,   0), S(   8,  -7),
    S(  12, -13), S( -39,  22), S(-188,  86), S(  -4,   5)}},
  {{S(   0,   0), S(  10, -25), S(  14, -16), S( -15,  -1),
    S(   5,  -9), S( -49,  21), S(-104, -61), S( -22,   9)},
   {S(   0,   0), S(  32, -14), S(  17, -12), S(  -3,  -9),
    S( -18,  -5), S( -25,  10), S(  52,  36), S( -29,   8)},
   {S(   0,   0), S(  12,  -6), S( -22,   0), S(  -5, -15),
    S( -11,   0), S(  -8,  11), S( -55, -49), S( -31,  -1)},
   {S(   0,   0), S(   4,  -3), S(   3, -11), S(   7, -17),
    S(   2, -15), S( -14,  10), S(-226, -53), S( -11, -13)}},
};

const int KingStorm[2][FILE_NB/2][RANK_NB] = {
  {{S(   0,  20), S( 117, -11), S( -27,  25), S( -22,  11),
    S( -14,   4), S(  -9,   0), S( -21,  10), S( -23,   0)},
   {S(  -1,  47), S(  60,  10), S( -19,  24), S(  -8,  12),
    S(  -5,   5), S(   2,  -3), S(  -2,   0), S( -17,   1)},
   {S(  11,  38), S(  20,  24), S( -22,  21), S(  -8,  10),
    S(   9,   1), S(  12,  -1), S(  13,  -8), S(   9,  -1)},
   {S(  -1,  24), S(  16,  20), S( -12,   6), S( -12,   0),
    S(  -5,  -1), S(  12, -15), S(   8, -16), S( -10,   1)}},
  {{S(   0,   0), S( -13, -15), S( -13,  -2), S(  20, -17),
    S(  10,  -5), S(  -2, -10), S(  10,  11), S(  10,  27)},
   {S(   0,   0), S( -14, -32), S( -10, -11), S(  28, -13),
    S(  -4,  -2), S(   3, -12), S(  -1,  -3), S( -20,   1)},
   {S(   0,   0), S( -26, -46), S( -29,  -6), S(  14, -11),
    S(   8,  -2), S(  -1, -19), S(   0, -19), S( -10,   5)},
   {S(   0,   0), S(  -1, -16), S( -15, -19), S(  -7,  -5),
    S(   2, -10), S(  13, -42), S(  59, -11), S(  17,  21)}},
};
