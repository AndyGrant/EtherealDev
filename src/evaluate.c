...
const int KnightMobility[9] = {
    S(  -9,  -1), S( -38, -19), S( -19, -24), S(  -4, -16),
    S(   5, -13), S(  10,   0), S(  21,  -1), S(  33,  -3),
    S(  46, -22),
};
...
const int BishopMobility[14] = {
    S( -16,  -5), S( -47, -19), S( -19, -32), S(  -6, -19),
    S(   7, -14), S(  17,  -4), S(  22,   2), S(  25,   2),
    S(  29,   8), S(  35,   0), S(  31,   9), S(  20,  -5),
    S(   4,   2), S(   1,  -7),
};
...
const int RookMobility[15] = {
    S(  -7,  -1), S( -55, -14), S(  -8, -38), S(   1, -24),
    S(   3, -13), S(   4,  -1), S(   5,   9), S(   9,  15),
    S(  15,  15), S(  20,  21), S(  24,  24), S(  25,  31),
    S(  28,  34), S(  29,  32), S(  15,  37),
};
...
const int QueenMobility[28] = {
    S(   0,   0), S(   0,   0), S(  -2,   0), S( -18,  -1),
    S( -16,  -2), S( -18,  -4), S( -10,  -7), S( -11,  -6),
    S(  -6, -18), S(  -4, -15), S(   0, -12), S(   1,  -5),
    S(   3,  -2), S(   6,   3), S(   6,   8), S(   8,   6),
    S(  11,  13), S(   9,  10), S(  12,   8), S(   9,   5),
    S(   6,   3), S(   9,   7), S(   1,  -2), S(   0,  -1),
    S(   0,  -2), S(   1,   0), S(   0,  -1), S(   0,   0),
};
