...
const int KnightMobility[9] = {
    S( -93, -86), S( -48, -96), S( -40, -51), S( -30, -21),
    S( -18, -18), S( -10, -10), S(   0,  -3), S(  13, -12),
    S(  34, -54),
};
...
const int BishopMobility[14] = {
    S( -62,-128), S( -44, -68), S( -30, -51), S( -16, -31),
    S(   0, -25), S(   9,  -5), S(  13,   2), S(  16,   4),
    S(  12,  12), S(  18,   3), S(  26,   3), S(  39, -24),
    S(  45,  -4), S(  37, -48),
};
...
const int RookMobility[15] = {
    S(-147,-107), S( -73,-120), S( -22, -68), S( -10, -27),
    S(  -6,  -7), S(  -8,  12), S(  -7,  27), S(   0,  30),
    S(   5,  37), S(  14,  44), S(  14,  51), S(  20,  60),
    S(  26,  60), S(  29,  48), S(  24,  26),
};

/* Queen Evaluation Terms */

const int QueenMobility[28] = {
    S( -61,-263), S(-217,-390), S( -48,-204), S( -36,-190),
    S( -38,-132), S( -29, -69), S( -21, -91), S( -20, -76),
    S( -16, -63), S( -10, -52), S(  -8, -30), S(  -2, -26),
    S(   0, -15), S(   4,  -9), S(   3,  -3), S(   2,   6),
    S(   3,  15), S(  -3,  12), S(   5,  21), S(  -5,  18),
    S(  -1,  18), S(  19,  21), S(   5,   0), S(  31,   3),
    S(  34,  12), S(  57,  -6), S( -50, -18), S(   0,  -1),
};
