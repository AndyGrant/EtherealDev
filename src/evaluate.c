...
const int KingShelter[2][FILE_NB/2][RANK_NB] = {
  {{S( -26,  13), S(  -3,  -3), S( -13,   0), S(  -8,  11),
    S( -22, -12), S( -31, -15), S(  38,  -8), S( -25,   7)},
   {S(  14,   3), S(  16, -10), S( -16,   0), S(  -9, -16),
    S(   1, -32), S(  16, -48), S(  49, -34), S( -18,   0)},
   {S(  29,   4), S(  12, -10), S( -35,  -1), S( -19, -16),
    S( -15, -24), S( -39,   9), S(   6,  46), S( -26,   5)},
   {S( -21,   6), S(   6,  -4), S(  -2,   3), S(   9,  -2),
    S(   3,   6), S(   1,  29), S(-200,  79), S( -14,   6)}},
  {{S(   0,   0), S(  -5,  -3), S(   5,  -9), S(  13,  -4),
    S(   8, -21), S( -44,   8), S(-108, -72), S( -11,   5)},
   {S(   0,   0), S(  22,  -5), S(   6, -10), S( -12,  -3),
    S(   9, -30), S( -42,   5), S(  58,  46), S( -35,   7)},
   {S(   0,   0), S(  13,  -1), S(  -8,   1), S( -14,  -6),
    S( -12, -10), S(  23,  11), S( -57, -63), S( -45,  12)},
   {S(   0,   0), S(   8, -16), S(   3, -11), S( -11,  -8),
    S( -19,  -6), S(   7, -16), S(-240, -73), S( -46,   5)}},
};

const int KingStorm[2][FILE_NB/2][RANK_NB] = {
  {{S(   2,   7), S(  38,  24), S(  -1,  15), S( -16,   4),
    S(  -8,   0), S( -11,  -1), S( -13,   0), S( -13,   0)},
   {S(   5,  30), S(  14,  18), S(  -5,   4), S(  -7,   0),
    S(   0,   0), S(   5,  -7), S(  -1,   2), S( -12,   4)},
   {S(   3,  20), S(   5,  24), S(  -9,   4), S( -16,   0),
    S(   6,  -3), S(   6,  -4), S(   6,  -8), S(   5,   3)},
   {S(   6,  20), S(   8,  26), S(  -4,  -6), S( -19, -10),
    S(  -6,  -3), S(   9, -15), S(   9, -10), S( -14,   6)}},
  {{S(   0,   0), S(   0,   0), S(  -3, -17), S(  19, -17),
    S(   1,   1), S(  -2,  -5), S(   5,   3), S(   0,   0)},
   {S(   0,   0), S(   0,   0), S(  -4, -18), S(  29,  -8),
    S(   0,   0), S(  -4,   2), S(   0,   1), S(  -2,   0)},
   {S(   0,   0), S(  -1,  -1), S(  -9, -17), S(   0,  -3),
    S(  -2,   4), S( -18,  -5), S(  -1,  -1), S(   0,   0)},
   {S(   0,   0), S(   0,   0), S(  -6, -19), S(  -3,  -3),
    S(  -5,  -8), S(   8, -18), S(  18,   0), S(   0,   1)}},
};
