...
const int QueenMobility[28] = {
    S( -43,-263), S(-156,-390), S( -34,-205), S( -27,-190),
    S(  -8,-132), S( -20, -69), S( -12, -90), S( -15, -76),
    S(  -8, -61), S(  -7, -51), S(  -1, -28), S(   0, -27),
    S(  -2, -16), S(   1,  -7), S(   0,  -2), S(   0,   3),
    S(   4,  16), S(   0,  13), S(   8,  21), S(   0,  20),
    S(   0,  18), S(  13,  22), S(   3,  -1), S(  22,   5),
    S(  24,  13), S(  40,  -6), S( -36, -17), S(   0,   0),
};
