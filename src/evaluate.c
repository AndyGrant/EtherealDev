...
const int KingStorm[2][FILE_NB][RANK_NB] = {
  {{S(   5,  -7), S(   1,  -3), S(  -1,   0), S( -12,   0), S(  13,   8), S(  -5,   7), S( -13,  14), S(   0,   3)},
   {S(  -1,  -1), S(   1,  -3), S(   0,   0), S(   2,  10), S(  14,   8), S( -16, -23), S(-132,   2), S(  -3,   0)},
   {S(   3,  -3), S(   3,  -1), S(   1,   1), S(   1,   6), S(   9,   6), S(  14,   2), S(  35,  10), S(   2,   0)},
   {S( -10,  -4), S(  -2,   0), S(  -2,   0), S(   1,   2), S(   1,   4), S( -16,  18), S(  47,   6), S(   0,   0)},
   {S(  -3,   0), S(   0,   0), S(   0,   4), S(   0,   1), S(   2,  11), S(   1,   7), S(  32,  15), S(   1,   1)},
   {S(   0,  -1), S(   1,   0), S(  -1,   1), S(  -1,   2), S(   6,   5), S(  23,  10), S(   3,  -6), S(  -1,   0)},
   {S(  -4,  -2), S(   1,   0), S(   1,   1), S(  -2,   2), S(   7,   9), S(   1,   9), S(  17,  -2), S(  -1,   0)},
   {S(   0,  -3), S(   0,  -3), S(  -1,   0), S(  -3,   0), S(   2,  -1), S( -17,  -2), S(  34,  39), S(   0,   1)}},
  {{S(-121,-118), S(  -3,   4), S(   6,  -6), S(  16,  -1), S(  -7,  -8), S(   1, -24), S(   0,   0), S(   0,   0)},
   {S(-128,-185), S( -33, -20), S(  16,  -7), S(   2,  -5), S(  -3,  -3), S(   5, -44), S(   0,   0), S(   0,   0)},
   {S(  39, -82), S(  -1, -10), S(  13,  -5), S(  10,  -1), S(  -2,  -2), S( -14,  12), S(   0,   0), S(   0,   0)},
   {S(-113,   8), S( -17, -11), S(  -4,  -4), S(  -3,  -4), S(  -2,   1), S(  35,  23), S(   0,   0), S(   0,   0)},
   {S(-207,-169), S(  -7, -12), S(   0,  -2), S(   2,  -1), S(   5,  10), S(  61,   1), S(   0,   0), S(   0,   0)},
   {S( -39,  -8), S( -15, -16), S(  -4,  -3), S( -11,   4), S( -22,  -1), S( -14,   0), S(   0,   0), S(   0,   0)},
   {S( -74,  22), S( -10, -13), S(  18,  -1), S(   1,   2), S(  -2,   3), S(  -1,  -3), S(   0,   0), S(   0,   0)},
   {S(-146, -58), S(  -5,  -7), S(   6,  -3), S(  13,  -1), S(   0,  -1), S(   1,   7), S(   0,   0), S(   0,   0)}},
};
