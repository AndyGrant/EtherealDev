...
const int PawnValue[PHASE_NB] = {  100,  100};
...
const int KnightValue[PHASE_NB] = {  300,  300};
...
const int BishopValue[PHASE_NB] = {  300,  300};
...
const int RookValue[PHASE_NB] = {  500,  500};
...
const int QueenValue[PHASE_NB] = {  900,  900};
