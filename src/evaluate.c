...
const int KingSafetyThreatWeight[PIECE_NB] = { 5, 12, 9, 10, 10, 0 };

const int KingSafetyBaseLine = 22;

const int KingSafetyWeakSquares = 12;

const int KingSafetyFriendlyPawns = -11;

const int KingSafetyNoEnemyQueens = -71;
