...
const int KingShelter[2][FILE_NB / 2][RANK_NB] = {
  {{S( -16,   0), S(  -3,  -4), S(   2,   1), S(   3,   4), S(  -4,  11), S(  13,  14), S(-114,  25), S( -10,   6)},
   {S(   6,   4), S(   2,  -5), S( -20,  -2), S( -14,  -7), S( -21,  -7), S( -16,  17), S(  31,  35), S( -11,   0)},
   {S(   9,   8), S(  13,   0), S( -19,   2), S(  -5,  -8), S(   2,  -9), S(   3,  -8), S(   0,   8), S(  -8,   0)},
   {S( -15,  16), S(   6,   2), S(  -6,  -1), S(  12,  -5), S(   7, -16), S(  -6,  -7), S( -56,  16), S(  -1,   0)}},
  {{S(   0,   0), S(   1,  -9), S(   5,  -6), S(  -9,   1), S( -11,   0), S(   4,  13), S(-140, -48), S( -12,   5)},
   {S(   0,   0), S(   9,   0), S(  -5,   0), S( -21,  -1), S( -19,  -2), S(   6,  29), S(   7, -54), S( -28,   4)},
   {S(   0,   0), S(   4,   5), S( -19,   1), S(   0,  -9), S(  15, -16), S( -36,   5), S(  27,  11), S( -19,   0)},
   {S(   0,   0), S(   1,   7), S(   5,   0), S(  15,   1), S(   5, -10), S(   6, -11), S( -62, -23), S(  -2,  -3)}},
};
