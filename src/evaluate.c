...
const int KingShelter[2][FILE_NB/2][RANK_NB] = {
  {{S( -24,   3), S(   4,  -5), S(  11,   2), S(   0,   8),
    S(  -4,   0), S(   0,  13), S(  -8,   1), S( -28,  12)},
   {S(  15,   4), S(  21,  -6), S(  -1,   1), S( -12,   4),
    S( -19,  -7), S(  -7,   9), S(   0,   3), S( -16,   3)},
   {S(  29,   3), S(  20,   1), S( -20,  17), S(  -3,  -9),
    S(  17, -29), S(  -1,  -9), S(  -4,   1), S( -16,   8)},
   {S(  -1,  15), S(  22,   0), S(   5,  -5), S(  26, -15),
    S(  34, -30), S(  -7, -21), S(  -8,  -5), S(   6,  -1)}},
  {{S(   0,   0), S(   9, -10), S(  13, -12), S( -26,   5),
    S( -10,  11), S(   7,  13), S(   0,   2), S( -28,  16)},
   {S(   0,   0), S(  28,   1), S(  17,   2), S(  -7,   6),
    S( -20,  11), S(  -4,   3), S( -18,  -3), S( -39,  13)},
   {S(   0,   0), S(  18,   2), S(  -7,   5), S(  10, -10),
    S(  22,  -4), S(   2, -10), S(   2,  -4), S( -37,   7)},
   {S(   0,   0), S(  17,   7), S(  20,   0), S(  26,  -8),
    S(  24, -24), S( -14, -12), S(  -9,  -4), S(   0,  -5)}},
};

const int KingStorm[2][FILE_NB/2][RANK_NB] = {
  {{S(   2,   8), S(  36,  23), S(  -5,  10), S( -13,   4),
    S(  -5,   0), S(  -6,  -1), S( -13,   3), S(  -7,   2)},
   {S(   5,  29), S(  14,  20), S(  -5,   6), S(  -6,   0),
    S(   0,   0), S(   7,  -9), S(   0,   2), S(  -8,   7)},
   {S(   3,  20), S(   4,  22), S( -11,   5), S( -17,   0),
    S(   0,  -4), S(   2,  -4), S(   2,  -5), S(   0,   4)},
   {S(   5,  17), S(   7,  21), S(  -5,  -4), S( -16,  -8),
    S( -12,  -5), S(   6, -12), S(   1,  -4), S( -16,   4)}},
  {{S(   0,   0), S(   0,   0), S(   7, -15), S(  20, -16),
    S(   8,   0), S(  -1,  -6), S(  -6,   0), S(   0,   1)},
   {S(   0,   0), S(   0,   0), S(  -1, -21), S(  25, -10),
    S(  -1,   0), S(   0,   0), S(   0,   0), S(  -2,   0)},
   {S(   0,   0), S(  -1,  -1), S(  -7, -19), S(  -3,  -6),
    S(  -4,   4), S( -20,  -4), S(  -4,  -1), S(   0,   0)},
   {S(   0,   0), S(   0,   0), S(  -8, -21), S(  -6,  -5),
    S(  -5,  -5), S(   3, -11), S(  17,   1), S(   0,   0)}},
};
