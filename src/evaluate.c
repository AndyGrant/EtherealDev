...
const int PawnValue[PHASE_NB] = {  150,  150};
...
const int KnightValue[PHASE_NB] = { 450, 450};
...
const int BishopValue[PHASE_NB] = { 450, 450};
...
const int RookValue[PHASE_NB] = { 750, 750};
...
const int QueenValue[PHASE_NB] = { 1350, 1350};
