...
const int KingShelter[2][FILE_NB/2][RANK_NB][PHASE_NB] = {
  {{{   3,  -2}, {   2,  -8}, {   0,  -1}, {   0,   3}, {   5,   0}, {  -1,  -8}, { -63,  -7}, { -18,   6}},
   {{  26,  -3}, {  10,  -6}, {  -7,   2}, {  -6,   1}, {  -6,  -9}, { -14,  -2}, {-106,  33}, { -18,   5}},
   {{  21,   0}, {   8,  -3}, {  -6,   3}, {  -4,  -4}, {  -4, -15}, {   7, -20}, { -19,  -6}, { -17,   2}},
   {{   1,  11}, {   8,  -1}, {  -4,  -1}, {   9,  -4}, {   1, -16}, {  -9, -11}, { -41,  -1}, {  -3,   2}}},
  {{{   0,   0}, {  19, -13}, {   9,  -5}, {  -6,   0}, {  -6,  -4}, { -15,  -5}, { -84,   9}, { -20,   9}},
   {{   0,   0}, {   8,  -5}, {   0,  -3}, {  -8,  -2}, { -17,   0}, { -39,   1}, { -66, -28}, { -24,   5}},
   {{   0,   0}, {  10,   2}, {  -2,   5}, {   4,  -3}, {   8, -15}, { -57,   8}, { -57, -19}, { -15,   1}},
   {{   0,   0}, {   5,   5}, {  13,   0}, {   8,  -8}, {   6, -15}, {  -7, -19}, { -52,  16}, {  -6,   0}}},
};
...
void evaluateKings(EvalInfo* ei, Board* board, int colour){
    ...
    for (file = MAX(0, kingFile - 1); file <= MIN(7, kingFile + 1); file++){
        ...
        ei->midgame[colour] += KingShelter[file == kingFile][square32(file)][distance][MG];
        ei->endgame[colour] += KingShelter[file == kingFile][square32(file)][distance][EG];
