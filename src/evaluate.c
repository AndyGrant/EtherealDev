...
const int PassedPawn[2][2][RANK_NB] = {
  {{S(   0,   0), S( -17, -14), S(  -7,  -8), S(  -1,  -9), S(  37, -10), S(  72, -12), S( 159,  67), S(   0,   0)},
   {S(   0,   0), S(   1,   8), S(   3,   9), S(   5,  19), S(  34,  12), S(  78,  27), S( 174,  90), S(   0,   0)}},
  {{S(   0,   0), S(  10,   7), S(   5,  -5), S(   9,   4), S(  35,  25), S(  89,  35), S( 206,  52), S(   0,   0)},
   {S(   0,   0), S(  12,  17), S(  14,  20), S(  15,  52), S(  37, 101), S( 101, 174), S( 210, 270), S(   0,   0)}},
};
