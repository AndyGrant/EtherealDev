...
const int KingShelter[2][FILE_NB/2][RANK_NB] = {
  {{S( -24,  10), S( -21,  -5), S(  -9,  11), S(  -5,   8),
    S( -22, -13), S( -37, -16), S(  37,  -8), S( -26,  14)},
   {S(  15,   7), S(   2,  -9), S( -17,   0), S(  -7, -22),
    S(  -1, -33), S(  15, -49), S(  48, -34), S( -31,  -2)},
   {S(  31,  10), S(  14,   3), S( -26,   0), S(  -7, -19),
    S( -10, -20), S( -40,   9), S(   7,  45), S( -26,  -3)},
   {S( -12,   9), S(   4,   0), S( -26,   1), S(  22,  -2),
    S(  15,  10), S(   2,  31), S(-199,  79), S(  -1, -12)}},
  {{S(   0,   0), S(  -5,  -4), S(   2,  -8), S(  14,  -6),
    S(   7, -23), S( -45,   6), S(-107, -71), S(  -9,   9)},
   {S(   0,   0), S(  11,  10), S(  11,   1), S(  -8, -12),
    S(   5, -40), S( -43,   5), S(  57,  45), S( -45,   5)},
   {S(   0,   0), S(   6,   4), S( -15,  -2), S( -17,  -6),
    S( -19, -13), S(  21,  10), S( -56, -62), S( -44,   3)},
   {S(   0,   0), S(  -3,  -7), S(  -9,  -6), S(  14,   0),
    S(   1,  -2), S(   5, -17), S(-238, -72), S( -17, -18)}},
};
