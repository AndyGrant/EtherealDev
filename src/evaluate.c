...
const int PieceValues[8][PHASE_NB] = {
    { 107, 134}, { 456, 408}, { 477, 423}, { 670, 712},
...
const int PawnConnected32[32] = {
    ...
    S(  -1,  -9), S(  11,   1), S(   4,   0), S(   4,  19),
    S(  15,   0), S(  33,  -1), S(  22,   9), S(  26,  18),
    S(  10,   0), S(  22,   4), S(  10,  11), S(  15,  23),
    S(  16,   7), S(  24,  14), S(  30,  20), S(  34,  21),
    S(  57,  26), S(  53,  46), S(  68,  54), S(  82,  59),
...
const int RookMobility[15] = {
    ...
    S(  -7,  -1), S(  -7,  13), S(  -6,  24), S(   0,  28),
    S(   6,  32), S(   9,  37), S(  12,  43), S(  15,  49),
    S(  15,  53), S(  22,  47), S(  71,  13),
};

const int QueenMobility[28] = {
    S( -61,-263), S(-212,-388), S( -60,-203), S( -27,-193),
    S( -15,-142), S( -11, -91), S(  -5, -64), S(  -6, -37),
...
const int KingDefenders[12] = {
    S( -17,  -2), S( -10,   0), S(  -1,   2), S(   7,   4),
    S(  16,   5), S(  26,   1), S(  32,   0), S(  15,   0),
    S(  12,   6), S(  12,   6), S(  12,   6), S(  12,   6),
};

const int KingShelter[2][8][8] = {
  {{S( -13,   5), S(  16, -24), S(  19,  -8), S(   9,   2), S(   4,   3), S(   8,   2), S(  -2, -32), S( -49,  19)},
   {S(  17,  -6), S(  21, -18), S(  -1,  -6), S( -17,   2), S( -30,  13), S( -69,  70), S(  94,  85), S( -29,   3)},
   {S(  32,   0), S(  16,  -9), S( -26,   5), S( -11, -10), S( -23,  -4), S(  -7,  -2), S(   0,  66), S( -14,   0)},
   {S(   4,  14), S(  19,  -8), S(   2, -10), S(  14, -24), S(  23, -35), S( -50,   1), S(-138,  51), S(   3,  -5)},
   {S( -12,   9), S(   0,  -2), S( -26,   0), S( -18,   0), S( -20, -10), S( -38,   0), S(  35, -15), S(  -6,  -2)},
   {S(  44, -13), S(  25, -18), S( -22,   0), S( -12, -20), S(   4, -25), S(  18, -24), S(  43, -29), S( -26,   1)},
   {S(  25,  -9), S(   1, -18), S( -23,  -5), S( -19, -13), S( -29, -10), S( -34,  31), S(   0,  44), S( -12,   4)},
   {S( -10,  -8), S(   6, -18), S(   8,  -2), S(  -2,   6), S( -12,  13), S(  -9,  38), S(-190,  87), S( -19,  17)}},
  {{S(   0,   0), S(  -9, -23), S(   0, -18), S( -43,  17), S( -18,  -1), S(   4,  44), S(-168, -10), S( -45,  13)},
   {S(   0,   0), S(  25, -19), S(   6,  -8), S( -20,  -5), S(   1, -16), S(  29,  72), S(-185,  -5), S( -42,   7)},
   {S(   0,   0), S(  34, -10), S(  -1,  -6), S(   8, -19), S(  13,  -8), S( -92,  49), S( -86, -76), S( -23,  -3)},
   {S(   0,   0), S(   0,   9), S(  -1,   1), S( -16,  -1), S( -26,   1), S(-102,  29), S(   7, -43), S( -22,  -5)},
   {S(   0,   0), S(  11,   2), S(  11,  -5), S(  13, -12), S(  13, -24), S( -54,  15), S(-106, -64), S(  -1,  -7)},
   {S(   0,   0), S(   8,  -6), S( -20,   0), S( -27, -10), S(  19, -27), S( -40,   2), S(  57,  40), S( -20,  -3)},
   {S(   0,   0), S(  24, -12), S(  11, -12), S( -10, -10), S( -28,   5), S(  -8,  15), S( -56, -52), S( -36,  14)},
...
const int KingStorm[2][4][8] = {
  {{S(   2,  21), S( 113, -12), S( -28,  24), S( -22,  10), S( -13,   3), S(  -8,  -2), S( -19,   7), S( -22,  -2)},
   {S(   1,  44), S(  56,   9), S( -17,  24), S(  -4,  13), S(  -3,   5), S(   5,  -3), S(   0,   0), S( -13,   0)},
   {S(  12,  35), S(  20,  18), S( -22,  20), S( -13,  10), S(   3,   1), S(   6,   0), S(   8,  -7), S(   1,  -1)},
   {S(   1,  24), S(  21,  18), S( -11,   7), S( -14,   3), S( -13,   0), S(   6, -11), S(   0,  -7), S( -15,   1)}},
  {{S(   0,   0), S( -11, -13), S( -16,  -1), S(  20, -16), S(  11,  -6), S(   0, -17), S(  -8,   0), S(  16,  27)},
   ...
   {S(   0,   0), S(  -1, -14), S( -19, -18), S( -11,  -4), S(  -4,  -6), S(   6, -30), S(  66,  -6), S(  12,  18)}},
};
...
const int PassedPawn[2][2][RANK_NB] = {
  {{S(   0,   0), S( -38,   0), S( -52,  23), S( -82,  26), S(  -6,  16), S(  66,   1), S( 153,  59), S(   0,   0)},
   {S(   0,   0), S( -26,   2), S( -46,  23), S( -71,  27), S( -13,  29), S(  83,  28), S( 184,  95), S(   0,   0)}},
  {{S(   0,   0), S( -27,  10), S( -47,  17), S( -73,  33), S(  -1,  34), S(  90,  39), S( 258, 127), S(   0,   0)},
   {S(   0,   0), S( -28,   6), S( -40,  14), S( -66,  37), S(  -5,  60), S(  74, 144), S( 154, 301), S(   0,   0)}},
};
