...
const int KingStorm[2][4][8] = {
  {{S(   2,   6), S(  33,  22), S(  -5,  10), S( -14,   4),
    S(  -3,  -1), S(  -8,  -3), S( -12,   3), S(  -1,   6)},
   {S(   5,  25), S(  12,  20), S(  -6,   5), S(  -4,  -1),
    S(  -3,  -2), S(  -1,  -9), S(   1,   1), S(   0,  16)},
   {S(   3,  17), S(   3,  20), S( -11,   4), S( -17,   1),
    S(   0,  -5), S(   0,  -6), S(  -4,  -3), S(   8,   3)},
   {S(   5,  16), S(   6,  20), S(  -5,  -5), S( -18,  -8),
    S( -15,  -6), S(   8, -10), S(  -1,  -4), S( -12,  -3)}},
  {{S(   0,   0), S(   0,   0), S(   7, -12), S(  21, -13),
    S(   6,   0), S(  -2,  -6), S(  -7,   0), S(   0,   1)},
   {S(   0,   0), S(   0,   0), S(   0, -19), S(  29,  -8),
    S(   0,   1), S(  -4,   0), S(  -1,   0), S(  -2,   0)},
   {S(   0,   0), S(  -1,  -1), S(  -7, -20), S(  -3,  -3),
    S(  -8,   4), S( -19,  -4), S(  -4,  -2), S(   0,   0)},
   {S(   0,   0), S(   0,   0), S(  -6, -18), S(  -8,  -3),
    S(  -8,  -5), S(  13,  -9), S(  15,   1), S(   1,   1)}},
};
