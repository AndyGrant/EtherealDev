...
const int KnightMobility[9] = {
    S( -90, -86), S( -35, -94), S( -19, -42), S(  -4, -15),
    S(   2, -15), S(   8,   0), S(  18,  -2), S(  31,  -5),
    S(  49, -42),
};
...
const int BishopMobility[14] = {
    S( -59,-128), S( -47, -67), S( -18, -46), S(  -6, -21),
    S(   6,  -9), S(  17,   0), S(  21,   6), S(  24,   3),
    S(  26,   8), S(  33,   3), S(  35,   3), S(  45, -14),
    S(  45,  -4), S(  40, -34),
};
...
const int RookMobility[15] = {
    S(-147,-107), S( -71,-119), S( -16, -68), S(  -9, -26),
    S(  -9,  -3), S(  -9,  13), S(  -7,  24), S(  -2,  31),
    S(   1,  34), S(   6,  36), S(   9,  42), S(  17,  47),
...
const int QueenMobility[28] = {
    S( -61,-263), S(-216,-389), S( -48,-204), S( -36,-189),
    S( -14,-132), S( -25, -69), S( -14, -91), S( -18, -75),
    S( -11, -61), S(  -9, -51), S(  -6, -29), S(  -4, -26),
    S(  -5, -15), S(   0,  -8), S(   0,  -3), S(  -2,   3),
    S(   4,  15), S(   0,  13), S(  11,  21), S(   0,  19),
    S(   0,  19), S(  19,  22), S(   5,   0), S(  31,   4),
