...
const int PassedPawn[2][2][RANK_NB] = {
  {{S(   0,   0), S( -30, -25), S( -20,  10), S( -10,  15), S(  20,  20), S(  60,  30), S( 150,  45), S(   0,   0)},
   {S(   0,   0), S( -30, -25), S( -15,  20), S(   0,  35), S(  30,  45), S(  65,  65), S( 190, 130), S(   0,   0)}},
  {{S(   0,   0), S( -10,  15), S( -10,  10), S(   5,  25), S(  25,  35), S(  75,  70), S( 225, 150), S(   0,   0)},
   {S(   0,   0), S( -10,  10), S( -10,  20), S(  10,  40), S(  30,  70), S(  80, 100), S( 250, 300), S(   0,   0)}},
};
