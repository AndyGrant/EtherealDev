...
const int PawnCandidatePasser[2][8] = {
   {S(   0,   0), S( -27, -10), S( -11,   9), S( -15,  28), S(  -1,  60), S(  44,  66), S(   0,   0), S(   0,   0)},
   {S(   0,   0), S( -14,  17), S(  -5,  20), S(   4,  43), S(  17,  82), S(  32,  54), S(   0,   0), S(   0,   0)},
};
...
const int KingShelter[2][8][8] = {
  {{S( -11,   3), S(  15, -26), S(  20,  -9), S(  12,   4), S(   6,   4), S(   1,   2), S(  -3, -33), S( -49,  18)},
   {S(  17,  -8), S(  20, -18), S(   1,  -5), S( -14,   4), S( -30,  15), S( -70,  68), S(  92,  82), S( -25,   1)},
   {S(  35,  -4), S(  14,  -9), S( -28,   7), S( -11,  -8), S( -20,  -4), S( -11,   1), S(   0,  66), S( -12,  -2)},
   {S(   4,  11), S(  21, -11), S(   4, -11), S(  15, -22), S(  25, -36), S( -58,   5), S(-136,  52), S(   5,  -7)},
   {S( -15,   7), S(   4,  -4), S( -26,   1), S( -18,   5), S( -20,  -6), S( -41,  -1), S(  33, -17), S(  -6,  -2)},
   {S(  46, -18), S(  22, -17), S( -21,   2), S( -12, -18), S(   5, -24), S(  17, -21), S(  41, -30), S( -24,   1)},
   {S(  25, -13), S(  -1, -16), S( -23,  -2), S( -19,  -8), S( -30,  -7), S( -36,  32), S(   0,  44), S( -10,   1)},
   {S(  -9, -12), S(   6, -19), S(   7,   0), S(  -2,  11), S( -11,  15), S(  -9,  37), S(-190,  87), S( -17,  14)}},
  {{S(   0,   0), S( -11, -23), S(   4, -18), S( -40,  16), S( -22,   2), S(   3,  42), S(-167,  -8), S( -46,   7)},
   {S(   0,   0), S(  24, -21), S(   7,  -7), S( -18,  -1), S(  -1, -12), S(  26,  66), S(-184,  -3), S( -39,   3)},
   {S(   0,   0), S(  30, -11), S(  -2,  -7), S(   7, -17), S(  15,  -7), S( -87,  47), S( -84, -73), S( -20,  -5)},
   {S(   0,   0), S(  -3,   9), S(  -2,   0), S( -17,   2), S( -27,   1), S( -99,  31), S(   7, -41), S( -22,  -7)},
   {S(   0,   0), S(  12,   2), S(  11,  -5), S(  14, -11), S(  14, -26), S( -57,  15), S(-104, -61), S(  -1,  -7)},
   {S(   0,   0), S(   6,  -8), S( -20,   0), S( -27,  -6), S(  17, -24), S( -38,   3), S(  55,  38), S( -18,  -6)},
   {S(   0,   0), S(  22, -15), S(  11, -13), S(  -9,  -7), S( -27,   9), S(  -9,  15), S( -56, -49), S( -31,  11)},
   {S(   0,   0), S(  12, -38), S(  19, -27), S( -18,  -4), S( -17,  18), S(  -5,  20), S(-228, -55), S( -22,   1)}},
};

const int KingStorm[2][4][8] = {
  {{S(  -4,  28), S( 117,  -8), S( -25,  26), S( -19,   8), S( -14,   2), S(  -8,  -4), S( -17,   5), S( -22,  -2)},
   {S(  -3,  49), S(  57,  12), S( -19,  24), S(  -5,  11), S(  -4,   5), S(   5,  -4), S(  -1,   0), S( -11,   0)},
   {S(   8,  38), S(  17,  23), S( -23,  21), S( -11,   9), S(   3,   2), S(   7,   0), S(   9,  -7), S(   3,  -1)},
   {S(  -2,  25), S(  16,  21), S( -17,   9), S( -14,   2), S( -13,   2), S(   7, -11), S(   1,  -8), S( -13,   2)}},
  {{S(   0,   0), S( -15, -16), S( -17,  -1), S(  18, -17), S(   9,  -7), S(   3, -18), S(  -3,  -1), S(  17,  29)},
   {S(   0,   0), S( -16, -34), S(  -3,  -8), S(  35, -12), S(  -1,  -2), S(  13, -23), S(  -7, -10), S( -17,   2)},
   {S(   0,   0), S( -28, -49), S( -27,  -6), S(  11, -11), S(   3,  -2), S(  -8, -14), S( -13, -15), S( -11,   6)},
   {S(   0,   0), S(  -2, -18), S( -16, -18), S( -12,  -4), S(  -4,  -7), S(   4, -26), S(  72, -11), S(  13,  20)}},
};
...
const int PassedPawn[2][2][8] = {
  {{S(   0,   0), S( -38,   3), S( -55,  21), S( -82,  27), S(  -6,  12), S(  70,  -5), S( 157,  56), S(   0,   0)},
   {S(   0,   0), S( -29,   7), S( -51,  24), S( -73,  30), S( -13,  31), S(  89,  32), S( 182, 101), S(   0,   0)}},
  {{S(   0,   0), S( -24,  16), S( -50,  19), S( -73,  33), S(  -3,  36), S(  89,  40), S( 263, 114), S(   0,   0)},
   {S(   0,   0), S( -29,  12), S( -45,  17), S( -67,  38), S(  -1,  52), S(  92, 117), S( 161, 275), S(   0,   0)}},
};
