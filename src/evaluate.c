...
const int PawnConnected32[32][PHASE_NB] = {
    ...
    {   6,   0}, {  20,   0}, {  14,   8}, {  17,  23},
    {   5,   0}, {  16,   2}, {  16,   7}, {  18,  17},
    {   5,  13}, {  18,  18}, {  18,  22}, {  37,  23},
    {  26,  57}, {  31,  71}, {  79,  63}, {  75,  82},
    { 206,  41}, { 200,  61}, { 189,  64}, { 250,  96},
    {   0,   0}, {   0,   0}, {   0,   0}, {   0,   0},
};
...
const int PassedPawn32[32][PHASE_NB] = {
    ...
    {   0,   2}, {  -2,   4}, {  -8,   2}, {   0,   0},
    {  10,  10}, {   0,  10}, {  -6,   3}, {  -3,   1},
    {  14,  21}, {  12,  16}, {   5,  11}, {   5,   6},
    {  29,  38}, {  28,  35}, {  15,  25}, {  22,  22},
    {  45,  51}, {  30,  47}, {  39,  42}, {  48,  40},
    {   0,   0}, {   0,   0}, {   0,   0}, {   0,   0},
};
...
const int PassedPawnConnected32[32][PHASE_NB] = {
    ...
    {   8,   0}, {  -7,  -3}, {  -2,   1}, {   6,  -2},
    {  10,   7}, {  -4,   3}, {   2,   5}, {   8,   6},
    {  26,  18}, {  16,  15}, {  16,  11}, {   8,   9},
    {   0,  25}, {  14,  25}, {   1,  15}, {  -2,   6},
    { -24,   1}, {  32,  35}, {  11,  27}, {  69,   0},
    {   0,   0}, {   0,   0}, {   0,   0}, {   0,   0},
};

const int PassedPawnCanAdvance[2][RANK_NB][PHASE_NB] = {
   {{   0,   0}, {  -4,   0}, {   0,   4}, {  -2,   3}, {   0,   2}, {  -2,  -3}, {   9,  12}, {   0,   0}},
   {{   0,   0}, {   0,   2}, {  -2,   2}, {   1,   7}, {  11,  17}, {  33,  41}, {  62,  62}, {   0,   0}}
};

const int PassedPawnSafeAdvance[2][RANK_NB][PHASE_NB] = {
   {{   0,   0}, {  -4,   2}, {  -3,   1}, {  -2,   3}, {   5,   4}, {  11,   8}, {  22,  26}, {   0,   0}},
   {{   0,   0}, {   0,   1}, {   0,   2}, {   3,   9}, {  13,  21}, {  42,  47}, {  83,  66}, {   0,   0}}
};
