...
const int KingShelter[2][FILE_NB / 2][RANK_NB] = {
  {{S( -14,   7), S(   3,  -8), S(  10,   2), S(  10,   4), S(  -6,   6), S(   4,  14), S( -78,  14), S( -26,   8)},
   {S(  11,   4), S(  10,  -7), S(  -5,  -9), S( -11, -12), S( -30, -10), S( -60,  42), S(   9,  53), S( -33,   5)},
   {S(  18,   8), S(  14,  -2), S( -18,  -1), S(  -7, -10), S( -14, -17), S(  12, -31), S(  15,   9), S( -16,   1)},
   {S(   3,  22), S(   9,   1), S( -15,  -4), S(   2,  -5), S( -12, -23), S( -30, -28), S( -47,  10), S(  -9,   0)}},
  {{S(   0,   0), S(   4, -22), S(   6, -16), S( -45,   7), S(  -9,  -8), S( -15,   3), S(-162, -17), S( -53,  13)},
   {S(   0,   0), S(  15,  -3), S(   3,  -3), S( -10,  -5), S( -10, -21), S(   6,  38), S(-145,  -8), S( -46,   8)},
   {S(   0,   0), S(  17,   1), S(  -4,  -4), S(  -2, -19), S(  12, -18), S( -65,  25), S( -70, -32), S( -26,  -1)},
   {S(   0,   0), S(   2,   7), S(   2,   3), S(   2,  -3), S( -11, -12), S( -79,   6), S( -19, -57), S( -16,  -2)}},
};
...
int evaluateKings(EvalInfo* ei, Board* board, int colour){
    ...
    for (file = MAX(0, kingFile - 1); file <= MIN(7, kingFile + 1); file++){
        ...
        pkeval += KingShelter[file == kingFile][square32(file)][distance];
