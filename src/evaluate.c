...
const int KingSafety[56][PHASE_NB] = {
     {   0,   0},  {   0,   0},  {   0,   0},  {   0,  -1},  {   0,  -2},  {   0,  -3},  {   0,  -4},  {   0,  -6},
     {  -1,  -7},  {  -2,  -8},  {  -4, -10},  {  -5, -11},  {  -7, -12},  { -10, -14},  { -13, -15},  { -16, -16},
     { -20, -17},  { -24, -17},  { -29, -17},  { -35, -18},  { -41, -17},  { -47, -17},  { -54, -16},  { -62, -15},
     { -71, -13},  { -80, -11},  { -91,  -8},  {-102,  -5},  {-113,  -1},  {-126,   2},  {-140,   7},  {-154,  13},
     {-169,  19},  {-186,  26},  {-203,  34},  {-221,  42},  {-241,  51},  {-261,  61},  {-283,  72},  {-306,  84},
     {-330,  97},  {-355, 110},  {-381, 125},  {-409, 140},  {-438, 157},  {-468, 175},  {-500, 193},  {-533, 213},
     {-567, 234},  {-603, 257},  {-641, 280},  {-679, 305},  {-720, 331},  {-762, 358},  {-805, 387},  {-850, 417},
};
