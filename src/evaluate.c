...
const int PawnBackwards[2][PHASE_NB] = { {  -2,  -5}, {  -8, -10} };
...
const int PawnConnected32[32][PHASE_NB] = {
    ...
    {   9,   2}, {   5,   1}, {   2,   3}, {   5,   1},
    {   3,   2}, {   4,   5}, {   2,   2}, {   9,   5},
    {   4,  10}, {  10,  14}, {   8,  13}, {  25,  21},
    {  14,  21}, {  22,  26}, {  48,  29}, {  40,  28},
    {  42,  18}, {  49,  22}, {  59,  31}, {  49,  31},
    {   0,   0}, {   0,   0}, {   0,   0}, {   0,   0},
};


const int KnightValue[PHASE_NB] = { 315, 301};

const int KnightOutpost[2][PHASE_NB] = { {  12, -11}, {  29,  11} };
...
const int BishopWings[PHASE_NB] = {  -5,   9};

const int BishopPair[PHASE_NB] = {  38,  50};

const int BishopOutpost[2][PHASE_NB] = { {  11,  -8}, {  27,  -4} };

const int BishopMobility[14][PHASE_NB] = {
    { -45, -51}, { -43, -36}, { -17, -22}, {  -1,  -7},
    {   9,   3}, {  19,  12}, {  24,  18}, {  27,  20},
    {  29,  23}, {  26,  21}, {  27,  25}, {  30,  17},
    {  36,  28}, {  17,   7},
};


const int RookValue[PHASE_NB] = { 454, 481};

const int RookFile[2][PHASE_NB] = { {   8,   9}, {  25,   4} };

const int RookOnSeventh[PHASE_NB] = {   2,  10};

const int RookMobility[15][PHASE_NB] = {
    {-117, -95}, { -59, -53}, { -10, -28}, {  -6, -11},
    {  -3,   0}, {   0,  12}, {  -1,  21}, {   0,  25},
    {   6,  32}, {  12,  34}, {  16,  38}, {  19,  41},
    {  19,  43}, {  20,  42}, {  13,  37},
};


const int QueenValue[PHASE_NB] = { 847, 878};

const int QueenChecked[PHASE_NB] = { -47, -46};

const int QueenMobility[28][PHASE_NB] = {
    {-184, -50}, { -97,-221}, { -88,-100}, { -58, -62},
    { -21, -62}, { -16, -27}, {  -7, -26}, {  -3, -22},
    {  -1, -21}, {   1, -17}, {   4,  -7}, {   6,  -2},
    {   8,   4}, {  10,  10}, {  11,  14}, {  11,  23},
    {  11,  27}, {  10,  28}, {  11,  28}, {  13,  33},
    {  15,  35}, {  24,  38}, {  28,  41}, {  30,  38},
    {  35,  42}, {  27,  34}, {  45,  49}, {  31,  43},
};


const int PassedPawn[2][2][RANK_NB][PHASE_NB] = {
  {{{   0,   0}, { -10,  -7}, { -18,   2}, { -15,   4}, {  14,  22}, {  46,  27}, {  60,  38}, {   0,   0}},
   {{   0,   0}, {  -4,   0}, { -15,   8}, {  -8,  19}, {  12,  34}, {  50,  45}, {  75,  68}, {   0,   0}}},
  {{{   0,   0}, {   0,  10}, {  -7,   7}, {  -2,  21}, {  22,  30}, {  68,  57}, { 117, 127}, {   0,   0}},
   {{   0,   0}, {   1,   3}, {  -7,   7}, {  -3,  33}, {  18,  75}, {  80, 160}, { 201, 295}, {   0,   0}}}
};
