...
const int PawnValue   = S( 111, 132);
const int KnightValue = S( 484, 394);
const int BishopValue = S( 494, 421);
const int RookValue   = S( 655, 727);
const int QueenValue  = S(1319,1350);
const int KingValue   = S(   0,   0);

const int PieceValues[8][PHASE_NB] = {
    { 111, 132}, { 484, 394}, { 494, 421}, { 655, 727},
    {1319,1350}, {   0,   0}, {   0,   0}, {   0,   0},
};
...
const int KnightMobility[9] = {
    S( -91, -86), S( -35, -94), S( -20, -42), S(  -6, -15),
    S(   6, -15), S(  14,   1), S(  24,  -2), S(  38,  -4),
    S(  51, -44),
};
...
const int RookMobility[15] = {
    S(-147,-107), S( -73,-120), S( -19, -68), S(  -9, -26),
    S( -10,  -3), S(  -7,  13), S(  -4,  25), S(   0,  32),
    S(   5,  35), S(   9,  38), S(  12,  44), S(  19,  50),
    S(  20,  51), S(  26,  47), S(  20,  48),
};
...
const int QueenMobility[28] = {
    ...
    S( -12,-132), S( -28, -69), S( -16, -91), S( -22, -76),
    S( -14, -61), S( -11, -52), S(  -6, -29), S(  -3, -27),
    S(  -5, -16), S(   3,  -8), S(   3,  -3), S(   0,   3),
    S(   8,  16), S(   2,  14), S(  13,  22), S(   0,  19),
    S(   0,  19), S(  20,  23), S(   5,   0), S(  32,   5),
    S(  34,  12), S(  58,  -5), S( -50, -19), S(   0,  -1),
};
