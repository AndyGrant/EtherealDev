...
const int ThreatWeakPawn             = S( -19, -31);
const int ThreatMinorAttackedByPawn  = S( -73, -54);
const int ThreatMinorAttackedByMajor = S( -43, -41);
const int ThreatRookAttackedByLesser = S( -56, -37);
const int ThreatQueenAttackedByOne   = S( -84, -30);
const int ThreatOverloadedPieces     = S( -17, -27);
