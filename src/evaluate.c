...
const int KingShelter[4][8] = {
   {S( -25,  22), S(  -2,  -2), S(  12,   3), S(  10,  -4), S(  -8,  -5), S(  21, -18), S(  42,-105), S(   0,   0)},
   {S( -35,  12), S(   9,   3), S(   5,  -1), S(  -4,  -4), S(  -8, -11), S(   5, -34), S(  17, -95), S(   0,   0)},
   {S( -11,   5), S(  26,   6), S(  -6,   5), S(  -6,   2), S(  28,  -9), S(  47, -18), S(  65, -63), S(   0,   0)},
   {S(  -6,  -9), S(  -3, -12), S( -14,  -6), S(  22,  -5), S(  29,   1), S(  29, -10), S(  34, -51), S(   0,   0)},
};
