...
const int KnightMobility[9] = {
    S( -89, -85), S( -26, -92), S( -11, -39), S(   2, -17),
    S(   9, -15), S(  13,  -3), S(  24, -10), S(  36, -19),
    S(  48, -46),
};
...
const int BishopMobility[14] = {
    S( -58,-127), S( -36, -66), S(  -8, -44), S(   2, -19),
    S(  15, -16), S(  24,  -8), S(  26,   0), S(  26,  -1),
    S(  25,   4), S(  28,  -5), S(  28,  -1), S(  38, -24),
    S(  44,  -6), S(  39, -38),
};
...
const int RookMobility[15] = {
    S(-146,-106), S( -61,-118), S(  -9, -66), S(   0, -19),
    S(   0,   0), S(   1,  16), S(   3,  25), S(   6,  33),
    S(  13,  31), S(  15,  38), S(  19,  41), S(  20,  47),
    S(  20,  51), S(  27,  47), S(  19,  49),
};

/* Queen Evaluation Terms */

const int QueenMobility[28] = {
    S( -61,-263), S(-216,-390), S( -47,-204), S( -35,-190),
    S( -18,-132), S( -20, -69), S(  -9, -90), S(  -9, -74),
    S(  -6, -61), S(  -4, -52), S(  -2, -30), S(  -2, -25),
    S(  -3, -15), S(   0,  -6), S(   0,   0), S(  -2,   4),
    S(  -1,  17), S(  -2,  14), S(   4,  19), S(  -3,  19),
    S(  -1,  18), S(  18,  21), S(   5,  -1), S(  30,   3),
    S(  33,  10), S(  58,  -6), S( -50, -18), S(   0,  -2),
};
