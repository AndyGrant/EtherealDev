...
const int KnightOutpost[2][8] = {
   {S(   0,   0), S(   0,   0), S(   0,   0), S(  21,   4),
    S(  29,   7), S(  27,  13), S(   0,   0), S(   0,   0)},
   {S(   0,   0), S(   0,   0), S(   0,   0), S(  28,  10),
    S(  61,  25), S(  41,  17), S(   0,   0), S(   0,   0)},
};
...
const int BishopOutpost[2][8] = {
   {S(   0,   0), S(   0,   0), S(   0,   0), S(  31,   7),
    S(  29,  12), S(  36,  14), S(   0,   0), S(   0,   0)},
   {S(   0,   0), S(   0,   0), S(   0,   0), S(  46,   6),
    S(  49,   5), S(  50,  10), S(   0,   0), S(   0,   0)},
};
