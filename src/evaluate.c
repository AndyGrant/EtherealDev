...
const int KingStormDanger[2][FILE_NB/2][RANK_NB][PHASE_NB] = {
  {{{  23,  13}, {   0,   0}, { -15,   4}, {  -5,   0}, {   0,   0}, {  -4,   0}, {  -8,   0}, { -20,   0}},
   {{  24,  16}, {   0,   0}, {  -8,   1}, {  -3,   0}, {   3,   0}, {  -4,  -1}, {  -6,  -1}, {   6,   0}},
   {{  20,  10}, {   0,   0}, {  -4,   2}, {  -6,  -1}, {   0,   1}, {   0,   0}, {   0,   0}, {   1,   0}},
   {{  25,   9}, {   0,   0}, {  -8,  -1}, {  -6,  -1}, {   0,   1}, {  14,   0}, {  20,   1}, {   8,  -1}}},
  {{{   0,   0}, {  56,  16}, {   1,   2}, {  10,   0}, {   8,   0}, {   2,  -2}, {   3,   0}, { -10,   0}},
   {{   0,   0}, {  19,  20}, { -12,   0}, {   1,   2}, {   5,   1}, {  -3,  -2}, { -19,  -1}, {   0,   1}},
   {{   0,   0}, {  13,  11}, { -15,  -3}, {   0,   0}, {   3,   0}, {  -1,   2}, {  -5,   1}, {  -5,  -1}},
   {{   0,   0}, {  24,  10}, { -18,  -7}, {   2,   1}, {  -1,   3}, {  18,   3}, {  30,   3}, {  -1,  -1}}},
};
