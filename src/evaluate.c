...
const int KingShelter[2][8][8] = {
  {{S( -16,  14), S(   7, -10), S(  16,   0), S(  22,   1), S(   7,   7), S(  30,   4), S(  -1, -32), S( -30,   3)},
   {S(   4,   6), S(  16,  -8), S(  12,  -9), S(  -2, -12), S( -26,   0), S( -65,  79), S( 100,  93), S( -30,   0)},
   {S(  14,  12), S(  10,  -2), S( -19,   0), S(  -7,  -2), S( -22,  -3), S(  14,  -8), S(   4,  65), S( -15,   2)},
   {S(   9,  30), S(  14,   0), S(   0,  -7), S(  15, -17), S(  13, -36), S( -23, -32), S(-147,  41), S(  -3,   0)},
   {S( -17,  20), S(   0,   3), S( -27,   2), S( -11,   4), S( -24, -16), S( -41, -18), S(  39,  -7), S( -12,   0)},
   {S(  24,   4), S(  22,  -4), S( -22,   0), S( -12, -22), S(   5, -32), S(  16, -49), S(  50, -33), S( -17,   0)},
   {S(  21,   4), S(   4, -10), S( -28,  -6), S( -17, -14), S( -24, -21), S( -43,   9), S(   6,  46), S( -24,   7)},
   {S( -18,  -2), S(   2, -10), S(   7,   1), S(  -2,   2), S( -13,  13), S(   3,  32), S(-201,  79), S( -20,  15)}},
  {{S(   0,   0), S(   5, -15), S(   6, -13), S( -46,  19), S(   0,  -9), S(   9,  51), S(-170, -14), S( -51,  11)},
   {S(   0,   0), S(  18,  -7), S(   8,  -6), S(  -5,  -8), S(  11, -32), S(  51, 102), S(-188, -11), S( -45,   4)},
   {S(   0,   0), S(  24,   0), S(   0,  -6), S(  19, -27), S(  13,  -8), S(-113,  44), S( -89, -83), S( -22,  -2)},
   {S(   0,   0), S(  -5,   9), S(  -9,  13), S( -13,   3), S( -23,   0), S(-116,  10), S(   5, -50), S( -28,   0)},
   {S(   0,   0), S(   8,   5), S(  10,  -6), S(  18,  -4), S(   8, -23), S( -44,   7), S(-108, -72), S(  -8,  -3)},
   {S(   0,   0), S(  12,   1), S( -16,   0), S( -12, -14), S(  29, -38), S( -44,   5), S(  59,  47), S( -28,   1)},
   {S(   0,   0), S(  12,  -1), S(   1,   0), S( -25,  -5), S( -22, -13), S(  22,  11), S( -58, -64), S( -46,  14)},
   {S(   0,   0), S(   7, -27), S(  11, -15), S( -22,   0), S( -27,  -3), S(   6, -17), S(-240, -73), S( -43,  15)}},
};
