...
extern const int KnightUnsupported;
...
extern const int BishopUnsupported;
...
void initCoefficients(int coeffs[NTERMS]) {
    ...
    ENABLE_0(INIT_COEFF, KnightUnsupported)             ;
    ...
    ENABLE_0(INIT_COEFF, BishopUnsupported)             ;
...
void initCurrentParameters(double cparams[NTERMS][PHASE_NB]) {
    ...
    ENABLE_0(INIT_PARAM, KnightUnsupported)             ;
    ...
    ENABLE_0(INIT_PARAM, BishopUnsupported)             ;
...
void printParameters(double params[NTERMS][PHASE_NB], double cparams[NTERMS][PHASE_NB]) {
    ...
    ENABLE_0(PRINT_PARAM, KnightUnsupported)            ;
    ...
    ENABLE_0(PRINT_PARAM, BishopUnsupported)            ;
