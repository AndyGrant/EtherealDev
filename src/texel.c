...
void printParameters(double params[NT][PHASE_NB], double cparams[NT][PHASE_NB]){
    ...
    printf("// Definition of Values for each Piece type\n");
    ...
    printf("// Definition of evaluation terms related to Pawns\n");
    ...
    printf("// Definition of evaluation terms related to Knights\n");
    ...
    printf("// Definition of evaluation terms related to Bishops\n");    
    ...
    printf("// Definition of evaluation terms related to Rooks\n");    
    ...
    printf("// Definition of evaluation terms related to Queens\n");    
    ...
    printf("// Definition of evaluation terms related to Kings\n\n");
    ...
    printf("// Definition of evaluation terms related to Passed Pawns\n");
