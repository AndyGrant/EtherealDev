...
extern const int ThreatPawnAttackedByTwo;
...
extern const int ThreatQueenAttackedByTwo;
...
void initializeCoefficients(int coeffs[NT]){
    ...
    if (TuneThreatPawnAttackedByTwo)
        coeffs[i++] = T.threatPawnAttackedByTwo[WHITE] - T.threatPawnAttackedByTwo[BLACK];
    
    if (TuneThreatMinorAttackedByPawn)
        coeffs[i++] = T.threatMinorAttackedByPawn[WHITE] - T.threatMinorAttackedByPawn[BLACK];
        
    if (TuneThreatMinorAttackedByMinor)
        coeffs[i++] = T.threatMinorAttackedByMinor[WHITE] - T.threatMinorAttackedByMinor[BLACK];
    ...
    if (TuneThreatQueenAttackedByTwo)  
        coeffs[i++] = T.threatQueenAttackedByTwo[WHITE] - T.threatQueenAttackedByTwo[BLACK];
}
...
void initializeCurrentParameters(double cparams[NT][PHASE_NB]){
    ...
    if (TuneThreatPawnAttackedByTwo){
        cparams[i  ][MG] = ScoreMG(ThreatPawnAttackedByTwo);
        cparams[i++][EG] = ScoreEG(ThreatPawnAttackedByTwo);
    }
    ...
    if (TuneThreatMinorAttackedByMinor){
        cparams[i  ][MG] = ScoreMG(ThreatMinorAttackedByMinor);
        cparams[i++][EG] = ScoreEG(ThreatMinorAttackedByMinor);
    }
    ...
    if (TuneThreatQueenAttackedByTwo){
        cparams[i  ][MG] = ScoreMG(ThreatQueenAttackedByTwo);
        cparams[i++][EG] = ScoreEG(ThreatQueenAttackedByTwo);
    }
}
...
void printParameters(double params[NT][PHASE_NB], double cparams[NT][PHASE_NB]){
    ...
    if (TuneThreatPawnAttackedByOne){
        printf("\nconst int ThreatPawnAttackedByOne    = S(%4d,%4d);", tparams[i][MG], tparams[i][EG]); i++;
    }
    
    if (TuneThreatPawnAttackedByTwo){
        printf("\nconst int ThreatPawnAttackedByTwo    = S(%4d,%4d);", tparams[i][MG], tparams[i][EG]); i++;
    }
    
    if (TuneThreatMinorAttackedByPawn){
        printf("\nconst int ThreatMinorAttackedByPawn  = S(%4d,%4d);", tparams[i][MG], tparams[i][EG]); i++;
    }
    
    if (TuneThreatMinorAttackedByMinor){
        printf("\nconst int ThreatMinorAttackedByMinor = S(%4d,%4d);", tparams[i][MG], tparams[i][EG]); i++;
    }
    
    if (TuneThreatMinorAttackedByMajor){
        printf("\nconst int ThreatMinorAttackedByMajor = S(%4d,%4d);", tparams[i][MG], tparams[i][EG]); i++;
    }
    
    if (TuneThreatMajorAttackedByMinor){
        printf("\nconst int ThreatMajorAttackedByMinor = S(%4d,%4d);", tparams[i][MG], tparams[i][EG]); i++;
    }
    
    if (TuneThreatQueenAttackedByOne){
        printf("\nconst int ThreatQueenAttackedByOne   = S(%4d,%4d);", tparams[i][MG], tparams[i][EG]); i++;
    }
    
    if (TuneThreatQueenAttackedByTwo){
        printf("\nconst int ThreatQueenAttackedByTwo   = S(%4d,%4d);", tparams[i][MG], tparams[i][EG]); i++;
    }
