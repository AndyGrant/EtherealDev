...
extern const int KingStorm[2][FILE_NB][RANK_NB];
...
void initCoefficients(int coeffs[NTERMS]) {
    ...
    if (TuneKingStorm                 ) INIT_COEFF_3(KingStorm, 2, 8, 8)        ;
...
void initCurrentParameters(double cparams[NTERMS][PHASE_NB]) {
    ...
    if (TuneKingStorm                 ) INIT_PARAM_3(KingStorm, 2, 8, 8)        ;
...
void printParameters(double params[NTERMS][PHASE_NB], double cparams[NTERMS][PHASE_NB]) {
    ...
    if (TuneKingStorm                 ) PRINT_PARAM_3(KingStorm, 2, 8, 8)        ;
