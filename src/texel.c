...
extern const int ThreatQueenAttackedByPawn;
extern const int ThreatQueenAttackedByLesser;
...
void initCoefficients(int coeffs[NTERMS]) {
    ...
    if (TuneThreatQueenAttackedByPawn   ) INIT_COEFF_0(ThreatQueenAttackedByPawn)   ;
    if (TuneThreatQueenAttackedByLesser ) INIT_COEFF_0(ThreatQueenAttackedByLesser) ;
...
void initCurrentParameters(double cparams[NTERMS][PHASE_NB]) {
    ...
    if (TuneThreatQueenAttackedByPawn   ) INIT_PARAM_0(ThreatQueenAttackedByPawn)   ;
    if (TuneThreatQueenAttackedByLesser ) INIT_PARAM_0(ThreatQueenAttackedByLesser) ;
...
void printParameters(double params[NTERMS][PHASE_NB], double cparams[NTERMS][PHASE_NB]) {
    ...
    if (TuneThreatQueenAttackedByPawn   ) PRINT_PARAM_0(ThreatQueenAttackedByPawn)      ;
    if (TuneThreatQueenAttackedByLesser ) PRINT_PARAM_0(ThreatQueenAttackedByLesser)    ;
