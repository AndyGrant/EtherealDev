...
extern const int ThreatPawnUnsupported;
extern const int ThreatPawnHanging;
...
void initCoefficients(int coeffs[NTERMS]) {
    ...
    if (TuneThreatPawnUnsupported     ) INIT_COEFF_0(ThreatPawnUnsupported)     ;
    if (TuneThreatPawnHanging         ) INIT_COEFF_0(ThreatPawnHanging)         ;
...
void initCurrentParameters(double cparams[NTERMS][PHASE_NB]) {
    ...
    if (TuneThreatPawnUnsupported     ) INIT_PARAM_0(ThreatPawnUnsupported)     ;
    if (TuneThreatPawnHanging         ) INIT_PARAM_0(ThreatPawnHanging)         ;
...
void printParameters(double params[NTERMS][PHASE_NB], double cparams[NTERMS][PHASE_NB]) {
    ...
    if (TuneThreatPawnUnsupported     ) PRINT_PARAM_0(ThreatPawnUnsupported)     ;
    if (TuneThreatPawnHanging         ) PRINT_PARAM_0(ThreatPawnHanging)         ;
