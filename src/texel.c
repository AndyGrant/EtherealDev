...
extern const int KnightOutpost[3];
...
extern const int BishopOutpost[3];
...
void initCoefficients(int coeffs[NTERMS]) {
    ...
    ENABLE_1(INIT_COEFF, KnightOutpost, 3)              ;
    ...
    ENABLE_1(INIT_COEFF, BishopOutpost, 3)              ;
...
void initCurrentParameters(double cparams[NTERMS][PHASE_NB]) {
    ...
    ENABLE_1(INIT_PARAM, KnightOutpost, 3)              ;
    ...
    ENABLE_1(INIT_PARAM, BishopOutpost, 3)              ;
...
void printParameters(double params[NTERMS][PHASE_NB], double cparams[NTERMS][PHASE_NB]) {
    ...
    ENABLE_1(PRINT_PARAM, KnightOutpost, 3)             ;
    ...
    ENABLE_1(PRINT_PARAM, BishopOutpost, 3)             ;
