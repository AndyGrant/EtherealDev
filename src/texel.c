...
extern const int KnightPresence;
...
void initCoefficients(int coeffs[NTERMS]) {
    ...
    if (TuneKnightPresence              ) INIT_COEFF_0(KnightPresence)              ;
...
void initCurrentParameters(double cparams[NTERMS][PHASE_NB]) {
    ...
    if (TuneKnightPresence              ) INIT_PARAM_0(KnightPresence)              ;
...
void printParameters(double params[NTERMS][PHASE_NB], double cparams[NTERMS][PHASE_NB]) {
    ...
    if (TuneKnightPresence              ) PRINT_PARAM_0(KnightPresence)             ;
