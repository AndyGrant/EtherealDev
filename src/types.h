...
typedef uint16_t CounterMoveTable[COLOUR_NB][PIECE_NB+1][SQUARE_NB];

typedef int16_t HistoryTable[COLOUR_NB][2][2][SQUARE_NB][SQUARE_NB];
typedef int16_t CaptureHistoryTable[PIECE_NB+1][2][2][SQUARE_NB][PIECE_NB+1];
typedef int16_t ContinuationTable[2][PIECE_NB+1][SQUARE_NB][CONT_NB][PIECE_NB+1][SQUARE_NB];
