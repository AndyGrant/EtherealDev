...
int qsearch(Thread* thread, PVariation* pv, int alpha, int beta, int height){
    ...
    while ((currentMove = selectNextMove(&movePicker, board)) != NONE_MOVE){
        ...
        int tacticalValue = thisTacticalMoveValue(board, currentMove);
        int movedValue = PieceValues[PieceType(board->squares[MoveFrom(currentMove)])][EG];
